<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPanelManageWarehouse/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageProduct.aspx.cs" Inherits="CResearchers_CPanelManageWarehouse_PageManageProduct" %>
                        ...
                        <div class="content-box-large">
                            <div class="widget-box">
                                ...
                                <div class="container-fluid" dir="rtl">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <h5>حدد الوحدة : <span style="color: red">*</span>
                                            </h5>
                                            ...
                                            <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator4" runat="server"
                                                ControlToValidate="DLUnits" ErrorMessage="* حدد الوحدة" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                                ValidationGroup="g2" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVProductAll" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductID"
                                                    Width="100%" CssClass="footable1" EnableTheming="True" GridLines="Horizontal" OnRowDataBound="GVProductAll_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="حالة التفعيل" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <%# ClassSaddam.FChangeStyleCheckbox2((Boolean) (Eval("IsActive")))%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>

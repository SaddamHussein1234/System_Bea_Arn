<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPanelManageExchangeOrders/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageProductAnOrderToTxchangeHomeFurnishing.aspx.cs" Inherits="CResearchers_CPanelManageExchangeOrders_PageManageProductAnOrderToTxchangeHomeFurnishing" %>
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLAffiliation" runat="server" ValidationGroup="g2" CssClass="form-control2 chzn-select dropdown"
                                            Width="100%">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLSupportType" runat="server" ValidationGroup="g2" CssClass="form-control2 chzn-select dropdown" Width="100%">
                                            <asp:ListItem></asp:ListItem>
                                        </asp:DropDownList>

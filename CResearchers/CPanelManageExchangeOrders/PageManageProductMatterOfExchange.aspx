<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPanelManageExchangeOrders/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageProductMatterOfExchange.aspx.cs" Inherits="CResearchers_CPanelManageExchangeOrders_PageManageProductMatterOfExchange" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageManageProductMatterOfExchange.aspx" class="btn btn-primary">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageManageProductMatterOfExchange.aspx">إضافة أمر صرف سلة</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="إنشاء أمر صرف سلة"></asp:Label>
                        ...
                        <div class="container-fluid" dir="rtl">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtNumberMostafeed" runat="server" class="form-control" ValidationGroup="g2" AutoPostBack="true" Enabled="false"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="DLName" runat="server" ValidationGroup="g2" Width="100%" CssClass="form-control2 chzn-select dropdown" Enabled="false"
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <h5>رقم الامر : <span style="color: red">*</span>
                                    </h5>
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="WidthText" runat="server" visible="false">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtPriceOfTheGrain" runat="server" class="form-control" Text="0" ValidationGroup="g2" AutoPostBack="true" OnTextChanged="txtPriceOfTheGrain_TextChanged"
                                        ...
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                <td style="width: 50%" runat="server" id="IDAmeenSondoq">
                                                    <h5>أمين الصندوق : <span style="color: red">*</span>
                                                    </h5>
                                                    ...
                                                    <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator9" runat="server"
                                                        ControlToValidate="DLAmeenAlSondoq" ErrorMessage="* أمين الصندوق" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                                        ValidationGroup="g2" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: thin double #808080; border-width: 1px; width: 20%">
                                                <table style="width: 100%; font-size: 12px">
                                                    <tr>
                                                        <td align="left" style="width: 60%">رقم الأمر / 
                                                        </td>
                                                        <td style="width: 40%">

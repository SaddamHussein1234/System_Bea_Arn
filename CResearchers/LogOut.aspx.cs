...
public partial class CResearchers_LogOut : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            //Response.Cookies[DateTime.Now.ToString("_545_yyyyMMyyyyMM_22_")].Expires = DateTime.Now.AddDays(-30);
            //Response.Cookies["__Checkedbahith_True_"].Expires = DateTime.Now.AddDays(-30);
            //Response.Cookies["__Userbahith_True_"].Expires = DateTime.Now.AddDays(-30);
            //Response.Cookies["__UserUniqbahith_True_"].Expires = DateTime.Now.AddDays(-30);

<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageRe_beneficiaryByModer.aspx.cs" Inherits="CResearchers_CPVillage_PageRe_beneficiaryByModer" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageRe_beneficiaryAdd.aspx" id="IDAdd" runat="server" data-toggle="tooltip" title="إضافة طلب جديد" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageRe_beneficiaryByModer.aspx">قائمة طلبات الإعاده التي تحتاج الى موافقة المدير</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة طلبات الإعاده التي تحتاج الى موافقة المدير
                        </h3>
                        ...
                        <asp:Panel ID="pnlData" runat="server" Direction="RightToLeft" Visible="False">
                            <div class="ColorBackground">
                                <div align="center" class="w">
                                    <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة طلبات الإعاده التي تحتاج إلى موافقة المدير" placeholder="عنوان البحث" Style="text-align: center; width: 100%"></asp:TextBox>
                                    <span class="hr"></span>
                                </div>
                            </div>
                                ...
                                <asp:GridView ID="GVRe_beneficiary" runat="server" AutoGenerateColumns="False" DataKeyNames="IDIteam"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16" Visible="false">
                                            <ItemTemplate>
                                                <a href='PageRe_beneficiaryDetails.aspx?ID=<%# Eval("NumberOrder")%>&XID=<%# Eval("IDUniq")%>' title="عرض الملف" data-toggle="tooltip"

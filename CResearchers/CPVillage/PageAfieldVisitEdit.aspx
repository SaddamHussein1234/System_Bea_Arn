<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageAfieldVisitEdit.aspx.cs" Inherits="CResearchers_CPVillage_PageAfieldVisitEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content">
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">تعديل زيارة ميدانية</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
                        ...
                        <div class="container-fluid" dir="rtl">
                            ...
                            <div class="WidthText2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtNumberVisit" runat="server" class="form-control" ValidationGroup="g2" Enabled="false"></asp:TextBox>
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="WidthText2">
                                    <div class="form-group">
                                        ...
                                        <asp:RadioButton ID="CBBahthHalatMosTafeed" runat="server" Font-Size="14px" ValidationGroup="g2" GroupName="GAfield" />
                                    </div>
                                </div>
                                <div class="WidthText2">
                                    <div class="form-group">
        ...
        <asp:Panel ID="pnlManageAllow" runat="server">
        <div class="container-fluid">
            <div class="panel panel-default" style="background-color: #016803; color:#f0f0f0">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-pencil"></i>
                        <asp:Label ID="Label3" runat="server" Text="إدارة الزيارة"></asp:Label>
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="content-box-large">
                        <div class="widget-box">
                            <div class="container-fluid" dir="rtl">
                                <div class="WidthText2">
                                    <div class="form-group">
                                        <h5>يسمح بعمل الزيارة الميدانية :
                                        </h5>
                                ...
                                <div class="WidthText2">
                                    <div class="form-group">
                                        <h5>لا يسمح بعمل الزيارة الميدانية :
                                        </h5>

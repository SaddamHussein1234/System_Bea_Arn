<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageTecisionToExcludeDetails.aspx.cs" Inherits="CResearchers_CPVillage_PageTecisionToExcludeDetails" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">قرار إستبعاد مستفيد</a></li>
                </ul>
            </div>
        </div>
                ...
                <tr>
                    <td colspan="2">
                        <div class="WidthText4" style="margin-right: 15px">
                            <asp:TextBox ID="txtTitle" runat="server" Font-Size="14px" class="form-control" placeholder="عنوان البحث" Text="قرار إستبعاد مستفيد" Style="text-align: center; width: 95%; background-color: #fc5d5d; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                        </div>
                        <div class="WidthText">
                                    ...
                                    <div class="container-fluid" dir="rtl">
                                        ...
                                        <div class="WidthText5">
                                            <div class="form-group">
                                                ...
                                                <p>
                                                    فإنه تم إستبعاد (المستفيد) الموضح بياناته بعاليه اعتباراً من تاريخة
                                                </p>
                                                <div align="center">
                                                    <p>

<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageConvertedCasesByModer.aspx.cs" Inherits="CResearchers_CPVillage_PageConvertedCasesByModer" %>
                        ...
                        <asp:Panel ID="pnlData" runat="server" Direction="RightToLeft" Visible="False">
                            <div class="ColorBackground">
                                <div align="center" class="w">
                                    <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة طلبات التحويل التي تحتاج إلى موافقة المدير" placeholder="عنوان البحث" Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                    <span class="hr"></span>
                                </div>
                            </div>

...
public partial class CResearchers_CPVillage_PageAcceptanceDecisionAdd : System.Web.UI.Page
{
    string XID;
    ...
    private void FGetLastRecord()
    {
        ...
        dt = ClassDataAccess.GetData("SELECT * FROM [dbo].[QararQobolMustafeed] With(NoLock) Where IsQobol = @0 And IsEstepaad = @1 And IsDelete = @2 Order by NumberQarar Desc", Convert.ToString(true), Convert.ToString(false), Convert.ToString(false));
        if (dt.Rows.Count > 0)
        {
    ...
    {
        DataTable dt = new DataTable();
        dt = ClassDataAccess.GetData("SELECT * FROM [dbo].[QararQobolMustafeed] With(NoLock) Where IsQobol = @0 And IsEstepaad = @1 And IsDelete = @2 Order by NumberReport Desc", Convert.ToString(true), Convert.ToString(false), Convert.ToString(false));
        if (dt.Rows.Count > 0)
        {
    ...
    {
        DataTable dt = new DataTable();
        dt = ClassDataAccess.GetData("SELECT * FROM [dbo].[QararQobolMustafeed] With(NoLock) Where NumberQarar = @0 And IsQobol = @1 And IsEstepaad = @2 And IsDelete = @3", txtNumberQarar.Text.Trim(), Convert.ToString(true), Convert.ToString(false), Convert.ToString(false));
        if (dt.Rows.Count > 0)
        {
    ...
    {
        DataTable dt = new DataTable();
        dt = ClassDataAccess.GetData("SELECT * FROM [dbo].[QararQobolMustafeed] With(NoLock) Where NumberReport = @0 And IsQobol = @1 And IsEstepaad = @2 And IsDelete = @3", txtNumberReport.Text.Trim(), Convert.ToString(true), Convert.ToString(false), Convert.ToString(false));
        if (dt.Rows.Count > 0)
        {

<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageBeneficiaryAdd.aspx.cs" Inherits="CResearchers_CPVillage_PageBeneficiaryAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageBeneficiaryAdd.aspx">إضافة إستمارة مستفيد للنظام</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="إضافة إستمارة مستفيد للنظام - البيانات الاساسية للنظام"></asp:Label>
                    </h3>
                </div>
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="WidthText1">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLTypeMostafeed" runat="server" ValidationGroup="g2" CssClass="dropdown" Enabled="false"
                                            ...
                                            <asp:ListItem Value="مستبعد" Selected="True">سيتم إعتمادة من قبل رئيس المجلس</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <div class="WidthText1">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLAlQriah" runat="server" ValidationGroup="g2" Width="100%" CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;" Enabled="false">
                                ...
                                <div class="WidthText1">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLHalafAlMosTafeed" runat="server" ValidationGroup="g2" Width="100%" CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;" AutoPostBack="true" OnSelectedIndexChanged="DLHalafAlMosTafeed_SelectedIndexChanged">
                                            <asp:ListItem Value=""></asp:ListItem>
                                        </asp:DropDownList>
                                        ...
                                        <table>
                                            <tr>
                                                <td style="padding-left: 3px">
                                                    <asp:DropDownList ID="ddlYearsH" runat="server" Width="55" Enabled="false">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="padding-left: 3px">
                                                    <asp:DropDownList ID="ddlMonthsH" runat="server" Width="40" Enabled="false">
                                                        <asp:ListItem></asp:ListItem>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlDatesH" runat="server" Width="40" OnSelectedIndexChanged="ddlDatesH_SelectedIndexChanged" AutoPostBack="true" Enabled="false">
                                                        <asp:ListItem></asp:ListItem>
                                                        <asp:ListItem Text="01" Value="01" />
                                                        <asp:ListItem Text="02" Value="02" />
                                                        <asp:ListItem Text="03" Value="03" />
                    ...
                    <div class="content-box-large">
                        <div class="widget-box">
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="WidthText1" runat="server" visible="false" id="PnlMehnah">
                                    <div class="form-group">
                                ...
                                <div class="WidthText1">
                                    <div class="form-group">
                                        ...
                                        <asp:CheckBox ID="CBActive" runat="server" Font-Size="14px" CssClass="checkbox-inline" ValidationGroup="g2" Checked="true" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-box">
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="WidthText3">
                                    <div class="form-group">
                                        <h5>المسموح :(bmp , gif , png , jpg , jpeg)
                                        </h5>

<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageAfieldVisitNotApproved.aspx.cs" Inherits="CResearchers_CPVillage_PageAfieldVisitNotApproved" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="إسم المستفيد" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            <%# ClassSaddam.FCheckAllowModer2((bool) (Eval("IsModer")))%> 

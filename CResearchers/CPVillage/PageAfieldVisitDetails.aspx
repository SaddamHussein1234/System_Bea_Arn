<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageAfieldVisitDetails.aspx.cs" Inherits="CResearchers_CPVillage_PageAfieldVisitDetails" %>
            ...
            <div class="container-fluid">
                <div class="pull-right">
                    ...
                    <div style="float: left">
                        ...
                        &nbsp;
                        <asp:TextBox ID="txtSearch" runat="server" CssClass="WidthText20" placeholder=" رقم الزيارة ... "></asp:TextBox>
                    </div>
                </div>
                <h1>لوحة التحكم</h1>
                <ul class="breadcrumb">
                    <li><a href="Default.aspx">الرئيسية</a></li>
                    <li><a href="PageAfieldVisitApproval.aspx">الزيارات</a></li>

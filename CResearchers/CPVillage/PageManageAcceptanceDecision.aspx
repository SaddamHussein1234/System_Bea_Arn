<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageManageAcceptanceDecision.aspx.cs" Inherits="CResearchers_CPVillage_PageManageAcceptanceDecision" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3 col-sm-6" runat="server" id="IDAcceptanceDecisionAdd" visible="false">
                ...
                <div class="col-lg-6 col-md-3 col-sm-6" runat="server" id="IDAcceptanceDecisionDetailsView" visible="false">

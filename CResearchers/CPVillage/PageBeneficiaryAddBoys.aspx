<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageBeneficiaryAddBoys.aspx.cs" Inherits="CResearchers_CPVillage_PageBeneficiaryAddBoys" %>
                                            ...
                                            <table>
                                                <tr>
                                                    <td style="padding-left: 3px">
                                                        <asp:DropDownList ID="ddlYearsH" runat="server" Width="70" Enabled="false">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td style="padding-left: 3px">
                                                        <asp:DropDownList ID="ddlMonthsH" runat="server" Width="50" Enabled="false">
                                                            <asp:ListItem></asp:ListItem>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlDatesH" runat="server" Width="50" OnSelectedIndexChanged="ddlDatesH_SelectedIndexChanged" AutoPostBack="true" Enabled="false">
                                                            <asp:ListItem></asp:ListItem>
                                                            <asp:ListItem Text="01" Value="01" />
                                                            <asp:ListItem Text="02" Value="02" />
                                                            <asp:ListItem Text="03" Value="03" />

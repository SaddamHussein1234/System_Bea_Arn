<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageVisitReportByHouse.aspx.cs" Inherits="CResearchers_CPVillage_PageVisitReportByHouse" %>
                                                ...
                                                <asp:GridView ID="GVVisitReport" runat="server" AutoGenerateColumns="False" DataKeyNames="NumberMostafeed"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="رقم الملف" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <%# Eval("NumberMostafeed")%> <%# ClassSaddam.FGetPercintImg2((String) (Eval("A1")))%>
                                                            </ItemTemplate>

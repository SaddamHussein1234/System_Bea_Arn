<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageManageBeneficiary.aspx.cs" Inherits="CResearchers_CPVillage_PageManageBeneficiary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3 col-sm-6" runat="server" id="IDAddBeneficiary" visible="false">
                    <a href="PageBeneficiaryAdd.aspx" data-toggle="tooltip" title="إضافة مستفيد">
                        <div class="tile">
                ...
                <div class="col-lg-6 col-md-3 col-sm-6" runat="server" id="IDBeneficiaryBySearch" visible="false">
                ...
                <div class="col-lg-6 col-md-3 col-sm-6" runat="server" id="IDBeneficiaryByView" visible="false">
                ...
                <div class="col-lg-6 col-md-3 col-sm-6" runat="server" id="IDBeneficiaryAddBoys" visible="false">

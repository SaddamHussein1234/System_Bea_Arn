<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageExclusionOfTheBeneficiaryByModer.aspx.cs" Inherits="CResearchers_CPVillage_PageExclusionOfTheBeneficiaryByModer" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageExclusionOfTheBeneficiary.aspx" runat="server" id="IDAdd" data-toggle="tooltip" title="إضافة طلب جديد" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageExclusionOfTheBeneficiaryByModer.aspx">قائمة طلبات الإستبعاد التي تحتاج إلى موافقة المدير</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة طلبات الإستبعاد التي تحتاج إلى موافقة المدير
                        </h3>
                        ...
                        <asp:Panel ID="pnlData" runat="server" Direction="RightToLeft" Visible="False">
                            <div class="ColorBackground">
                                <div align="center" class="w">
                                    <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة طلبات الإستبعاد التي تحتاج إلى موافقة المدير" placeholder="عنوان البحث" Style="text-align: center; width: 100%"></asp:TextBox>
                                    <span class="hr"></span>
                                </div>
                            </div>

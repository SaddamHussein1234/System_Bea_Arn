...
public partial class CResearchers_CPVillage_PageSearchStatus : System.Web.UI.Page
{
    string XID;
    ...
    private void FArnTahweelAlHalahByQariah()
    {
        try
        {
            ClassBahthHalatMostafeed CBM = new ClassBahthHalatMostafeed();
            CBM._AlQaryah = Convert.ToInt32(DLAlQriah.SelectedValue);
            CBM._IDUniq = txtSearch.Text.Trim();
            CBM._IsDelete = false;
            DataTable dtRecord = new DataTable();
            dtRecord = CBM.BArnBahthHalatMostafeedByQariah();
    ...
    int tempcounter = 0;
    protected void GVConvertedCases_RowDataBound(object sender, GridViewRowEventArgs e)
    {

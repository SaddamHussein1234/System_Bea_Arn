...
public partial class CResearchers_CPVillage_PageAfieldVisitDetails : System.Web.UI.Page
{
    string XID;
    ...
    private void FGetDataMostafed()
    {
        ...
        dtGetQariah = ClassDataAccess.GetData("SELECT Top(1) ZeyarahMaydanyah.NumberAlMosTafeed,[AlQaryah],ZeyarahMaydanyah.IsDelete FROM [dbo].[ZeyarahMaydanyah] With(NoLock) Inner Join RasAlEstemarah on RasAlEstemarah.NumberMostafeed = ZeyarahMaydanyah.NumberAlMosTafeed Where NumberAlZyarah = @0 And ZeyarahMaydanyah.IsDelete = @1 And RasAlEstemarah.IsDelete = @1", txtSearch.Text.Trim(), Convert.ToString(false));

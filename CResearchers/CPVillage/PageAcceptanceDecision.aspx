<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageAcceptanceDecision.aspx.cs" Inherits="CResearchers_CPVillage_PageAcceptanceDecision" %>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVAcceptanceDecision" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                                                    Width="100%" CssClass="footable1" EnableTheming="True" GridLines="Horizontal" OnRowDataBound="GVAcceptanceDecision_RowDataBound"

<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageVisitReportDetails.aspx.cs" Inherits="CResearchers_CPVillage_PageVisitReportDetails" %>
            ...
            <table style="width: 100%;">
                <tr>
                    <td align="center" colspan="2">
                        <span class='hr'></span>
                        <asp:TextBox ID="txtTitle" runat="server" Font-Size="14px" class="form-control" placeholder="عنوان البحث" Text="تقرير نتيجة زياره ميدانية" Style="text-align: center; width: 95%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="center" colspan="2">
                                ...
                                <td class="StyleTD" colspan="2">
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            <td style="width: 75%;">0<asp:Label ID="lblPhone" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                                        ...
                                                        <ItemTemplate>
                                                            <div class="WidthText30">
                                                                <a href='<%# "../" + Eval("ImgReport") %>' target="_blank" title="تكبير الصورة" data-toggle="tooltip">
                                                                    <img src='<%# "../" + Eval("ImgReport") %>' style="margin: 4px; border-radius: 5px" width="100%" height="122" class="WidthImg" />
                                                                </a>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:Repeater>

<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageVisitReport.aspx.cs" Inherits="CResearchers_CPVillage_PageVisitReport" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageVisitReportAdd.aspx" data-toggle="tooltip" title="إضافة طلب جديد" class="btn btn-primary" id="IDAdd" runat="server"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageVisitReport.aspx">قائمة عرض تقارير الزيارات</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة عرض تقارير الزيارات
                        </h3>
                                        ...
                                        <tr>
                                            <th>
                                                ...
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة تقارير الزيارات الميدانية" placeholder="عنوان البحث" Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="من قبل" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <br />
                                                                <%# ClassSaddam.FCheckAllowModer2((bool) (Eval("IsModerAllow")))%> 
                                                              , <%# ClassSaddam.FCheckAllowRaeesLagnatByBaheth((bool) (Eval("IsRaesLagnatAlBahthAllow")))%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                            <ItemTemplate>
                                                                ...
                                                                <a href='PageVisitReportEdit.aspx?ID=<%# Eval("NumberReport")%>&XID=<%# Convert.ToString(Guid.NewGuid())%>' title="تعديل" data-toggle="tooltip"
                                                                    class="btn btn-primary" style="margin-top: 5px"><span class="fa fa-edit"></span></a>
                                                            </ItemTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageRe_beneficiaryAdd.aspx.cs" Inherits="CResearchers_CPVillage_PageRe_beneficiaryAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageRe_beneficiary.aspx">طلبات الإعادة</a></li>
                    <li><a href="PageRe_beneficiaryAdd.aspx">إضافة طلب إعادة</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-pencil"></i>
                            <asp:Label ID="Label4" runat="server" Text="إضافة قرار قبول"></asp:Label>
                        </h3>
                    </div>
                    <div class="panel-body">
                        <div class="content-box-large">
                                ...
                                <div class="container-fluid" dir="rtl">
                                    ...
                                    <div class="WidthText4" align="center">
                                        <div class="form-group" align="Right">
                                            <h5>أسباب الإعادة : <span style="color: red">*</span>
                                            </h5>

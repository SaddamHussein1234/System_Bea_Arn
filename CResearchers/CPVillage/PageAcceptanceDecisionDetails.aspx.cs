...
public partial class CResearchers_CPVillage_PageAcceptanceDecisionDetails : System.Web.UI.Page
{
    string XID;
    ...
    private void CheckAccountAdmin()
    {
        ...
        {
            bool A44;
            A44 = Convert.ToBoolean(dtViewProfil.Rows[0]["A44"]);
            if (A44 == false)
            {
                Response.Redirect("PageNotAccess.aspx");
            }
                ...
                try
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        IDBarcode.ImageUrl = "http://chart.apis.google.com/chart?cht=qr&chl=" + ClassSetting.FGetNameServer() +
                            "/Cpanel/PScanQQ.aspx?ID=" + txtSearch.Text.Trim() + "&chs=75";

<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageAcceptanceDecisionAdd.aspx.cs" Inherits="CResearchers_CPVillage_PageAcceptanceDecisionAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageAcceptanceDecisionAdd.aspx">إضافة قرار قبول</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
                                ...
                                <div class="container-fluid" dir="rtl">
                                    <div class="WidthText4">
                                        ...
                                        <div class="container-fluid" dir="rtl">
                                            <div class="WidthText2">
                                                <div class="form-group">
                                                    <h5>رقم التقرير : <span style="color: red">*</span>
                                                    </h5>

<%@ Page Title="" Language="C#" MasterPageFile="~/CResearchers/CPVillage/MPVillage.master" AutoEventWireup="true" CodeFile="PageRe_beneficiaryDetails.aspx.cs" Inherits="CResearchers_CPVillage_PageRe_beneficiaryDetails" %>
            ...
            <div class="container-fluid">
                <div class="pull-right">
                    ...
                    <div style="float: left">
                        <asp:Button ID="btnSearch" runat="server" Text="بحث" class="btn btn-info pull-right" data-toggle="tooltip" OnClick="btnSearch_Click" title="بحث" Style="margin-right: 4px" />
                        &nbsp;
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageRe_beneficiary.aspx">قرارات الإعادة</a></li>
                    <li><a href="">طلب إعادة مستفيد</a></li>
                </ul>
            </div>
        </div>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td align="center" style="width: 50%">
                        <asp:TextBox ID="txtTitle" runat="server" Font-Size="14px" class="form-control" placeholder="عنوان البحث" Text="طلب إعادة مستفيد" Style="text-align: center; width: 95%; background-color: #00cc1a; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                    </td>
                    <td align="center" style="width: 50%">
                                ...
                                <div class="content-box-large">
                                    <div class="container-fluid" dir="rtl">
                                        ...
                                        <div class="WidthText5">
                                            <div class="form-group">
                                                <p>
                                                    نأمل من سعادتكم الموافقة على طلب (إعادة مستفيد) المستفيد الموضحة بياناته بعاليه للأسباب التالية :-
                                                </p>
                                                <p>
                                        ...
                                        <div class="container-fluid" dir="rtl">
                                            ...
                                            <div class="WidthText5" runat="server" id="IDAllowAlZeyarah" visible="false">
                                                <div class="form-group">
                                                    ...
                                                    <span>يسمح بإعادة المستفيد </span>
                                                </div>
                                            </div>
                                            <div class="WidthText5" runat="server" id="IDNotAllowAlZeyarah" visible="false">
                                                <div class="form-group">
                                                    ...
                                                    <span>لا يسمح بإعادة المستفيد للأسباب التالية </span>
                                                    <br />
                                                    <br />

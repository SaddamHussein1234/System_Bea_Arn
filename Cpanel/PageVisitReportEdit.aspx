<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageVisitReportEdit.aspx.cs" Inherits="Cpanel_PageVisitReportEdit" %>
...
<!--
    ...
    <script type="text/javascript">
        ...
        function ConfirmDeleteMedical() {
            var count = document.getElementById("<%=hfCountMedical.ClientID %>").value;
            var gv = document.getElementById("<%=pnlDeviceMedical.ClientID%>");
            var chk = gv.getElementsByTagName("input");
            for (var i = 0; i < chk.length; i++) {
                if (chk[i].checked && chk[i].id.indexOf("chkAll") == -1) {
                    count++;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="content">
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">تعديل تقرير زيارة ميدانية</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
                ...
                <div class="panel-body">
                    <div class="content-box-large">
                        ...
                        <div class="container-fluid" dir="rtl">
                            <div class="WidthText3" runat="server" visible="false">
                                <div class="form-group">
                                    <h5>رقم الزيارة :
                                    </h5>
                                    <asp:TextBox ID="txtNumberVisit" runat="server" class="form-control" ValidationGroup="g2"></asp:TextBox>
                                    <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator1" runat="server"
                                        ControlToValidate="txtNumberVisit" ErrorMessage="* رقم المستفيد" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                        ValidationGroup="g2" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtNumberVisit"
                            ...
                            <div class="WidthText1">
                                <div class="form-group">
                                    ...
                                    <asp:Label ID="txtNumberMostafeed" runat="server" Text="0" class="form-control"></asp:Label>
                                    <%--<asp:TextBox ID="txtNumberMostafeed" runat="server" class="form-control" ValidationGroup="g2"></asp:TextBox>
                            ...
                            <div class="WidthText1">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtNumberReport" runat="server" class="form-control" ValidationGroup="g2" Enabled="false"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group date " style="margin-right: -10px">
                                            <asp:TextBox ID="txtDateReport" runat="server" class="form-control" Width="190" data-date-format="YYYY-MM-DD" ValidationGroup="g5" Style="direction: ltr"></asp:TextBox>
                            ...
                            <div class="WidthText1" runat="server" visible="false">
                                <div class="form-group">
                                    <br />
                                    <asp:LinkButton ID="LBUpdate" runat="server" CssClass="btn btn-info" data-toggle="tooltip" title="فحص الزيارة" ValidationGroup="g2" OnClick="LBUpdate_Click">
                                       فحص الزيارة <span class="tip-bottom"><i class="fa fa-edit" style="font-size:16px"></i></span></asp:LinkButton>
                                </div>
                            </div>
                        </div>
        ...
        <asp:Panel ID="pnlCheckData" runat="server" Visible="false">
                        ...
                        <div class="content-box-large">
                            <div class="widget-box">
                                <div class="container-fluid" dir="rtl">
                                    ...
                                    <div class="WidthText1">
                                        <div class="form-group">
                                            <h5>تاريخ الإحتياج : <span style="color: red">*</span>
                                            </h5>
                                            <div class="col-sm-3">
                                                <div class="input-group date " style="margin-right: -10px">
                                                    <asp:TextBox ID="txtDate" runat="server" class="form-control" Width="120" data-date-format="YYYY-MM-MM" ValidationGroup="GDevice" Style="direction: ltr"></asp:TextBox>
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-default" type="button">
                                                            <i class="fa fa-calendar"></i>
                                                        </button>
                                                    ...
                                                    <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator10" runat="server"
                                                        ControlToValidate="txtDate" ErrorMessage="* تاريخ الإحتياج" ForeColor="#FF0066"
                                                        meta:resourcekey="RequiredFieldValidator1Resource1" ValidationGroup="GDevice" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <asp:GridView ID="GVDevice" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItam"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="الجهاز" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# Library_CLS_Arn.WSM.WSM_ClassProduct.FProductName(Convert.ToInt32(Eval("IDDevice")))%>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="تاريخ الإضافة" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# ClassDataAccess.FCheckAndChangeF((DateTime) (Eval("DateAddDevice")))%>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-pencil"></i>
                            <asp:Label ID="Label70" runat="server" Text="إحتياجات الأجهزة الطبية"></asp:Label>
                        </h3>
                        <div style="float: left">
                            <asp:LinkButton ID="btnDeleteDevice" runat="server" class="btn btn-danger" OnClick="btnDeleteDevice_Click"
                                OnClientClick="return ConfirmDeleteMedical();" title="حذف" data-toggle="tooltip"><span class="tip-bottom">
                            <i class="fa fa-trash-o"></i></span></asp:LinkButton>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="content-box-large">
                            <div class="widget-box">
                                <div class="container-fluid" dir="rtl">
                                    <div class="WidthText1">
                                        <div class="form-group">
                                            <h5>حدد الجهاز : <span style="color: red">*</span>
                                            </h5>
                                            <asp:DropDownList ID="DLDiviceMedical" runat="server" Font-Size="Larger" Width="100%" CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;" ValidationGroup="GDeviceMedical">
                                                <asp:ListItem Value=""></asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator70" runat="server"
                                                ControlToValidate="DLDiviceMedical" ErrorMessage="* حدد الجهاز" ForeColor="#FF0066"
                                                meta:resourcekey="RequiredFieldValidator1Resource1" ValidationGroup="GDeviceMedical" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="WidthText1">
                                        <div class="form-group">
                                            <h5>العدد : <span style="color: red">*</span>
                                            </h5> 
                                            <asp:TextBox ID="txtNumberMedical" runat="server" Width="90%" ValidationGroup="GDeviceMedical" CssClass="form-control"></asp:TextBox>
                                            <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator11" runat="server"
                                                ControlToValidate="txtNumberMedical" ErrorMessage="* العدد" ForeColor="#FF0066"
                                                meta:resourcekey="RequiredFieldValidator1Resource1" ValidationGroup="GDeviceMedical" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="WidthText1">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group date " style="margin-right: -10px">
                                                    <asp:TextBox ID="txtDateMedical" runat="server" class="form-control" Width="120" data-date-format="YYYY-MM-DD" ValidationGroup="GDeviceMedical" Style="direction: ltr"></asp:TextBox>
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-default" type="button">
                                                            <i class="fa fa-calendar"></i>
                                                        </button>
                                                    </span>
                                                    <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator90" runat="server"
                                                        ControlToValidate="txtDateMedical" ErrorMessage="* تاريخ الإحتياج" ForeColor="#FF0066"
                                                        meta:resourcekey="RequiredFieldValidator1Resource1" ValidationGroup="GDeviceMedical" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="WidthText1">
                                        <div class="form-group">
                                            <br />
                                            <asp:Button ID="btnAddDeviceMedical" runat="server" Text="إضافة الجهاز" Style="margin-right: 4px;" OnClick="btnAddDeviceMedical_Click"
                                                class="btn btn-info btn-fill pull-left" ValidationGroup="GDeviceMedical" />
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid" dir="rtl">
                                    <asp:Panel ID="pnlDeviceMedical" runat="server" Visible="False">
                                        <asp:GridView ID="GVDeviceMedical" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Itam_"
                                            Width="100%" CssClass="footable1" EnableTheming="True" GridLines="Horizontal"
                                            UseAccessibleHeader="False">
                                            <Columns>
                                                <asp:TemplateField HeaderStyle-Width="10px">
                                                ...
                                                <asp:BoundField DataField="_ID_Itam_" HeaderText="_ID_Itam_" InsertVisible="False" ReadOnly="True"
                                                    SortExpression="_ID_Itam_" Visible="false" />
                                                <asp:TemplateField HeaderText="م" HeaderStyle-Width="10px" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <span style="margin-right: 5px"><%# Container.DataItemIndex + 1 %></span>
                                                    </ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfCountMedical" runat="server" Value="0" />
                                        <span style="font-size: 12px; padding-right: 5px">عدد الملفات : </span>
                                        <asp:Label ID="lblCountMedical" runat="server" Text="0" Style='color: Red; font-size: 12px'></asp:Label>
                                    </asp:Panel>
                                    <asp:Panel ID="pnlNullMedical" runat="server" Visible="False">
                                        <br />
                                        <br />
                                        <br />
                                        <div align="center">
            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-pencil"></i>
                            <asp:Label ID="Label8" runat="server" Text="ملاحظة الباحث"></asp:Label>
                        </h3>
                    </div>
                    <div class="panel-body">
                        <div class="content-box-large">
                                ...
                                <div class="container-fluid" dir="rtl">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txt_Note_Baheth" runat="server" ValidationGroup="g5" CssClass="form-control" TextMode="MultiLine" Rows="5"></asp:TextBox>
                                            <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator9" runat="server"
                                                ControlToValidate="txt_Note_Baheth" ErrorMessage="* الملاحظة" ForeColor="#FF0066"
                                                meta:resourcekey="RequiredFieldValidator1Resource1" ValidationGroup="g5" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                <div style="float: left">
                    <asp:Button ID="btnEdit" runat="server" Text="تعديل البيانات" Style="margin-right: 4px; font-size: medium"

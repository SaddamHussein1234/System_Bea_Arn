...
public partial class Cpanel_PageBeneficiarySourceOfIncome : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            txtTitle.Text = "قائمة إحصائية المستفيدين حسب مصدر الدخل ";
            //FGetNumberZero();
            FGetAlBaheth();
    ...
    private void FGetChartBySelect()
    {
        ...
        chartConfigAll.Add("caption", "إحصائية حسب مصدر الدخل");
        ...
        FusionCharts.Charts.Chart MyFirstChart = new FusionCharts.Charts.Chart("column2d", "first_chart", "100%", "285", "json", jsonData.ToString());
        // render chart
    ...
    protected void LBPrintAll_Click(object sender, EventArgs e)
    {
        ...
        //if (GVMostafeedByDakhl.Rows.Count > 14)
        //{
        ...
        //}
        //else if (GVMostafeedByDakhl.Rows.Count <= 14)
        //{
    ...
    private void FGetMostafeedByMasderAlDhal(int XID)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtSearchMostafeed.Text = "قائمة بيانات المستفيدين حسب مصدر دخل ( " + DLMasderAlDkhal.SelectedItem.ToString() + " ) ";

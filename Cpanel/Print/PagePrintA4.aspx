<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PagePrintA4.aspx.cs" Inherits="Cpanel_Print_PagePrintA4" %>
...
<head runat="server">
    <title></title>
    <style type="text/css">
        @page { margin: 11pt 0} @media print { @page { size: 297mm 210mm; margin: 5mm; size: A4; } }
    </style>
</head>
<body>

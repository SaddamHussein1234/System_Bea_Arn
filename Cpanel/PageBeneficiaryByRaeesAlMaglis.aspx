<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageBeneficiaryByRaeesAlMaglis.aspx.cs" Inherits="Cpanel_PageBeneficiaryByRaeesAlMaglis" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageBeneficiaryByRaeesAlMaglis.aspx">مستفيدين يحتاجون إلى موافقة رئيس المجلس</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>مستفيدين يحتاجون إلى موافقة رئيس المجلس
                        </h3>

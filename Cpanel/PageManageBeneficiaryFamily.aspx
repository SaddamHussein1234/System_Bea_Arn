<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageBeneficiaryFamily.aspx.cs" Inherits="Cpanel_PageManageBeneficiaryFamily" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVBeneficiaryFamilyAll.ClientID%>");
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageManageBeneficiaryFamily.aspx">قائمة قرابة عائلة المستفيد</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <asp:Label ID="lbmsg" runat="server" Text="إضافة قرابة عائلة المستفيد"></asp:Label>
                        </h3>
                    </div>
                                ...
                                <div class="container-fluid" dir="rtl">
                                    <div class="WidthText4">
                                        <div class="form-group">
                                            <h5>قرابة عائلة المستفيد : <span style="color: red">*</span>
                                            </h5>
                                            <asp:TextBox ID="txtName" runat="server" class="form-control" ValidationGroup="g2"></asp:TextBox>
                                            <asp:Label ID="lblName" runat="server" Text="* يرجى إضافة قرابة عائلة المستفيد" ForeColor="Red" Font-Size="11px" Visible="false"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="WidthText4">
                                        <div class="form-group">
            ...
            <div class="container-fluid" runat="server" id="view">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة قرابة عائلة المستفيد الموجودة في النظام
                        </h3>
                    ...
                    <div class="panel-body">
                        <asp:Panel ID="pnlData" runat="server">
                            <asp:GridView ID="GVBeneficiaryFamilyAll" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="قرابة عائلة المستفيد" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            <%# Eval("AlQarabah")%>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                        <ItemTemplate>
                                            <a href='PageManageBeneficiaryFamily.aspx?ID=<%# Eval("IDUniq")%>' title="تعديل"

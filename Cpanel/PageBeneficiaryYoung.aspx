<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageBeneficiaryYoung.aspx.cs" Inherits="Cpanel_PageBeneficiaryYoung" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageBeneficiaryYoung.aspx">إحصائية الشباب والفتيات</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <asp:Label ID="Label2" runat="server" Text="بيانات الشباب والفتيات"></asp:Label>
                        </h3>
                    ...
                    <div class="panel-body">
                        <div class="col-md-3">
                            <div class="form-group">
                                <h5>الشباب : </h5>
                                <small>من عمر : </small><asp:TextBox ID="txtAgeBoysmaller" Width="50" runat="server" class="form-control2" ValidationGroup="GAge" Text="17"></asp:TextBox>
                                <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator6" runat="server"
                                   ControlToValidate="txtAgeBoysmaller" ErrorMessage="*" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                ValidationGroup="GAge" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator> - 
                                <small>إلى عمر : </small><asp:TextBox ID="txtAgeBoyLarger" Width="50" runat="server" class="form-control2" ValidationGroup="GAge" Text="25"></asp:TextBox>
                                <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator2" runat="server"
                                   ControlToValidate="txtAgeBoyLarger" ErrorMessage="*" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                ValidationGroup="GAge" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <h5>الفتيات : </h5>
                                <small>من عمر : </small><asp:TextBox ID="txtAgeGirlssmaller" Width="50" runat="server" class="form-control2" ValidationGroup="GAge" Text="17"></asp:TextBox>
                                <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator1" runat="server"
                                   ControlToValidate="txtAgeGirlssmaller" ErrorMessage="*" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                ValidationGroup="GAge" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator> - 
                                <small>إلى عمر : </small><asp:TextBox ID="txtAgeGirlsLarger" Width="50" runat="server" class="form-control2" ValidationGroup="GAge" Text="25"></asp:TextBox>
                                <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator3" runat="server"
                                   ControlToValidate="txtAgeGirlsLarger" ErrorMessage="*" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                ValidationGroup="GAge" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <asp:RadioButtonList ID="RBLFilter" runat="server"  Height="34" Style="font-size: 12px; width: 140px">
                                    ...
                                    <asp:ListItem Value="_Boy">الشباب</asp:ListItem>
                                    <asp:ListItem Value="_Gir">الفتيات</asp:ListItem>
                                </asp:RadioButtonList>
                            </div>
                        </div>
                        <div class="col-md-2">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <th>
                                                            ...
                                                            <div style="float:left">
                                                                <span style="font-size: 12px; padding-right: 5px">عدد القُرى بحسب الملفات : </span>
                                                                <asp:Label ID="lblCountAitam" runat="server"  Style='color: Red; font-size: 12px'></asp:Label>
                                                            </div>
                                                            <div align="center">
                                                                <span style="font-size: 12px; padding-right: 5px">عدد الأسر بحسب الملفات : </span>

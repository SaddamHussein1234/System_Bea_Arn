<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageBeneficiaryAccommodationType.aspx.cs" Inherits="Cpanel_PageBeneficiaryAccommodationType" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageBeneficiaryAccommodationType.aspx">إحصائية حسب نوع المسكن</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <asp:Label ID="lbmsg" runat="server" Text="إحصائية حسب نوع المسكن"></asp:Label>
                        </h3>
            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>
                            <asp:Label ID="Label2" runat="server" Text="البيانات حسب نوع المسكن"></asp:Label>
                        </h3>
                        <div style="float: left">
                            نوع المسكن : 
                            <asp:DropDownList ID="DLTypeAlmaskan" runat="server" CssClass="dropdown" Height="34" Style="font-size: 12px; width: 140px">
                                <asp:ListItem Value=""></asp:ListItem>
                            </asp:DropDownList>

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/CRM/CRM_Main.master" AutoEventWireup="true" CodeFile="PageCash_SupportAdd.aspx.cs" Inherits="Cpanel_ERP_CRM_PageCash_Support_PageCash_SupportAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageCash_Support.aspx">فواتير الدعم النقدي</a></li>
                    <li><a href="PageCash_SupportAdd.aspx">إضافة فاتورة</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
                        ...
                        <div class="widget-box">
                            <div class="container-fluid">
                                ...
                                <div class="col-lg-3" runat="server" visible="false">
                                    <div class="form-group">
                                        <h5>مبلغ الفاتورة : <span class="required">*</span></h5>
                                        <asp:TextBox ID="txtMoney_Bill" runat="server" class="form-control" ValidationGroup="VGAddBill" TextMode="Number"></asp:TextBox>
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator3" runat="server"
                                            ControlToValidate="txtMoney_Bill" ErrorMessage="* مبلغ الفاتورة" ForeColor="#FF0066"
                                            meta:resourcekey="RequiredFieldValidator1Resource1" ValidationGroup="VGAddBill" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtNo_Bill"
                                            ErrorMessage="* أرقام فقط ..." ValidationExpression="^[0-9]+$" ValidationGroup="VGAddBill" Font-Size="10px"
                                            Display="Dynamic">
                                        </asp:RegularExpressionValidator>
                                    </div>
                                                ...
                                                <asp:GridView ID="GVBillAll" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="مبلغ الفاتورة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCountTotalPrice" runat="server" Font-Size="12px" 
                                                                    Text=' <%# Repostry_Cash_Donation_.FGetBillMony(new Guid(Eval("_ID_FinancialYear_").ToString()), Convert.ToInt64(Eval("_ID_Bill_"))) %>'></asp:Label>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                            <ItemTemplate>
                                                                <a href='<%=ResolveUrl("~/Cpanel/ERP/OM/Cash_Donation/PageView.aspx?ID=")%><%# Eval("_ID_Bill_")%>&IDUniq=<%# Eval("_ID_FinancialYear_")%>&Type=Moder' title="عرض الفاتورة" data-toggle="tooltip"
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td style="width: 20%; border: thin double #808080; border-width: 1px;" align="center">
                                                ...
                                                <small>
                                                    <asp:Label ID="lblSa" runat="server" Style='color: Red; font-size: 12px'></asp:Label>
                                                </small>
                                            </td>
                                        </tr>
                                    </table>

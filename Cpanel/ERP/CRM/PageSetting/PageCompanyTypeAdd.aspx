<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/CRM/CRM_Main.master" AutoEventWireup="true" CodeFile="PageCompanyTypeAdd.aspx.cs" Inherits="Cpanel_ERP_CRM_PageSetting_PageCompanyTypeAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageCompanyType.aspx">قائمة أنواع الشركات</a></li>
                    <li><a href="PageCompanyTypeAdd.aspx">إضافة/تعديل </a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <h5>العنوان : </h5>
                                        <asp:TextBox ID="txtCompanyType" runat="server" class="form-control" ValidationGroup="g2"></asp:TextBox>
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator4" runat="server"
                                            ControlToValidate="txtCompanyType" ErrorMessage="* العنوان" ForeColor="#FF0066"

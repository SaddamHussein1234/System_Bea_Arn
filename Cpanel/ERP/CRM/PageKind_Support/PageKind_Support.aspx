<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/CRM/CRM_Main.master" AutoEventWireup="true" CodeFile="PageKind_Support.aspx.cs" Inherits="Cpanel_ERP_CRM_PageKind_Support_PageKind_Support" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageKind_Support.aspx">قائمة الدعم العيني</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                                                ...
                                                <asp:GridView ID="GVBillAll" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderText="عدد مرات الدعم">
                                                            <ItemTemplate>
                                                                <%# Library_CLS_Arn.CRM.Repostry.Repostry_In_Kind_Support_.FCRM_In_Kind_Support_Manage(new Guid(ddlYears.SelectedValue), new Guid(Eval("_ID_Item_").ToString()), txtStartDate.Text.Trim(),txtEndDate.Text.Trim()) %>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                            <ItemTemplate>
                                                                <a href='PageKind_SupportByDate.aspx?IDYear=<%# ddlYears.SelectedValue %>&ID=<%# Eval("_ID_Item_")%>&From_Date=<%# txtStartDate.Text.Trim() %>&To_Date=<%# txtEndDate.Text.Trim() %>' title="عرض التفاصيل" data-toggle="tooltip"

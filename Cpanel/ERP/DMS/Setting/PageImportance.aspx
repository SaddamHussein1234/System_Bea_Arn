<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/DMS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageImportance.aspx.cs" Inherits="Cpanel_ERP_DMS_Setting_PageImportance" %>
...
<!--
    ...
    <script type="text/javascript">
        ...
        var gv = document.getElementById("<%=GVImportance.ClientID%>");
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageImportance.aspx"><asp:Label ID="lblListName" runat="server" Text="أهمية المعاملة"></asp:Label></a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <asp:Label ID="lblListName2" runat="server" Text="قائمة أهمية المعاملة"></asp:Label>
                        </h3>
                    </div>
                                ...
                                <div class="table table-responsive" id="pnlPrint" runat="server" dir="rtl">
                                    <table class='table table-bordered table-condensed' style="width: 100%" aria-multiline="true">
                                                    ...
                                                    <div align="center" class="w">
                                                        <div>
                                                            <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث"
                                                                ...
                                                                Text="قائمة أهمية المعاملة"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GVImportance" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"

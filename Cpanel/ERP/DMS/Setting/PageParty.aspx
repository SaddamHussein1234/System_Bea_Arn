<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/DMS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageParty.aspx.cs" Inherits="Cpanel_ERP_DMS_Setting_PageParty" %>
...
<!--
    ...
    <script type="text/javascript">
        ...
        var gv = document.getElementById("<%=GVParty.ClientID%>");
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageParty.aspx"><asp:Label ID="lblListName" runat="server" Text="الجهات"></asp:Label></a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                                ...
                                <div class="table table-responsive" id="pnlPrint" runat="server" dir="rtl">
                                    <table class='table table-bordered table-condensed' style="width: 100%" aria-multiline="true">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GVParty" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="رقم الجوال" HeaderStyle-ForeColor="#CCCCCC">
                                                                <ItemTemplate>
                                                                    <div style="text-align: left;"><%# Eval("_Phone_Number1_")  %></div>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Right" />
                                                                <ItemStyle HorizontalAlign="Right" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="البريد الإلكتروني" HeaderStyle-ForeColor="#CCCCCC">
                                                                <ItemTemplate>
                                                                    <div style="text-align: left;"><%# Eval("_Email_Address_")  %></div>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Right" />
                                                                <ItemStyle HorizontalAlign="Right" />
                                                            </asp:TemplateField>
                                ...
                                <div class=" panel-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="container-fluid" dir="rtl">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5 style="text-align: right">المدينة : </h5>
                                                    <asp:TextBox ID="txt_City_Add" runat="server" class="form-control text-left" ValidationGroup="VGAdd"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="container-fluid" dir="rtl">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtAddress_Add" runat="server" class="form-control text-left" ValidationGroup="VGAdd"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>البريد الإلكتروني : <i style="color: red">*</i></h5>
                                                    <asp:TextBox ID="txtEmail_Add" runat="server" class="form-control" ValidationGroup="VGAdd"
                                                         style="text-align:left; direction:ltr;"></asp:TextBox>
                                                    <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator34" runat="server"
                                                        ControlToValidate="txtEmail_Add" ErrorMessage="* البريد الالكتروني" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                                        ValidationGroup="VGAdd" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server"
                                                        ControlToValidate="txtEmail_Add" Font-Size="10px" ErrorMessage="بريد خطأ"
                                                        ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                                                        ForeColor="Red" ValidationGroup="VGAdd" Display="Dynamic"></asp:RegularExpressionValidator>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="container-fluid" dir="rtl">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtWebSite_Add" runat="server" class="form-control" ValidationGroup="VGAdd"
                                                         style="text-align:left; direction:ltr;"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>سنة التأسيس : </h5>
                                                    <asp:TextBox ID="txtEstablished_Year_Add" runat="server" class="form-control" Text="0" ValidationGroup="VGAdd"
                                                         style="text-align:left; direction:ltr;"></asp:TextBox>
                                                    <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator13" runat="server"
                                                        ControlToValidate="txtEstablished_Year_Add" ErrorMessage="* سنة التأسيس" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                                        ValidationGroup="VGAdd" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>الفاكس : </h5>
                                                    <asp:TextBox ID="txt_Fax_Add" runat="server" class="form-control" ValidationGroup="VGAdd"
                                                         style="text-align:left; direction:ltr;"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="container-fluid" dir="rtl">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>رقم المكتب : </h5>
                                                    <asp:TextBox ID="txtMobile_Number1_Add" runat="server" class="form-control" ValidationGroup="VGAdd" TextMode="Number" style="text-align:left; direction:ltr;"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>الرقم المباشر : </h5>
                                                    <asp:TextBox ID="txtPhone_Number2_Add" runat="server" class="form-control" ValidationGroup="VGAdd" TextMode="Number" style="text-align:left; direction:ltr;"></asp:TextBox>
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        <div class="container-fluid" dir="rtl">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5 style="text-align: right">العنوان إنجليزي : <i style="color: red">*</i></h5>
                                                    <asp:TextBox ID="txtName_En_Edit" runat="server" class="form-control text-left" ValidationGroup="VGEdit" 
                                                        Style="text-align: left; direction: ltr;" Text="-"></asp:TextBox>
                                        ...
                                        <div class="container-fluid" dir="rtl">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5 style="text-align: right">المدينة : </h5>
                                                    <asp:TextBox ID="txt_City_Edit" runat="server" class="form-control text-left" ValidationGroup="VGEdit"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="container-fluid" dir="rtl">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5 style="text-align: right">العنوان : </h5>
                                                    <asp:TextBox ID="txtAddress_Edit" runat="server" class="form-control text-left" ValidationGroup="VGEdit"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>البريد الإلكتروني : <i style="color: red">*</i></h5>
                                                    <asp:TextBox ID="txtEmail_Edit" runat="server" class="form-control" ValidationGroup="VGEdit"
                                                         style="text-align:left; direction:ltr;"></asp:TextBox>
                                                    <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator12" runat="server"
                                                        ControlToValidate="txtEmail_Edit" ErrorMessage="* البريد الالكتروني" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                                        ValidationGroup="VGEdit" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                        ControlToValidate="txtEmail_Edit" Font-Size="10px" ErrorMessage="بريد خطأ"
                                                        ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                                                        ForeColor="Red" ValidationGroup="VGEdit" Display="Dynamic"></asp:RegularExpressionValidator>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="container-fluid" dir="rtl">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>الموقع الإلكتروني : </h5>
                                                    <asp:TextBox ID="txtWebSite_Edit" runat="server" class="form-control" ValidationGroup="VGEdit"
                                                         style="text-align:left; direction:ltr;"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>سنة التأسيس : </h5>
                                                    <asp:TextBox ID="txtEstablished_Year_Edit" runat="server" class="form-control" ValidationGroup="VGEdit"
                                                         style="text-align:left; direction:ltr;"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>الفاكس : </h5>
                                                    <asp:TextBox ID="txt_Fax_Edit" runat="server" class="form-control" ValidationGroup="VGEdit"
                                                         style="text-align:left; direction:ltr;"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="container-fluid" dir="rtl">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>رقم المكتب : </h5>
                                                    <asp:TextBox ID="txtMobile_Number1_Edit" runat="server" class="form-control" ValidationGroup="VGEdit" TextMode="Number" style="text-align:left; direction:ltr;"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <h5>الرقم المباشر : </h5>
                                                    <asp:TextBox ID="txtPhone_Number2_Edit" runat="server" class="form-control" ValidationGroup="VGEdit" TextMode="Number" style="text-align:left; direction:ltr;"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 hide">
                                                <div class="form-group">
                                                    ...
                                                    <div class="keepmeLogged">
                                                        <label class="switch">
                                                            <input name="RememberMe" type="checkbox" id="CBAllow_Ar_Edit" runat="server" checked />
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-2 hide">
                                                <div class="form-group">
                                                    ...
                                                    <div class="keepmeLogged">
                                                        <label class="switch">
                                                            <input name="RememberMe" type="checkbox" id="CBAllow_En_Edit" runat="server" checked />
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </div>
                                                </div>

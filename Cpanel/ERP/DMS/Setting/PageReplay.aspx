<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/DMS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageReplay.aspx.cs" Inherits="Cpanel_ERP_DMS_Setting_PageReplay" %>
...
<script type="text/javascript">
    function ConfirmDelete() {
        ...
        var gv = document.getElementById("<%=GVReplay.ClientID%>");
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageReplay.aspx">
                    <asp:Label ID="lblListName" runat="server" Text="قائمة الردود"></asp:Label></a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    <asp:Label ID="lblListName2" runat="server" Text="قائمة الردود"></asp:Label>
                </h3>
            </div>
                        ...
                        <div class="table table-responsive" id="pnlPrint" runat="server" dir="rtl">
                            <table class='table table-bordered table-condensed' style="width: 100%" aria-multiline="true">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GVReplay" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"

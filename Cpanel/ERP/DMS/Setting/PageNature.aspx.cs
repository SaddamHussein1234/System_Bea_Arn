...
public partial class Cpanel_ERP_DMS_Setting_PageNature : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            txt_Order_Add.Text = (Repostry_DMS_Nature_.FGetCount("GetLastRecord", 1, Guid.Empty, new Guid(HFIDStore.Value), string.Empty, string.Empty, string.Empty, true, "IDOrder") + 1).ToString();
            FGeAllByDate();
        }
    }
    ...
    private void FGeAllByDate()
    {
        try
        {
            ...
            dt = Repostry_DMS_Nature_.FGetDataInDataTable("GeAll", 1000, Guid.Empty, new Guid(HFIDStore.Value),
              txtSearch.Text.Trim(), string.Empty, string.Empty, true);
            if (dt.Rows.Count > 0)
            {
                GVNature.DataSource = dt;
                GVNature.DataBind();
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (GridViewRow row in GVNature.Rows)
            {
                if ((row.FindControl("chkSelect") as CheckBox).Checked)
                {
                    Guid _XID = new Guid(GVNature.DataKeys[row.RowIndex].Value.ToString());
                    Xresult = Repostry_DMS_Nature_.FAPP("Delete", _XID, new Guid(HFIDStore.Value), string.Empty, string.Empty,
    ...
    protected void LBNew_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string Xresult = Repostry_DMS_Nature_.FAPP("Add", Guid.NewGuid(), new Guid(HFIDStore.Value), txtName_Ar_Add.Text.Trim(), txtName_En_Add.Text.Trim(),
    ...
    protected void LBEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataTable dt = new DataTable();
            dt = Repostry_DMS_Nature_.FGetDataInDataTable("GetByIDUniq", 1, new Guid(HF_ID.Value),
    ...
    protected void LBEditData_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string Xresult = Repostry_DMS_Nature_.FAPP("Edit", new Guid(HF_ID.Value), new Guid(HFIDStore.Value), txtName_Ar_Edit.Text.Trim(), txtName_En_Edit.Text.Trim(),

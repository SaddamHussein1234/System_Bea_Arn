<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/DMS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageAll.aspx.cs" Inherits="Cpanel_ERP_DMS_OutComingGeneral_PageAll" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVOutComingGeneral.ClientID%>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageAll.aspx">الصادر العام</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <i class="fa fa-list"></i>قائمة الصادر العام
                        </h3>
                    </div>
                            ...
                            <div class="col-sm-3">
                                <div id="IDNature" class="col-sm-12" style="display: none; <%= FCheck("Nature") %>">
                                    <div class="form-group">
                                        ...
                                        <script type="text/javascript">
                                            function jsNature(ch) {
                                                var allcheckboxes = document.getElementById('<%=CBNature.ClientID %>').getElementsByTagName("input");
                                                for (i = 0; i < allcheckboxes.length; i++)
                                                    allcheckboxes[i].checked = ch.checked;
                                            }
                                        </script>
                                        <div class="checkbox checkbox-primary" align="right">
                                            <asp:CheckBox ID="CBCheckAllNature" onclick="jsNature(this)" runat="server" 
                                                Text="تحديد الكل" CssClass="styled" Checked="true" />
                                        </div>
                                        <div class="checkbox checkbox-primary">
                                ...
                                <div id="IDImportance" class="col-sm-12" style="display: none; <%= FCheck("Importance") %>">
                                    <div class="form-group">
                                        ...
                                        <script type="text/javascript">
                                            function jsImportance(ch) {
                                                var allcheckboxes = document.getElementById('<%=CBImportance.ClientID %>').getElementsByTagName("input");
                                                for (i = 0; i < allcheckboxes.length; i++)
                                                    allcheckboxes[i].checked = ch.checked;
                                            }
                                        </script>
                                        <div class="checkbox checkbox-primary" align="right">
                                            <asp:CheckBox ID="CBCheckAllImportance" onclick="jsImportance(this)" runat="server" 
                                                Text="تحديد الكل" CssClass="styled" Checked="true" />
                                        </div>
                                        <div class="checkbox checkbox-primary">
                            ...
                            <div class="table table-responsive" runat="server" id="pnlDataPrint" dir="rtl">
                                <table class='table' style="width: 100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVOutComingGeneral" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_,_ID_Year_,_Number_File_"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="المرفقات" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LBViewAttachments" runat="server" CommandName='<%# Eval("_The_Title_") %>' 
                                                                    CommandArgument='<%# Eval("_ID_Item_") %>' OnClick="LBViewAttachments_Click" CssClass="btn btn-info"
                                                                    title="عرض المرفقات " data-toggle="tooltip"><i class="fa fa-file-pdf-o"></i> عرض</asp:LinkButton>
                                                                    <a href="PageAttachments.aspx?ID=<%# Eval("_ID_Item_") %>&Type=<%= Request.QueryString["Type"] %>" data-toggle="tooltip" title="إضافة المرفقات" 
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                            <ItemTemplate>
                                                                <a href="PageAdd.aspx?ID=<%# Eval("_ID_Item_") %>&Type=<%= Request.QueryString["Type"] %>" data-toggle="tooltip" title="تعديل الخطاب">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href='PageView.aspx?ID=<%# Eval("_Number_File_")%>&IDYears=<%# Eval("_ID_Year_")%>&Type=<%= Request.QueryString["Type"] %>' title="عرض الخطاب" data-toggle="tooltip"><span class="fa fa-eye"></span></a>
                                                            </ItemTemplate>
        ...
        <div id="IDAttachments" class="modal fade in modal_New_Style">
                        ...
                        <div class="page-container">
                            <div class="page-content">
                                <div class=" panel-body">
                                    ...
                                    <div align="center">
                                        <div class="" dir="rtl">
                                            <asp:Panel ID="pnlDataAttachments" runat="server" Visible="False">
                                            ...
                                            <asp:Panel ID="pnlNullAttachments" runat="server" Visible="False">
                                                <hr />
                                                <div align="center">
                                                    <h3 style="font-size: 20px">لا توجد مرفقات لهذا الخطاب
                                                    </h3>
                                                </div>
                                                <br />
                                                <br />

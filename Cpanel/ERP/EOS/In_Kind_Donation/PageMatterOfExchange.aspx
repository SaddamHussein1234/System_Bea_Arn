<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageMatterOfExchange.aspx.cs" Inherits="Cpanel_ERP_EOS_In_Kind_Donation_PageMatterOfExchange" %>
                    ...
                    <div class="content-box-large">
                        <div class="widget-box">
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-lg-2">
                                    <h5>
                                        <asp:Label ID="lblSend" runat="server" Text="إرسال SMS"></asp:Label> <i class="fa fa-envelope"></i> : <span style="color: red">*</span> <br /><small style="color: red">موقف مؤقتاً للصيانة</small>
                                    </h5>

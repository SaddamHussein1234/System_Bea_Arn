<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageMatterOfExchangeForDevice.aspx.cs" Inherits="Cpanel_ERP_EOS_In_Kind_Donation_PageMatterOfExchangeForDevice" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">إضافة أمر صرف عيني - أدوية وأجهزة</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="إنشاء أمر صرف عيني - أدوية وأجهزة"></asp:Label>
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLCategory" runat="server" ValidationGroup="GDetails" AutoPostBack="true" Enabled="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="العدد" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblProduct" runat="server" Font-Size="12px" Text='<%# Eval("_ID_Product_")%>' Visible="false"></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>

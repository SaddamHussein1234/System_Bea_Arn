<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageSupportByBeneficiaryMulti.aspx.cs" Inherits="Cpanel_ERP_EOS_In_Kind_Donation_PageSupportByBeneficiaryMulti" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-header" runat="server" id="IDTathith" visible="false">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="PageMatterOfExchange.aspx" data-toggle="tooltip" title="إضافة أمر صرف جديد" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GVExchangeOrders" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"
                                                ...
                                                UseAccessibleHeader="False" AllowPaging="false" PageSize="50">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="إسم المستفيد" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            <div style="font-size: 11px" >
                                                                <asp:Label ID="lblName" runat="server" Font-Size="12px" 
                                                                    Text='<%# Eval("NameMostafeed")%>'></asp:Label><br />
                                                                <div class="HideThis">
                                                    ...
                                                    <asp:TemplateField HeaderText="لمشروع" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            <%# DLCategory.SelectedItem.ToString() %>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="بتاريخ" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            ...
                                                            <div style="font-size: 11px" class="HideThis">
                                                                <span style="font-size: 11px">الباحث/</span><%# Eval("NameBaheth")%>
    ...
    <div class="page-header" runat="server" id="IDTarmem" visible="false">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="../Cash_Donation/PageMatterOfExchange.aspx" data-toggle="tooltip" title="إضافة أمر صرف جديد" class="btn btn-primary"><i class="fa fa-plus"></i></a>

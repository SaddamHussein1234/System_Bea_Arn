<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WUCSortingSupportForHomes.ascx.cs" Inherits="Cpanel_ERP_EOS_PageSheard_WUCSortingSupportForHomes" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="العدد الموزع" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            ...
                                            Text='<%# FGetCountCard(new Guid(Eval("_ID_FinancialYear_").ToString()),Convert.ToInt32(Eval("NumberMostafeed")),Convert.ToInt32(Eval("ID_Type"))) %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Right" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="الإجمالي" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCountTotalPrice" runat="server" Font-Size="12px" 
                                                Text='<%# FGetSumCard(new Guid(Eval("_ID_FinancialYear_").ToString()),Convert.ToInt32(Eval("NumberMostafeed")),Convert.ToInt32(Eval("ID_Type"))) %>'></asp:Label>
                                            <small>
                                                <%# XMony %>
                                            </small>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                        <ItemTemplate>
                                            <a href='PageSupportByBeneficiary.aspx?TIDX=<%# Eval("NumberMostafeed")%>&XIDCate=<%# Eval("ID_Type")%>&XIDFrom=<%# txtDateFrom.Text.Trim()%>&XIDTo=<%# txtDateTo.Text.Trim()%>&IDYear=<%# Eval("_ID_FinancialYear_")%>' title="عرض التفاصيل" data-toggle="tooltip"

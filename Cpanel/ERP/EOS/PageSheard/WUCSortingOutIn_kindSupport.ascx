<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WUCSortingOutIn_kindSupport.ascx.cs" Inherits="Cpanel_ERP_EOS_PageSheard_WUCSortingOutIn_kindSupport" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="العدد الموزع" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            ...
                                            Text='<%# FGetCountCard(new Guid(Eval("_ID_FinancialYear_").ToString()), Convert.ToInt32(Eval("_ID_MosTafeed_")) , Convert.ToInt32(Eval("_ID_Project_"))) %>'></asp:Label>
                                             <%# Eval("TypeCart") %>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Right" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    ...
                                    <asp:TemplateField HeaderText="الإجمالي" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCountTotalPrice" runat="server" Font-Size="12px" 
                                                Text='<%# WSM_Repostry_Exchange_Order_Details_.FGetBySumProject("ByGuest", new Guid(Eval("_ID_FinancialYear_").ToString()), Convert.ToInt32(Eval("_ID_MosTafeed_")) , Convert.ToInt32(Eval("_ID_Project_")), txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                            <small><%# XMony %></small>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Right" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    ...
                                    <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                        <ItemTemplate>
                                            <a href='PageSupportByBeneficiary.aspx?XID=<%# Eval("_ID_MosTafeed_")%>&XIDCate=<%# Eval("_ID_Project_")%>&XIDFrom=<%# txtDateFrom.Text.Trim()%>&XIDTo=<%# txtDateTo.Text.Trim()%>&IDYear=<%# Eval("_ID_FinancialYear_").ToString() %>' title="عرض التفاصيل" data-toggle="tooltip"

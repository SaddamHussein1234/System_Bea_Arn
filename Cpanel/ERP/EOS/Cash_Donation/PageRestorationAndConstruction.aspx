<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageRestorationAndConstruction.aspx.cs" Inherits="Cpanel_ERP_EOS_Cash_Donation_PageRestorationAndConstruction" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">إضافة أمر صرف بناء وترميم</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-9">
            ...
            <div runat="server" id="pnlMostafeed">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-pencil"></i>
                            <asp:Label ID="lbmsg" runat="server" Text="إنشاء أمر صرف بناء وترميم"></asp:Label>
                        </h3>
                        <div style="float: left">
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtNumberMostafeed" runat="server" class="form-control" ValidationGroup="GBill" AutoPostBack="true" OnTextChanged="txtNumberMostafeed_TextChanged" Enabled="false"></asp:TextBox>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLName" runat="server" ValidationGroup="GBill" Width="100%" CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;" AutoPostBack="true" OnSelectedIndexChanged="DLName_SelectedIndexChanged" Enabled="false">
                                            <asp:ListItem Value=""></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                        ...
                        <div class="content-box-large">
                            <div class="widget-box">
                                <div class="container-fluid" dir="rtl">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtThe_Mony" runat="server" class="form-control" ValidationGroup="GBill" AutoPostBack="false"></asp:TextBox>
                                ...
                                <div class="container-fluid" dir="rtl">
                                    ...
                                    <div class="col-md-4" style="display: none;">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="DLSupportType" runat="server" ValidationGroup="GBill" CssClass="form-control2 chzn-select dropdown" Enabled="false"
                                                Width="100%">
                                                <asp:ListItem></asp:ListItem>
                                            </asp:DropDownList>
                                ...
                                <div class="container-fluid" dir="rtl">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:CheckBox ID="CBFinish" runat="server" Text=" تحديد على أنه لا يحتاج مبلغ آخر " Font-Size="12px" />
                                            <br />

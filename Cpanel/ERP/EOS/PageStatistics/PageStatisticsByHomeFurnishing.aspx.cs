...
public partial class Cpanel_ERP_EOS_PageStatistics_PageStatisticsByHomeFurnishing : System.Web.UI.Page
{
    ...
    {
        ClassQuaem.FGetSupportType(0, "'3'", CBCategory);
        FSelectCheck(true);
    }
    ...
    {
        Response.Redirect("PageStatisticsByHomeFurnishing.aspx");
    }

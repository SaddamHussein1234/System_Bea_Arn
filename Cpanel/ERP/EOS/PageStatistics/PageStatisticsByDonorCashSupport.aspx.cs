...
public partial class Cpanel_ERP_EOS_PageStatistics_PageStatisticsByDonorCashSupport : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("PageStatisticsByDonorCashSupport.aspx");
    }
    ...
    private void FGetSupportType()
    {
        try
        {
            ...
            MSFP.IDCheck = "GetByPojectStaticByDonor";
            ...
            MSFP.DataCheck2 = XDonor.Substring(0, XDonor.Length - 1);
            MSFP.DataCheck3 = XCategory.Substring(0, XCategory.Length - 1);
            MSFP.IsTarmem = false;
            MSFP.IsBena = false;
            MSFP.IsDelete = false;
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblSumOperating_Expenses.Text = WSM_Repostry_Operating_Expenses_.FGetBySumByStaticByProject("GetBySumByStaticByProjectMulti", Guid.Empty,
                    0, txtDateFrom.Text.Trim(), txtDateTo.Text.Trim(), MSFP.DataCheck, MSFP.DataCheck3);

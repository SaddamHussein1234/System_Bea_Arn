<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageStatisticsCashSupport.aspx.cs" Inherits="Cpanel_ERP_EOS_PageStatistics_PageStatisticsCashSupport" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="">قائمة الإحصاء المالي حسب الدعم النقدي</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="عدد الأسر المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_SupportForPrisms_.FGetByCount_GuestGetStatic("CountFamilyGet", new Guid(Eval("IDYear").ToString()), Guid.Empty ,XCategory.Substring(0, XCategory.Length - 1), Convert.ToInt32(Eval("_Al_Qaryah_")),txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                ) أسره
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="العدد الموزع" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                Text='<%# Repostry_SupportForPrisms_.FGetByCount_GuestGetStatic("CountCartGet", new Guid(Eval("IDYear").ToString()), Guid.Empty ,XCategory.Substring(0, XCategory.Length - 1), Convert.ToInt32(Eval("_Al_Qaryah_")),txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="المبلغ الإجمالي" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountTotalPrice" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_SupportForPrisms_.FGetBySum_GuestGetStatic("SumCartGet", new Guid(Eval("IDYear").ToString()), Guid.Empty ,XCategory.Substring(0, XCategory.Length - 1), Convert.ToInt32(Eval("_Al_Qaryah_")),txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                    <small>

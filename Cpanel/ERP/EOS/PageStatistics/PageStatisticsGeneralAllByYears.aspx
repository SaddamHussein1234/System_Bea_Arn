<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageStatisticsGeneralAllByYears.aspx.cs" Inherits="Cpanel_ERP_EOS_PageStatistics_PageStatisticsGeneralAllByYears" %>
            ...
            <div class="container-fluid">
                ...
                ValidationGroup="GType" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:LinkButton ID="LBEditAge" runat="server" class="btn btn-info" data-toggle="tooltip"
                        title="تحديث النوع" ValidationGroup="GType" OnClick="LBEditAge_Click">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">قائمة الإحصاء المالي العام </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة الإحصاء المالي العام
                        </h3>
                    </div>
                            ...
                            <div class="table table-responsive" runat="server" id="pnlDataPrint" dir="rtl">
                                ...
                                <table class='table' style="width: 100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h5> الدعم العيني (<asp:Label ID="lblTotal" runat="server" Text="Label"></asp:Label>)</h5>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="القُرى المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <%# WSM_Repostry_Exchange_Order_Bill_.FSumQariah(new Guid(Eval("IDYear").ToString()), Guid.Empty, string.Empty,
                                                                    Convert.ToInt32(Eval("_ID_Project_")),txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue, string.Empty)%> / قرية
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="عدد الأسر المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px" 
                                                                    Text='<%# WSM_Repostry_Exchange_Order_Bill_.FSumFamily(new Guid(Eval("IDYear").ToString()), Guid.Empty, string.Empty,
                                                                    Convert.ToInt32(Eval("_ID_Project_")),txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue, string.Empty)%>'></asp:Label>
                                                                ) أسره           
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="العدد الموزع" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                ( 
                                                                <asp:Label ID="lbl_Count_Cart" runat="server" Text='<%# WSM_Repostry_Exchange_Order_Bill_.FSumCart(new Guid(Eval("IDYear").ToString()), Guid.Empty, string.Empty,
                                                                    Convert.ToInt32(Eval("_ID_Project_")),txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue, string.Empty)%>'></asp:Label>
                                                                ) 

                                                                <%# ClassQuaem.FTypeCart(Convert.ToInt64(Eval("_ID_Project_")))%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="المبلغ" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblSumTotal" runat="server" 
                                                                Text='<%# WSM_Repostry_Exchange_Order_Details_.FGetBySumProjectStatic("ByProject", new Guid(Eval("IDYear").ToString()), Guid.Empty,
                                                                    string.Empty, Convert.ToInt32(DLType.SelectedValue),
                                                                    txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), Convert.ToInt32(Eval("_ID_Project_")))%>'></asp:Label>
                                                                <%# XMony %>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="المصاريف التشغيلية" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <a href='../Operating_Expenses/PageAdd.aspx?IDYears=<%# Eval("IDYear") %>&IDP=<%# Eval("_ID_Project_") %>'
                                                                    data-toggle="tooltip" title="إضافة المصاريف التشغيلية">
                                                                    <i class="fa fa-money"></i>  
                                                                    <asp:Label ID="lblSumOperating_Expenses" runat="server" 
                                                                    Text='<%# WSM_Repostry_Operating_Expenses_.FGetBySumByStaticByProject("GetBySumByStaticByProject", new Guid(Eval("IDYear").ToString()), Convert.ToInt32(Eval("_ID_Project_")),
                                                ...
                                                <h5> البناء والترميم (<asp:Label ID="lblTotalHome" runat="server" Text="Label"></asp:Label>)</h5>
                                                <asp:GridView ID="GVFinancialStatisticsHome" runat="server" AutoGenerateColumns="False"
                                                    Width="100%" CssClass="footable1" EnableTheming="True" GridLines="Horizontal"
                                                    OnRowDataBound="GVFinancialStatisticsHome_RowDataBound"
                                                    UseAccessibleHeader="False">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="م" HeaderStyle-Width="10px" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="القُرى المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountQariah" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_BenaaAndTarmim_.FGetByCount_GuestGetStatic("CountQariahGetGeneral", new Guid(Eval("IDYear").ToString()),Guid.Empty, Eval("ID_Type").ToString() , 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                ) قرية
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="عدد الأسر المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                (
                                                                <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_BenaaAndTarmim_.FGetByCount_GuestGetStatic("CountFamilyGetGeneral", new Guid(Eval("IDYear").ToString()),Guid.Empty, Eval("ID_Type").ToString() , 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                ) أسره
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="العدد الموزع" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                Text='<%# Repostry_BenaaAndTarmim_.FGetByCount_GuestGetStatic("CountCartGetGeneral", new Guid(Eval("IDYear").ToString()),Guid.Empty, Eval("ID_Type").ToString(), 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                 <%# ClassQuaem.FTypeCart(Convert.ToInt64(Eval("ID_Type")))%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="المبلغ" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblSumTotal" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_BenaaAndTarmim_.FGetBySum_GuestGetStatic("SumCartGetGeneral", new Guid(Eval("IDYear").ToString()),Guid.Empty, Eval("ID_Type").ToString(), 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                    <small>
                                                                        <%# XMony %>
                                                                    </small>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="المصاريف التشغيلية" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <a href='../Operating_Expenses/PageAdd.aspx?IDYears=<%# Eval("IDYear") %>&IDP=<%# Eval("ID_Type") %>'
                                                                    data-toggle="tooltip" title="إضافة المصاريف التشغيلية">
                                                                    <i class="fa fa-money"></i>  
                                                                    <asp:Label ID="lblSumOperating_Expenses" runat="server" 
                                                                    Text='<%# WSM_Repostry_Operating_Expenses_.FGetBySumByStaticByProject("GetBySumByStaticByProject", new Guid(Eval("IDYear").ToString()), Convert.ToInt32(Eval("ID_Type")),
                                                                        txtDateFrom.Text.Trim(), txtDateTo.Text.Trim(), string.Empty, string.Empty) %>'></asp:Label>
                                                                        <%# XMony %>
                                                                </a>
                                                            </ItemTemplate>
                                                ...
                                                <hr style='border: solid; border-width: 1px; width: 100%' />
                                                <h5> الدعم النقدي (<asp:Label ID="lblTotalMony" runat="server" Text="Label"></asp:Label>)</h5>
                                                <asp:GridView ID="GVFinancialStatisticsMony" runat="server" AutoGenerateColumns="False"
                                                    Width="100%" CssClass="footable1" EnableTheming="True" GridLines="Horizontal"
                                                    OnRowDataBound="GVFinancialStatisticsMony_RowDataBound"
                                                    UseAccessibleHeader="False">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="م" HeaderStyle-Width="10px" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>

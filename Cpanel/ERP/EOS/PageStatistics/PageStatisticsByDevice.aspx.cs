...
public partial class Cpanel_ERP_EOS_PageStatistics_PageStatisticsByDevice : System.Web.UI.Page
{
    ...
    {
        ClassQuaem.FGetSupportType(0, "'2'", CBCategory);
        FSelectCheck(true);
    }
    ...
    {
        Response.Redirect("PageStatisticsByDevice.aspx");
    }

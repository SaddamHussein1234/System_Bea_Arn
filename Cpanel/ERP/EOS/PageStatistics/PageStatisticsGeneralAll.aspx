<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageStatisticsGeneralAll.aspx.cs" Inherits="Cpanel_ERP_EOS_PageStatistics_PageStatisticsGeneralAll" %>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="القُرى المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <%# WSM_Repostry_Exchange_Order_Bill_.FSumQariahAll(Guid.Empty, Guid.Empty, string.Empty,
                                                        ...
                                                        <asp:TemplateField HeaderText="عدد الأسر المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px" 
                                                                    Text='<%# WSM_Repostry_Exchange_Order_Bill_.FSumFamilyAll(Guid.Empty, Guid.Empty, string.Empty,
                                                        ...
                                                        <asp:TemplateField HeaderText="العدد الموزع" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                ( 
                                                                <asp:Label ID="lbl_Count_Cart" runat="server" Text='<%# WSM_Repostry_Exchange_Order_Bill_.FSumCartAll(Guid.Empty, Guid.Empty, string.Empty,
                                                                    Convert.ToInt32(Eval("_ID_Project_")),txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue, string.Empty)%>'></asp:Label>
                                                                ) 
                                                        ...
                                                        <asp:TemplateField HeaderText="التجزئة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <i class="fa fa-cart-plus"></i> 
                                                                ( 
                                                                <asp:Label ID="lbl_Count_Cart_Part" runat="server" Text='<%# WSM_Repostry_Exchange_Order_Bill_.FSumCartAllPart(Guid.Empty, Guid.Empty, string.Empty,
                                                                    Convert.ToInt32(Eval("_ID_Project_")),txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue, string.Empty)%>'></asp:Label>
                                                                ) 

                                                                <%# ClassQuaem.FTypeCartPart(Convert.ToInt64(Eval("_ID_Project_")))%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="المبلغ" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblSumTotal" runat="server" Text='<%# Eval("_Sum")%>'></asp:Label> 
                                                                 <%# XMony %>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="المصاريف التشغيلية" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblSumOperating_Expenses" runat="server"
                                                                    Text='<%# WSM_Repostry_Operating_Expenses_.FGetBySumByStaticByProject("GetBySumByStaticByProjectAll", Guid.Empty, Convert.ToInt32(Eval("_ID_Project_")),
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="القُرى المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountQariah" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_BenaaAndTarmim_.FGetByCount_GuestGetStatic("CountQariahGetGeneralAll", Guid.Empty, Guid.Empty, Eval("ID_Type").ToString() , 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                ) قرية
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="عدد الأسر المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                (
                                                                <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_BenaaAndTarmim_.FGetByCount_GuestGetStatic("CountFamilyGetGeneralAll", Guid.Empty, Guid.Empty, Eval("ID_Type").ToString() , 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                ) أسره
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="المصاريف التشغيلية" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <i class="fa fa-money"></i>  
                                                                <asp:Label ID="lblSumOperating_Expenses" runat="server" 
                                                                Text='<%# WSM_Repostry_Operating_Expenses_.FGetBySumByStaticByProject("GetBySumByStaticByProjectAll", Guid.Empty, Convert.ToInt32(Eval("ID_Type")),
                                                                    txtDateFrom.Text.Trim(), txtDateTo.Text.Trim(), string.Empty, string.Empty) %>'></asp:Label>
                                                                    <%# XMony %>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="القُرى المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                (
                                                                <asp:Label ID="lblCountQariah" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_SupportForPrisms_.FGetByCount_GuestGetStatic("CountQariahGetGeneralAll", Guid.Empty, Guid.Empty , Eval("ID_Project_").ToString() , 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                ) قرية
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="عدد الأسر المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                (
                                                                <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_SupportForPrisms_.FGetByCount_GuestGetStatic("CountFamilyGetGeneralAll", Guid.Empty, Guid.Empty , Eval("ID_Project_").ToString() , 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                ) أسره
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="المصاريف التشغيلية" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <i class="fa fa-money"></i>  
                                                                <asp:Label ID="lblSumOperating_Expenses" runat="server" 
                                                                Text='<%# WSM_Repostry_Operating_Expenses_.FGetBySumByStaticByProject("GetBySumByStaticByProjectAll", Guid.Empty, Convert.ToInt32(Eval("ID_Project_")),
                                                                    txtDateFrom.Text.Trim(), txtDateTo.Text.Trim(), string.Empty, string.Empty) %>'></asp:Label>
                                                                <%# XMony %>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />

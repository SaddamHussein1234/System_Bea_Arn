<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageStatisticsByDonorCashSupport.aspx.cs" Inherits="Cpanel_ERP_EOS_PageStatistics_PageStatisticsByDonorCashSupport" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="">قائمة الإحصاء حسب الداعمين للدعم النقدي</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة الإحصاء حسب الداعمين للدعم النقدي
                        </h3>
                    </div>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="القُرى المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountQariah" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_SupportForPrisms_.FGetByCount_GuestGetStatic("CountQariahGetByDonor", new Guid(Eval("IDYear").ToString()), new Guid(Eval("IDDonor").ToString()), Eval("ID_Project_").ToString() , 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                ) قرية
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="عدد الأسر المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_SupportForPrisms_.FGetByCount_GuestGetStatic("CountFamilyGetByDonor", new Guid(Eval("IDYear").ToString()), new Guid(Eval("IDDonor").ToString()), Eval("ID_Project_").ToString() , 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                ) أسره
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="العدد الموزع" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                Text='<%# Repostry_SupportForPrisms_.FGetByCount_GuestGetStatic("CountCartGetByDonor", new Guid(Eval("IDYear").ToString()), new Guid(Eval("IDDonor").ToString()), Eval("ID_Project_").ToString(), 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="المبلغ الإجمالي" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountTotalPrice" runat="server" Font-Size="12px" 
                                                                    Text='<%# Repostry_SupportForPrisms_.FGetBySum_GuestGetStatic("SumCartGetByDonor", new Guid(Eval("IDYear").ToString()), new Guid(Eval("IDDonor").ToString()), Eval("ID_Project_").ToString(), 0,txtDateFrom.Text.Trim(), txtDateTo.Text.Trim()) %>'></asp:Label>
                                                                    <small>

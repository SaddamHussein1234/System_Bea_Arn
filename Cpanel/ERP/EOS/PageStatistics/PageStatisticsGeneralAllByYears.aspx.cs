...
public partial class Cpanel_ERP_EOS_PageStatistics_PageStatisticsGeneralAllByYears : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("PageStatisticsGeneralAllByYears.aspx");
    }
    ...
    private void FGetData()
    {
        ...
        FGetSupportType(); FGetSupportTypeHome(); FGetSupportTypeMony();
    ...
    private void FGetSupportTypeHome()
    {
        try
        {
    ...
    private void FGetSupportTypeMony()
    {
        try
        {
            string XYears = string.Empty, XYearsName = string.Empty, XCategory = string.Empty, XCategoryName = string.Empty;

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageStatisticsGeneral.aspx.cs" Inherits="Cpanel_ERP_EOS_PageStatistics_PageStatisticsGeneral" %>
            ...
            <asp:LinkButton ID="LBEditAge" runat="server" class="btn btn-info" data-toggle="tooltip"
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="">قائمة الإحصاء المالي العام للدعم العيني</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                                                        ...
                                                        <asp:Repeater ID="RPTProductAll" runat="server">
                                                            <ItemTemplate>
                                                                <div class='Width10Percint StyleTD' style="height: 50px;">
                                                                    <span style="font-size: 11px;"><%# Eval("ProductName") %></span> : 
                                                                    <span style="font-size: 11px;">(<%# WSM_Repostry_Exchange_Order_Details_.FSumPojectStaticGeneralSum(Guid.Empty, Guid.Empty, Guid.Empty, Convert.ToInt32(Eval("ProductID")), 504, txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue, XYears.Substring(0, XYears.Length - 1), XCategory.Substring(0, XCategory.Length - 1)) %>)</span>
                                                                    <span style="font-size: 10px;"><%# Eval("UnitName") %></span>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
                                                    </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageStatisticsByHomeFurnishing.aspx.cs" Inherits="Cpanel_ERP_EOS_PageStatistics_PageStatisticsByHomeFurnishing" %>
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">قائمة الإحصاء المالي لدعم تأثيث المنازل</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-list"></i>قائمة الإحصاء المالي للدعم لدعم تأثيث المنازل
                    </h3>
                </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="إسم القرية" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            ...
                                                            <%# ClassQuaem.FAlQarabah((Int32) (Eval("ID_Qariah")))%>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            (
                                                                    <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px"
                                                                        Text='<%# WSM_Repostry_Exchange_Order_Bill_.FSumFamilyByQariah(new Guid(Eval("IDYear").ToString()), Guid.Empty, XCategory.Substring(0, XCategory.Length - 1) ,
                                                                        Convert.ToInt32(Eval("ID_Qariah")),txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue, string.Empty)%>'></asp:Label>
                                                            ) أسره              
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    ...
                                                    <asp:TemplateField HeaderText="العدد الموزع" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            ...
                                                            ( 
                                                                <asp:Label ID="lbl_Count_Cart" runat="server" 
                                                                    Text='<%# WSM_Repostry_Exchange_Order_Bill_.FSumCartByQariah(new Guid(Eval("IDYear").ToString()), Guid.Empty,  XCategory.Substring(0, XCategory.Length - 1) ,
                                                                        Convert.ToInt32(Eval("ID_Qariah")),txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue, string.Empty)%>'></asp:Label>
                                                                    ) 
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                    ...
                                                    <asp:TemplateField HeaderText="المبلغ الإجمالي" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblCountTotalPrice" runat="server" 
                                                                    Text='<%# WSM_Repostry_Exchange_Order_Details_.FGetBySumProjectStatic("ByQariah", new Guid(Eval("IDYear").ToString()), Guid.Empty,
                                                                        XCategory.Substring(0, XCategory.Length - 1), Convert.ToInt32(DLType.SelectedValue),
                                                                        txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), Convert.ToInt32(Eval("ID_Qariah")))%>'></asp:Label>
                                                            <small>
                                            ...
                                            <div>
                                                <span style="font-size: 12px; padding-right: 5px">عدد الأسر المستفيدة : 
                                                    <asp:Label ID="lbl_Count" runat="server" Text="0"></asp:Label>
                                                    أسرة 

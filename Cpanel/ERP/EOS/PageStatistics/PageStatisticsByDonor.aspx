<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageStatisticsByDonor.aspx.cs" Inherits="Cpanel_ERP_EOS_PageStatistics_PageStatisticsByDonor" %>
            ...
            <asp:LinkButton ID="LBEditAge" runat="server" class="btn btn-info" data-toggle="tooltip"
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="">قائمة الإحصاء المالي حسب الداعمين للدعم العيني</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة الإحصاء المالي حسب الداعمين للدعم العيني
                        </h3>
                    </div>
                    <div class="panel-body">
                        <asp:Panel ID="IDFilter" runat="server" ScrollBars="Auto" Height="250">
                            ...
                            <div class="col-sm-5">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <h5><i class="fa fa-star"></i> حدد الداعم : </h5>
                                        <div class="checkbox checkbox-primary">
                                            <asp:CheckBoxList ID="CBDonors" runat="server"
                                                RepeatDirection="Vertical" CssClass="styled" Width="100%">
                                                <asp:ListItem></asp:ListItem>
                                            </asp:CheckBoxList>
                                        </div>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="الداعم" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <%# Library_CLS_Arn.CRM.Repostry.Repostry_Company_.FCRM_Company_Manage(new Guid(Eval("IDDonor").ToString()))%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="القُرى المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <%--<%# WSM_Repostry_Exchange_Order_Bill_.FGetByCount_QariahStatic("QariahByByDonor", new Guid(Eval("IDYear").ToString()), new Guid(Eval("IDDonor").ToString()), string.Empty,
                                                                    Convert.ToInt32(Eval("_ID_Project_")),txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue , string.Empty)%> / قرية--%>

                                                                <%# WSM_Repostry_Exchange_Order_Bill_.FSumQariahByDonor(new Guid(Eval("IDYear").ToString()), new Guid(Eval("IDDonor").ToString()),
                                                                    string.Empty, Convert.ToInt32(Eval("_ID_Project_")), txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue , string.Empty)%> / قرية
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="عدد الأسر المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px" 
                                                                    Text='<%# WSM_Repostry_Exchange_Order_Bill_.FSumFamilyByDonor(new Guid(Eval("IDYear").ToString()), new Guid(Eval("IDDonor").ToString()), string.Empty,
                                                        ...
                                                        <asp:TemplateField HeaderText="العدد الموزع" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                ( 
                                                            <asp:Label ID="lbl_Count_Cart" runat="server" Text='<%# WSM_Repostry_Exchange_Order_Bill_.FSumCartByDonor(new Guid(Eval("IDYear").ToString()), new Guid(Eval("IDDonor").ToString()), string.Empty,
                                                                    Convert.ToInt32(Eval("_ID_Project_")),txtDateFrom.Text.Trim(),txtDateTo.Text.Trim(), DLType.SelectedValue, string.Empty)%>'></asp:Label>
                                                        ...
                                                        <asp:TemplateField HeaderText="المبلغ الإجمالي" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblCountTotalPrice" runat="server" 
                                                                Text='<%# WSM_Repostry_Exchange_Order_Details_.FGetBySumProjectStatic("ByProjectByDonor", new Guid(Eval("IDYear").ToString()), new Guid(Eval("IDDonor").ToString()),
                                                ...
                                                <table style="width: 100%;">
                                                    <tr>
                                                        ...
                                                        <td style="width: 20%; border: thin double #808080; border-width: 1px;" align="center">
                                                            ...
                                                            <asp:Label ID="lblMonyOperating_Expenses" runat="server" Style='color: Red; font-size: 12px'></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>

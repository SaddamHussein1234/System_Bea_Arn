<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/EOS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageApprovalOfTheDirector.aspx.cs" Inherits="Cpanel_ERP_EOS_PageAllow_PageApprovalOfTheDirector" %>
                ...
                <div class="collapse" id="navbarToggleExternalContent" style="background-color: #ecedec">
                    <div class="bg-dark p-4" style="padding: 5px 5px 10px 0">
                        ...
                        <span class="text-muted">
                            ...
                            <i class="fa fa-minus"></i>
                            <asp:RadioButton ID="RBTalefCheck" runat="server" GroupName="RBCard" AutoPostBack="true" Enabled="false"
                                OnCheckedChanged="RBTalefCheck_CheckedChanged" />

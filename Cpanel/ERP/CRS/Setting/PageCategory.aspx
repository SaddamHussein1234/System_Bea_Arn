<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/CRS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageCategory.aspx.cs" Inherits="Cpanel_ERP_CRS_Setting_PageCategory" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>قائمة أنواع تقارير اللجان</li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <asp:Label ID="lblCustomer_Case2" runat="server" Text="قائمة أنواع تقارير اللجان"></asp:Label>
                        </h3>
                    </div>
                                                    ...
                                                    <div align="center" class="w">
                                                        <div>
                                                            <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث"
                                                                ...
                                                                Text="قائمة أنواع تقارير اللجان"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/CRS/MPCPanel.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Cpanel_ERP_CRS_Default" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row" style="margin: 5px; text-align: center">
                <div class="col-md-12" style="border: solid; border-width: 3px; border-color: #006011; border-radius: 5px">
                    <br />
                    <h3 style="font-family: 'Alwatan';">نظام تقارير اللجان - CRS
                    </h3>
                    <br />
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6" id="pnlMenuArn" runat="server" visible="true">
                <a href="<%=ResolveUrl("~/Cpanel/ERP/CRS/Setting/PageCategory.aspx")%>" data-toggle="tooltip" title="أنواع تقارير اللجان">
                    <div class="tile">
                        <div class="tile-heading">
                            أنواع تقارير اللجان <span class="pull-right"></span>
                        </div>
                        <div class="tile-body">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6" id="Div1" runat="server" visible="true">
                <a href="<%=ResolveUrl("~/Cpanel/ERP/CRS/Committee_Report/PageAll.aspx")%>" data-toggle="tooltip" title="تقارير اللجان">
                    <div class="tile">
                        <div class="tile-heading">
                            تقارير اللجان <span class="pull-right"></span>
                        </div>
                        <div class="tile-body">

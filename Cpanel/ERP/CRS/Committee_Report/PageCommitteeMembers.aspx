<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/CRS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageCommitteeMembers.aspx.cs" Inherits="Cpanel_ERP_CRS_Committee_Report_PageCommitteeMembers" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVCommitteeMembers.ClientID%>");
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageCommitteeMembers.aspx">قائمة تقارير اللجنة </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة تقارير اللجنة - موافقة رئيس وأعضاء اللجنة
                        </h3>
                            ...
                            <div class="table table-responsive">
                                ...
                                <table class='table' style="width: 100%">
                                        ...
                                        <tr>
                                            <th>
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة تقارير اللجنة التي تحتاج إلى موافقة رئيس وأعضاء اللجنة" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVCommitteeMembers" runat="server" AutoGenerateColumns="False" DataKeyNames="ID_Item"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="حالة الموافقة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                  <%# ClassSaddam.FCheckActiveF((bool) (Eval("_Is_Admin_")), false)%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                            <ItemTemplate>
                                                                <a href='PageView.aspx?ID=<%# Eval("_Nmber_")%>&IDUniq=<%# Eval("_ID_Item_")%>' title="عرض التقرير" data-toggle="tooltip"

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/CRS/MPCPanel.master" AutoEventWireup="true" CodeFile="PageChairmanOfTheBoard.aspx.cs" Inherits="Cpanel_ERP_CRS_Committee_Report_PageChairmanOfTheBoard" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageChairmanOfTheBoard.aspx">قائمة تقارير اللجنة </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة تقارير اللجنة - موافقة رئيس المجلس
                        </h3>
                                        ...
                                        <tr>
                                            <th>
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة تقارير اللجنة التي تحتاج إلى موافقة رئيس مجلس الإدارة" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/WSM/MPCPanel.master" AutoEventWireup="true" CodeFile="PageMatterOfExchangeForDamaged.aspx.cs" Inherits="Cpanel_ERP_WSM_In_Kind_Donation_PageMatterOfExchangeForDamaged" %>
                        ...
                        <div class="container-fluid" dir="rtl">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <h5>المشروع : <span style="color: red">*</span>
                                    </h5>
                                    <asp:DropDownList ID="DLSupportType" runat="server" ValidationGroup="GDetails" CssClass="form-control2 chzn-select dropdown" Width="250">
                                        <asp:ListItem></asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="DLInitiatives" runat="server" ValidationGroup="GBill" Width="100%" Enabled="false"
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <asp:LinkButton ID="LBGetBill" runat="server" data-toggle="tooltip" OnClick="LBGetBill_Click"
                                        title="جلب أصناف سابقة"> <i class="fa fa-refresh"></i> </asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content-box-large">
                        <div class="widget-box">
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <h5>الباحث الذي سيستلم الشحنة : <span style="color: red">*</span>
                                        </h5>

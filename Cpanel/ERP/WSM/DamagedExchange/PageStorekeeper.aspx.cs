...
public partial class Cpanel_ERP_WSM_DamagedExchange_PageStorekeeper : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            CLS_Permissions.CheckAccountAdmin("A107");
    ...
    private void FArnProductShopByNaeeb(bool Cart, bool Device, bool Tathith, bool Talef)
    {
        try
        {
            ...
            MEOB.IDCheck = "GetByStorekeeperDamaged";

...
public partial class Cpanel_ERP_WSM_DamagedExchange_PageChairmanOfTheBoard : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            CLS_Permissions.CheckAccountAdmin("A110");
    ...
    private void FArnProductShopByNaeeb(bool Cart, bool Device, bool Tathith, bool Talef)
    {
        try
        {
            ...
            MEOB.IDCheck = "GetByChairmanOfTheBoardDamaged";
            ...
            if (dt.Rows.Count > 0)
            {
                txtTitle.Text = "إرشيف " + ddlYears.SelectedItem.ToString() + " , قائمة أوامر الصرف التي تحتاج إلى موافقة رئيس المجلس ( التالف ) ";

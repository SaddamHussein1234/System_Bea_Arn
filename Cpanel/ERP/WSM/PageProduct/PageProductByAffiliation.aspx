<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/WSM/MPCPanel.master" AutoEventWireup="true" CodeFile="PageProductByAffiliation.aspx.cs" Inherits="Cpanel_ERP_WSM_PageProduct_PageProductByAffiliation" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="~/Cpanel/ERP/WSM/PageAffiliation/PageAll.aspx" data-toggle="tooltip" title="إضافة إنتماء جديد" class="btn btn-primary" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="">قائمة المنتجات حسب الإنتماء</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/WSM/MPCPanel.master" AutoEventWireup="true" CodeFile="PageStatistics.aspx.cs" Inherits="Cpanel_ERP_WSM_Statistics_PageStatistics" %>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="الكمية" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <%# WSM_Repostry_In_Kind_Donation_Details_.FGetCountProduct("GetStaticCountByProject", new Guid(Eval("IDYear").ToString()), Convert.ToInt64(Eval("ID_Product")),
                                                        ...
                                                        <asp:TemplateField HeaderText="التجزئة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <i class="fa fa-area-chart"></i>
                                                                <%# WSM_Repostry_In_Kind_Donation_Details_.FGetCountProduct("GetStaticCountPartitionByProject", new Guid(Eval("IDYear").ToString()), Convert.ToInt64(Eval("ID_Product")),
                                                                    txtDateFrom.Text.Trim(), txtDateTo.Text.Trim(), string.Empty, Eval("ID_Project").ToString() , string.Empty) %> / 
                                                        ...
                                                        <asp:TemplateField HeaderText="المبلغ الإجمالي" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <i class="fa fa-money"></i>
                                                                    <asp:Label ID="lblCountTotalPrice" runat="server" Font-Size="12px" Text='<%# WSM_Repostry_In_Kind_Donation_Details_.FGetCountProduct("GetStaticSumByProject", new Guid(Eval("IDYear").ToString()), Convert.ToInt64(Eval("ID_Product")),
                                                        ...
                                                        <asp:Repeater ID="RPTProductAll" runat="server">
                                                            <ItemTemplate>
                                                                <div class='Width10Percint StyleTD' style="height: 50px;">
                                                                    ...
                                                                    <%# WSM_Repostry_In_Kind_Donation_Details_.FGetCountProduct("GetStaticCountPartitionByProjectAll", Guid.Empty, Convert.ToInt64(Eval("ID_Product")),

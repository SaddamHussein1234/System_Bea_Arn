<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageEmployeeMandatesByRaees.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Transactions_PageEmployeeMandatesByRaees" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVEmpMandateByManager.ClientID%>");
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageEmployeeMandateAdd.aspx" data-toggle="tooltip" title="إضافة إنتداب لموظف" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageEmployeeMandatesByRaees.aspx">ملفات تحتاج إلى مدير الجمعية</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div align="left">
                            <asp:Button ID="btnAllow" runat="server" Text="تمت المهمة بشكل كامل" class="btn btn-info" OnClientClick="return ConfirmDelete();" OnClick="btnAllow_Click" />
                            <asp:Button ID="btnNotAllow" runat="server" Text="تمت المهمة مع الملاحظات التالية" class="btn btn-warning" ValidationGroup="GNotAllow"
                            ...
                            <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                                <table class='table' style="width: 100%">
                                                ...
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث" 
                                                            ...
                                                            Text="قائمة الإنتدابات التي تحتاج إلى موافقة المشرف المختص"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVEmpMandateByManager" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeMandateMapID"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Number_Mandate_" HeaderText="رقم الإنتداب" SortExpression="Number_Mandate_"
                                                        ...
                                                        <asp:BoundField DataField="MandateTitle" HeaderText="العنوان" SortExpression="MandateTitle"
                                                            HeaderStyle-ForeColor="#CCCCCC" />
                                                        ...
                                                        <asp:TemplateField HeaderText="تاريخ الإنتداب" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                            <ItemTemplate>
                                                                <a href='PageEmployeeMandateByView.aspx?IDYear=<%# Eval("FinancialYear_Id_") %>&ID=<%# Eval("Number_Mandate_") %>&IDU=<%# Eval("EmployeeMandateMapID")%>' 

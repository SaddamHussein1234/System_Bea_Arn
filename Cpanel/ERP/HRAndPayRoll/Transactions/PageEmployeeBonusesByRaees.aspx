<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageEmployeeBonusesByRaees.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Transactions_PageEmployeeBonusesByRaees" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVEmpBonusesByManager.ClientID%>");
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageEmployeeBonusesAdd.aspx" data-toggle="tooltip" title="إضافة مكافئة لموظف" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageEmployeeBonusesByRaees.aspx">ملفات تحتاج إلى موافقة المشرف المختص</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div align="left">
                            <asp:Button ID="btnAllow" runat="server" Text="يستحق المكآفأة" class="btn btn-info" OnClientClick="return ConfirmDelete();" OnClick="btnAllow_Click" />
                            <asp:Button ID="btnNotAllow" runat="server" Text="يستحق المكآفأة مع الملاحظات التالية" class="btn btn-warning" ValidationGroup="GNotAllow"
                            ...
                            <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                                <table class='table' style="width: 100%">
                                                ...
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث" 
                                                            ...
                                                            Text="قائمة المكافآت التي تحتاج إلى موافقة المشرف المختص"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVEmpBonusesByManager" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeBonusesMapID"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Number_Bonuses_" HeaderText="ر/القرار" SortExpression="Number_Bonuses_"
                                                        ...
                                                        <asp:BoundField DataField="BonusesTitle" HeaderText="العنوان" SortExpression="BonusesTitle"
                                                            HeaderStyle-ForeColor="#CCCCCC" />
                                                        ...
                                                        <asp:TemplateField HeaderText="تاريخ المكافئة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <%# ClassSaddam.FChangeDate((DateTime) (Eval("Date_Bonuses_")))%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField> 
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                            <ItemTemplate>
                                                                <a href='PageEmployeeBonusesByView.aspx?IDYear=<%# Eval("FinancialYear_Id_") %>&ID=<%# Eval("Number_Bonuses_") %>&IDU=<%# Eval("EmployeeBonusesMapID")%>' 

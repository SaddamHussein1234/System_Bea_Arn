<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageEmployeeAccountablesByRaees.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Transactions_PageEmployeeAccountablesByRaees" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageEmployeeAccountableAdd.aspx" data-toggle="tooltip" title="إضافة حسم لموظف" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageEmployeeAccountablesByRaees.aspx">ملفات تحتاج إلى رئيس الشؤون</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                            ...
                            <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                                <table class='table' style="width: 100%">
                                                ...
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث" 
                                                            ...
                                                            Text="قائمة المساءلات التي تحتاج إلى موافقة المشرف المختص"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVEmpLeaveByManager" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeAccountableID"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="نوع الحسم" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <%# Eval("Accountable")%>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="تاريخ الحسم" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <%# ClassSaddam.FChangeDate((DateTime) (Eval("Date_Accountable_")))%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>  
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                            <ItemTemplate>
                                                                ...
                                                                <a href='PageEmployeeAccountableAdd.aspx?ID=<%# Eval("EmployeeAccountableID")%>&Type=Raees' 
                                                                    title="إتخاذ الإجراء" data-toggle="tooltip">

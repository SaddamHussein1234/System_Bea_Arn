<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageEmployeeBonusesAdd.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Transactions_PageEmployeeBonusesAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageEmployeeBonuses.aspx">قائمة قرارات المكافآت</a></li>
                    <li><a href="#">إضافة/تعديل قرار مكافأة </a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title" style="float:right">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="إضافة/تعديل قرار مكافأة"></asp:Label>
                    </h3>
                    <div align="left">
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <asp:TextBox ID="txtNumberBonuses" runat="server" CssClass="form-control" ValidationGroup="g2"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" SetFocusOnError="true" ControlToValidate="txtNumberBonuses" ValidationGroup="g2"
                                                CssClass="required" Display="Dynamic" Font-Size="10px" ErrorMessage="* رقم القرض" runat="server"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtNumberBonuses"
                            ...
                            <div class="container-fluid" dir="rtl">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <asp:TextBox ID="txtTitle" MaxLength="20" runat="server" CssClass="form-control" ValidationGroup="g2"
                                                onkeypress="return Common.isNumericKey(event,this)" Text="قرار مكافأة موظف"></asp:TextBox>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <asp:TextBox ID="txtAmount" runat="server" CssClass="form-control" ValidationGroup="g2"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" SetFocusOnError="true" ControlToValidate="txtAmount" ValidationGroup="g2"
                                                CssClass="required" Display="Dynamic" Font-Size="10px" ErrorMessage="* المبلغ" runat="server"></asp:RequiredFieldValidator>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="control-label" id="Label2" runat="server">
                                            تاريخ المكافئة : <span title="إجباري" data-toggle="tooltip">*</span>
                                        </label>
                                        <div class="col-md-12">
                                            <div class="input-group date ">
                                                <asp:TextBox ID="txtDate_Bonuses" runat="server" placeholder="حدد تاريخ ... " class="form-control"
                                        ...
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator2" runat="server"
                                                ControlToValidate="txtDate_Bonuses" ErrorMessage="* حدد التأريخ" ForeColor="#FF0066"

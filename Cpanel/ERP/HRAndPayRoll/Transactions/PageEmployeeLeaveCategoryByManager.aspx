<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageEmployeeLeaveCategoryByManager.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Transactions_PageEmployeeLeaveCategoryByManager" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVEmpLeaveByManager.ClientID%>");
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageEmployeeLeaveCategoryByManager.aspx">ملفات تحتاج إلى مدير الجمعية</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                            ...
                            <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                                <table class='table' style="width: 100%">
                                                ...
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث" 
                                                            ...
                                                            Text="قائمة الإجازات التي تحتاج إلى موافقة المشرف المختص"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVEmpLeaveByManager" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeLeaveCategoryMapID"

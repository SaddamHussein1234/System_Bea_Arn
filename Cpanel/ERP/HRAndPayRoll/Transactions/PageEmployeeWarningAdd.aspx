<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageEmployeeWarningAdd.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Transactions_PageEmployeeWarningAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageEmployeeWarning.aspx">قائمة بيانات الإنذارات</a></li>
                    <li><a href="PageEmployeeWarningAdd.aspx">إضافة/تعديل إنذار </a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title" style="float:right">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="إضافة/تعديل إنذار"></asp:Label>
                    </h3>
                    <div align="left">
                        ...
                        <div class="widget-box">
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">
                                            رقم قرار الإنذار : <span title="إجباري" data-toggle="tooltip">*</span>
                                        </label>
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">
                                            عنوان الإنذار : <span title="إجباري" data-toggle="tooltip">*</span>
                                        </label>
                                        <asp:TextBox ID="titTitle" runat="server" CssClass="form-control" ValidationGroup="g2" Text="إنذار كتابي أول"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" SetFocusOnError="true" ControlToValidate="titTitle" ValidationGroup="g2"
                                            CssClass="required" Display="Dynamic" Font-Size="10px" ErrorMessage="* عنوان الإنذار" runat="server"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="control-label">
                                            تاريخ الإنذار : <span title="إجباري" data-toggle="tooltip">*</span>
                                        </label>
                                        <div class="input-group date ">
                                            <asp:TextBox ID="txtDate" runat="server" placeholder="تاريخ الإنذار ... " class="form-control"
                                                data-date-format="YYYY-MM-DD" ValidationGroup="g2" Style="text-align: center;"></asp:TextBox>
                                            <span class="input-group-btn">
                                                <button class="btn btn-default" type="button">
                                                    <i class="fa fa-calendar"></i>
                                        ...
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator2" runat="server"
                                            ControlToValidate="txtDate" ErrorMessage="* تاريخ الإنذار" ForeColor="#FF0066"
                                            meta:resourcekey="RequiredFieldValidator1Resource1" ValidationGroup="g2" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label class="control-label">
                                            أسباب الإنذار : <span title="إجباري" data-toggle="tooltip">*</span>
                                        </label>
                                        <div class="col-md-12">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" SetFocusOnError="true" ControlToValidate="txtDescrption" ValidationGroup="g2"
                                                CssClass="required" Display="Dynamic" Font-Size="10px" ErrorMessage="* أسباب الإنذار" runat="server"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">

...
public partial class Cpanel_ERP_HRAndPayRoll_Transactions_PageEmployeeLoansByRaees : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            CLS_Permissions.CheckAccountAdmin("A176");
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Repostry_Tricker_.FAPP_Add("Add", Guid.NewGuid(), Test_Saddam.FGetIDUsiq(), "HRM", "نظام الموارد البشرية", "عرض",
                      "عرض ملفات المشرف المختص لـ قائمة القروض", ClassSaddam.GetCurrentTime().ToString("yyyy-MM-dd HH:mm:ss"));
            }
            else
            {
    ...
    {
        Response.Redirect("PageEmployeeLoansByRaees.aspx");
    }

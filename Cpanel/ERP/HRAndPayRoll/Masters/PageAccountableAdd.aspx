<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageAccountableAdd.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageAccountableAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageAccountables.aspx">قائمة أنواع المسائلات</a></li>
                    <li><a href="PageAccountableAdd.aspx">إضافة/تعديل نوع مساءلة </a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="إضافة/تعديل نوع مساءلة"></asp:Label>
                    </h3>
                </div>
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <h5>عنوان المساءلة : </h5>
                                        <asp:TextBox ID="txtAccountable" runat="server" class="form-control" ValidationGroup="g2"></asp:TextBox>
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator4" runat="server"
                                            ControlToValidate="txtAccountable" ErrorMessage="* عنوان الإدارة" ForeColor="#FF0066"

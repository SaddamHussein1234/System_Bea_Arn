<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageEmployeeType.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageEmployeeType" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVEmployeeType.ClientID%>");
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageEmployeeTypeAdd.aspx" data-toggle="tooltip" title="إضافة إدارة جديدة" class="btn btn-info" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageEmployeeType.aspx">قائمة طبيعة العمل </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة طبيعة العمل
                        </h3>
                            ...
                            <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
                                <div class="row" style="margin: 5px; text-align: center">
                                    <div class="col-md-12" style="border: solid; border-width: 3px; border-color: #006011; border-radius: 5px">
                                        <br />
                                        <h3 style="font-family: 'Alwatan';">قائمة طبيعة العمل
                                        </h3>
                                        <br />
                                    </div>
                                </div>
                                <div class="table table-responsive">
                                    <asp:GridView ID="GVEmployeeType" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeTypeID"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="EmployeeType" HeaderText="العنوان" SortExpression="EmployeeType" HeaderStyle-ForeColor="#CCCCCC" />
                                            <asp:BoundField HeaderText="عدد الإجازات في الشهر" DataField="NoOfLeavePerMonth" HeaderStyle-ForeColor="#CCCCCC" />
                                            ...
                                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                <ItemTemplate>
                                                    <a href="PageEmployeeTypeAdd.aspx?ID=<%# Eval("EmployeeTypeID") %>" data-toggle="tooltip" title="تعديل البيانات">

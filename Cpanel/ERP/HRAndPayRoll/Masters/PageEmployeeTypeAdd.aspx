<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageEmployeeTypeAdd.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageEmployeeTypeAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageEmployeeType.aspx">قائمة أنواع التوظيف</a></li>
                    <li><a href="PageEmployeeTypeAdd.aspx">إضافة/تعديل </a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="إضافة/تعديل نوع طبيعة العمل"></asp:Label>
                    </h3>
                </div>
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <h5>العنوان : </h5>
                                        <asp:TextBox ID="txtDepartment" runat="server" class="form-control" ValidationGroup="g2"></asp:TextBox>
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator4" runat="server"
                                            ControlToValidate="txtDepartment" ErrorMessage="* العنوان" ForeColor="#FF0066"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <h5>أيام الإجازة في الشهر : </h5>
                                        <asp:DropDownList ID="ddlLeave" runat="server" CssClass="form-control input-width-xlarge" ValidationGroup="g2">
                                        ...
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator1" runat="server"
                                            ControlToValidate="ddlLeave" ErrorMessage="* حدد الأيام" ForeColor="#FF0066"
                                            meta:resourcekey="RequiredFieldValidator1Resource1" ValidationGroup="g2" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>

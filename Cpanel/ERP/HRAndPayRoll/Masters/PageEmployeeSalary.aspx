<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageEmployeeSalary.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageEmployeeSalary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVEmplyoeeSalary.ClientID%>");
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageEmployeeSalaryAdd.aspx" data-toggle="tooltip" title="إضافة رواتب الموظين" class="btn btn-info" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageEmployeeSalary.aspx">قائمة رواتب الموظين </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة رواتب الموظين
                        </h3>
                            ...
                            <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
                                <div class="row" style="margin: 5px; text-align: center">
                                    <div class="col-md-12" style="border: solid; border-width: 3px; border-color: #006011; border-radius: 5px">
                                        <br />
                                        <h3 style="font-family: 'Alwatan';">قائمة رواتب الموظفين
                                        </h3>
                                        <br />
                                    </div>
                                </div>
                                <div class="table table-responsive">
                                    <asp:GridView ID="GVEmplyoeeSalary" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeSalaryID"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="EmployeeNo" HeaderText="ر.الموظف" SortExpression="EmployeeNo" HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="26" />
                                            ...
                                            <asp:TemplateField HeaderText="الراتب الأساسي" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                    <%# Eval("Basic") %><%# ClassSaddam.FGetMonySa() %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="البدلات" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                    <%# Eval("TotalEarning") %><%# ClassSaddam.FGetMonySa() %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="المستقطع" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                    <%# Eval("TotalDeduction") %><%# ClassSaddam.FGetMonySa() %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="صافي الراتب" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                    <%# Eval("TotalSalary") %><%# ClassSaddam.FGetMonySa() %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                <ItemTemplate>
                                                    <a href="PageEmployeeSalaryAdd.aspx?ID=<%# Eval("EmployeeSalaryID") %>" class='<%# Convert.ToBoolean(Eval("IsLeave"))?"displayNone":"" %>'
                                                        data-toggle="tooltip" title="تعديل البيانات">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="PageEmployeeDefinitionOfSalary.aspx?ID=<%# Eval("EmployeeSalaryID") %>" data-toggle="tooltip" title="عرض إشعار تعريف بالراتب">

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageHoliday.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageHoliday" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVHoliday.ClientID%>");
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageHolidayAdd.aspx" data-toggle="tooltip" title="إضافة أيام إجازات" class="btn btn-info" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة أيام الإجازات
                        </h3>
                            ...
                            <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
                                <div class="row" style="margin: 5px; text-align: center">
                                    <div class="col-md-12" style="border: solid; border-width: 3px; border-color: #006011; border-radius: 5px">
                                        <br />
                                        <h3 style="font-family: 'Alwatan';">قائمة أيام الإجازات
                                        </h3>
                                        <br />
                                    </div>
                                </div>
                                <div class="table table-responsive">
                                    <asp:GridView ID="GVHoliday" runat="server" AutoGenerateColumns="False" DataKeyNames="HolidayID"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Title" HeaderText="العنوان" SortExpression="Title" HeaderStyle-ForeColor="#CCCCCC" />
                                            <asp:BoundField DataField="Description" HeaderText="مزيد من التفاصيل" SortExpression="Description" HeaderStyle-ForeColor="#CCCCCC" />
                                            ...
                                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                <ItemTemplate>
                                                    <a href="PageHolidayAdd.aspx?ID=<%# Eval("HolidayID") %>" data-toggle="tooltip" title="تعديل البيانات">

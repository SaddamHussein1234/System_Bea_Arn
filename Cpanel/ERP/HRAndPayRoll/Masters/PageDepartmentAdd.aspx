<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageDepartmentAdd.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageDepartmentAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageDepartment.aspx">قائمة الإدارات</a></li>
                    <li><a href="PageDepartmentAdd.aspx">إضافة/تعديل إدارة </a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="إضافة/تعديل إدارة"></asp:Label>
                    </h3>
                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator4" runat="server"
                                            ControlToValidate="txtDepartment" ErrorMessage="* عنوان الإدارة" ForeColor="#FF0066"

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageAllowance.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageAllowance" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageAllowanceAdd.aspx" data-toggle="tooltip" title="إضافة البدلات ( العلاوات)" class="btn btn-info" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageAllowance.aspx">قائمة البدلات ( العلاوات) </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة البدلات ( العلاوات)
                        </h3>
                            ...
                            <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
                                <div class="row" style="margin: 5px; text-align: center">
                                    <div class="col-md-12" style="border: solid; border-width: 3px; border-color: #006011; border-radius: 5px">
                                        <br />
                                        <h3 style="font-family: 'Alwatan';">قائمة البدلات ( العلاوات)
                                        </h3>
                                        <br />
                                    </div>
                                </div>
                                <div class="table table-responsive">
                                    <asp:GridView ID="GVAllowance" runat="server" AutoGenerateColumns="False" DataKeyNames="AllowanceID"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Allowance" HeaderText="العنوان" SortExpression="Allowance" HeaderStyle-ForeColor="#CCCCCC" />

                                            <asp:TemplateField HeaderText="يخصم" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                    الحالة <%# ClassSaddam.FChangeStyleCheckbox((Boolean) Eval("IsConsider")) %>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                <ItemTemplate>
                                                    <a href="PageAllowanceAdd.aspx?ID=<%# Eval("AllowanceID") %>" data-toggle="tooltip" title="تعديل البيانات">

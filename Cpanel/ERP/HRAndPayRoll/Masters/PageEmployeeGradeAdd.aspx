<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageEmployeeGradeAdd.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageEmployeeGradeAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageEmployeeGradeAdd.aspx">إضافة/تعديل فصائل </a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="إضافة/تعديل فصائل"></asp:Label>
                    </h3>
                </div>
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <h5>عنوان فصيل الدم : </h5>
                                        <asp:TextBox ID="txtEmployee_Grade" runat="server" class="form-control" ValidationGroup="g2"></asp:TextBox>
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator4" runat="server"
                                            ControlToValidate="txtEmployee_Grade" ErrorMessage="* عنوان فصيل الدم" ForeColor="#FF0066"

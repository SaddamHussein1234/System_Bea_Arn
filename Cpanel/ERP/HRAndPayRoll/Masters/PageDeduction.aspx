<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageDeduction.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageDeduction" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageDeductionAdd.aspx" data-toggle="tooltip" title="إضافة أنواع المستقطع" class="btn btn-info" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageDeduction.aspx">قائمة أنواع المستقطع </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة أنواع المستقطع
                        </h3>
                            ...
                            <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
                                <div class="row" style="margin: 5px; text-align: center">
                                    <div class="col-md-12" style="border: solid; border-width: 3px; border-color: #006011; border-radius: 5px">
                                        <br />
                                        <h3 style="font-family: 'Alwatan';">قائمة أنواع المستقطع
                                        </h3>
                                        <br />
                                    </div>
                                </div>
                                <div class="table table-responsive">
                                    <asp:GridView ID="GVDeduction" runat="server" AutoGenerateColumns="False" DataKeyNames="DeductionID"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Deduction" HeaderText="العنوان" SortExpression="Deduction" HeaderStyle-ForeColor="#CCCCCC" />
                                            ...
                                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                <ItemTemplate>
                                                    <a href="PageDeductionAdd.aspx?ID=<%# Eval("DeductionID") %>" data-toggle="tooltip" title="تعديل البيانات">

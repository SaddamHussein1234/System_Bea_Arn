<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageLeaveCategory.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageLeaveCategory" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVLeaveCategory.ClientID%>");
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageLeaveCategoryAdd.aspx" data-toggle="tooltip" title="إضافة إجازات" class="btn btn-info" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة الإجازات
                        </h3>
                            ...
                            <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
                                <div class="row" style="margin: 5px; text-align: center">
                                    <div class="col-md-12" style="border: solid; border-width: 3px; border-color: #006011; border-radius: 5px">
                                        <br />
                                        <h3 style="font-family: 'Alwatan';">قائمة الإجازات
                                        </h3>
                                        <br />
                                    </div>
                                </div>
                                <div class="table table-responsive">
                                    <asp:GridView ID="GVLeaveCategory" runat="server" AutoGenerateColumns="False" DataKeyNames="LeaveCategoryID"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="LeaveCategory" HeaderText="العنوان" SortExpression="LeaveCategory" HeaderStyle-ForeColor="#CCCCCC" />
                                            ...
                                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                <ItemTemplate>
                                                    <a href="PageLeaveCategoryAdd.aspx?ID=<%# Eval("LeaveCategoryID") %>" data-toggle="tooltip" title="تعديل البيانات">

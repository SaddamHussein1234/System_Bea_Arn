<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/ERP/Main.master" AutoEventWireup="true" CodeFile="PageShift.aspx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Masters_PageShift" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVShift.ClientID%>");
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageShiftAdd.aspx" data-toggle="tooltip" title="إضافة أوقات الدوام" class="btn btn-info" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة أوقات الدوام
                        </h3>
                            ...
                            <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
                                <div class="row" style="margin: 5px; text-align: center">
                                    <div class="col-md-12" style="border: solid; border-width: 3px; border-color: #006011; border-radius: 5px">
                                        <br />
                                        <h3 style="font-family: 'Alwatan';">قائمة أوقات الدوام
                                        </h3>
                                        <br />
                                    </div>
                                </div>
                                <div class="table table-responsive">
                                    <asp:GridView ID="GVShift" runat="server" AutoGenerateColumns="False" DataKeyNames="ShiftID"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Shift" HeaderText="العنوان" SortExpression="Shift" HeaderStyle-ForeColor="#CCCCCC" />
                                            <asp:BoundField DataField="FromTime" HeaderText="الفترة الأول(من الساعة)" SortExpression="FromTime" HeaderStyle-ForeColor="#CCCCCC" />
                                            <asp:BoundField DataField="ToTime" HeaderText="الفترة الأول(إلى الساعة)" SortExpression="ToTime" HeaderStyle-ForeColor="#CCCCCC" />
                                            
                                            <asp:TemplateField HeaderText="الفترة الثانية(من الساعة)" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                     <%# ClassSaddam.FChangeCountShift((int) Eval("Count_Shift_"),(string) Eval("FromTime_Tow")) %>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Right" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="الفترة الثانية(إلى الساعة)" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                     <%# ClassSaddam.FChangeCountShift((int) Eval("Count_Shift_"),(string) Eval("ToTime_To")) %>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Right" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                <ItemTemplate>
                                                    <a href="PageShiftAdd.aspx?ID=<%# Eval("ShiftID") %>" data-toggle="tooltip" title="تعديل البيانات">

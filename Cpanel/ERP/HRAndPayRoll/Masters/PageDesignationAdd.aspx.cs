...
public partial class Cpanel_ERP_HRAndPayRoll_Masters_PageDesignationAdd : System.Web.UI.Page
{
    ...
    private void FGetData()
    {
        try
        {
            ...
            MD.DesignationID = new Guid(Request.QueryString["ID"]);
            MD.DesignationName = string.Empty;
            MD.IsActive = true;
            DataTable dt = new DataTable();
            Repostry_Designation_ RD = new Repostry_Designation_();
            dt = RD.BErp_Designation_Manage(MD);
            if (dt.Rows.Count > 0)
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        try
        {
            if (Request.QueryString["id"] == null)
            {
                ...
                Repostry_Designation_ RD = new Repostry_Designation_();
                string Xresult = RD.FErp_Designation_Add(MD);
            ...
            else if (Request.QueryString["id"] != null)
            {
                ...
                {
                    IDCheck = "Edit",
                    DesignationID = new Guid(Request.QueryString["id"]),
                    DesignationName = txtDesignation.Text.Trim(),

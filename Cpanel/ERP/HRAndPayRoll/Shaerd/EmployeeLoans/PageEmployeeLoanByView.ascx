<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeLoanByView.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeLoans_PageEmployeeLoanByView" %>
<style type="text/css">
    .StyleTD {
        text-align: center;
        padding: 5px;
...
<div class="page-header">
    <div class="container-fluid">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="PageEmployeeLoans.aspx">قروض الموظفين</a></li>
            <li><a href="#">تفاصيل قرض موظف</a></li>
        </ul>
    </div>
</div>
<asp:Panel ID="pnlPrint" runat="server" Direction="RightToLeft" Visible="false">
    <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
        <table style="width: 100%;">
            <tr>
                <td align="center">
                    <asp:TextBox ID="txtTitle" runat="server" Font-Size="14px" class="form-control" placeholder="عنوان البحث" Text="طلب سلفة" Style="text-align: center; width: 95%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                </td>
                <td align="center">
                    ...
                    <table style="width: 95%">
                        <tr>
                            <td class="StyleTD" colspan="2">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 25%; border-left: double; border-width: 2px; border-color: #a1a0a0;">رقم القرض
                                        </td>
                                        <td style="width: 25%; border-left: double; border-width: 2px; border-color: #a1a0a0;">
                                            <asp:Label ID="lblNumberLoan" runat="server"></asp:Label>
                                        </td>
                            ...
                            <div class="content-box-large">
                                <div class="container-fluid" dir="rtl">
                                    ...
                                    <div class="WidthText5">
                                        <div class="form-group">
                                            <p>
                                                آمل منكم الموافقة على إعطائي سلفة وقدرة 
                                                <strong> (<asp:Label ID="lblAmount" runat="server"></asp:Label>) </strong> <br />
                                            وذلك : 
                                            <strong>
                                                <asp:Label ID="lblDateLoan" runat="server"></asp:Label>
                                            </strong>
                                            </p>
                                            <p>
                                                وسيتم تسديد السلفة على :                                                       
                                                    <strong>
                                                        <asp:Label ID="lblCountMounth" runat="server"></asp:Label>
                                                    </strong>
                                                في كل قسط 
                                                <strong>
                                                    <asp:Label ID="lblInstallmentMonth" runat="server"></asp:Label>
                                                </strong>
                                            </p>
                                            <br />
                                        ...
                                        <tr style="display:none;">
                                            <td align="right">
                                                <div runat="server" id="pnlRaeesAllow">
                                                    <i class="fa fa-check-square"></i> يعتمد منحة السلفة
                                                </div>
                                                <div runat="server" id="pnlRaeesNotAllow">
                                                    <i class="fa fa-check-square"></i> لا يعتمد منحة السلفة
                                                </div>
                                            </td>
                                            <td align="center" >

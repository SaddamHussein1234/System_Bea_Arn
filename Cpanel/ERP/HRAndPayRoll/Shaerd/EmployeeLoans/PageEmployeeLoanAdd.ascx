<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeLoanAdd.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeLoans_PageEmployeeLoanAdd" %>
<div class="page-header">
    <div class="container-fluid">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="PageEmployeeLoanAdd.aspx">إضافة/تعديل قروض الموظفين </a></li>
        </ul>
    </div>
</div>
<div class="container-fluid">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title" style="float:right">
                ...
                <asp:Label ID="lbmsg" runat="server" Text="إضافة/تعديل قروض الموظفين"></asp:Label>
            </h3>
            <div align="left">
                    ...
                    <div class="container-fluid" dir="rtl">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">
                                    رقم القرض : <span title="إجباري" data-toggle="tooltip">*</span>
                                </label>
                                    <asp:TextBox ID="txtNumberLoan" runat="server" CssClass="form-control" ValidationGroup="g2"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" SetFocusOnError="true" ControlToValidate="txtNumberLoan" ValidationGroup="g2"
                                        CssClass="required" Display="Dynamic" Font-Size="10px" ErrorMessage="* رقم القرض" runat="server"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtNumberLoan"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">
                                    الغرض : <span title="إجباري" data-toggle="tooltip">*</span>
                                </label>
                                <div class="col-md-12">
                                    <asp:TextBox ID="txtTitle" runat="server" CssClass="form-control" ValidationGroup="g2"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" id="lblBasic" runat="server">
                                    المبلغ المراد قرضة <span title="إجباري" data-toggle="tooltip">*</span>
                                </label>
                                <asp:TextBox ID="txtAmount" MaxLength="10" runat="server" CssClass="form-control" ValidationGroup="g2"
                                    onkeyup="EmployeeLoanSave.CalculateInstallment()" onkeypress="return Common.isNumericKey(event,this);" ></asp:TextBox>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" id="Label3" runat="server">
                                    تقصيد المبلغ على عدد شهور <span title="إجباري" data-toggle="tooltip">*</span>
                                </label>
                                    <asp:DropDownList ID="ddlTotalMonths" runat="server" CssClass="form-control2 chzn-select dropdown"
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" SetFocusOnError="true" ControlToValidate="ddlTotalMonths" ValidationGroup="g2"
                                        CssClass="required" Display="Dynamic" Font-Size="10px" ErrorMessage="* حدد الشهور" runat="server"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" id="Label2" runat="server">
                                    تاريخ القرض : <span title="إجباري" data-toggle="tooltip">*</span>
                                </label>
                                <div class="input-group date ">
                                    <asp:TextBox ID="txtDateLoan" runat="server" placeholder="تاريخ القرض ... " class="form-control"
                                ...
                                <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator2" runat="server"
                                        ControlToValidate="txtDateLoan" ErrorMessage="* حدد التأريخ" ForeColor="#FF0066"
                        ...
                        <div class="col-md-4" style="display:none;">
                            <div class="form-group">
                                <label class="control-label">
                                    ...
                                    <asp:DropDownList ID="DLIDRaeesShoo" runat="server" CssClass="form-control2 chzn-select dropdown"
                                        Width="100%" ValidationGroup="g2">
                                        <asp:ListItem></asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" SetFocusOnError="true" ControlToValidate="DLIDRaeesShoo" ValidationGroup="g2"
    ...
    <div id="IDAccess" runat="server" visible="false" class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">
                <i class="fa fa-pencil"></i>
                <asp:Label ID="Label1" runat="server" Text="المشرف المختص"></asp:Label>
            </h3>
        </div>
        <div class="panel-body">
            <div class="content-box-large">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div id="pnlModer" style="display: none; <%= FCheck("_Moder") %>" class="col-md-12"><br />
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" SetFocusOnError="true" ControlToValidate="DLModer" ValidationGroup="g2"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div id="pnlRaees" style="display: none; <%= FCheck("_Raees") %>" class="col-md-12"><br />
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" SetFocusOnError="true" ControlToValidate="DLIDRaees" ValidationGroup="g2"

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeLeaveCategoryByAdmin.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployLeave_PageEmployeeLeaveCategoryByAdmin" %>
...
<script type="text/javascript">
    function ConfirmDelete() {
        var count = document.getElementById("<%=hfCount.ClientID %>").value;
            var gv = document.getElementById("<%=GVEmpLeaveByAdmin.ClientID%>");
...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a href="PageEmployeeLeaveCategoryAdd.aspx" data-toggle="tooltip" title="إضافة إجازة لموظف" class="btn btn-primary"><i class="fa fa-plus"></i></a>
            ...
            <asp:Button ID="btnAllow" runat="server" Text="الموافقة على الملفات المحددة" class="btn btn-info" OnClientClick="return ConfirmDelete();" OnClick="btnAllow_Click" />
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageEmployeeLeaveCategoryByAdmin.aspx">ملفات تحتاج إلى الموافقة</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
                    ...
                    <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                        <table class='table' style="width: 100%">
                                        ...
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث" 
                                                    ...
                                                    Text="قائمة الإجازات التي تحتاج إلى موافقة الموظفين"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GVEmpLeaveByAdmin" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeLeaveCategoryMapID"

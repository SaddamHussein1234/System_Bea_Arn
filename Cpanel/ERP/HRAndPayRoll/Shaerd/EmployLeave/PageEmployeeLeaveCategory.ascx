<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeLeaveCategory.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployLeave_PageEmployeeLeaveCategory" %>
...
<script type="text/javascript">
    function ConfirmDelete() {
        var count = document.getElementById("<%=hfCount.ClientID %>").value;
            var gv = document.getElementById("<%=GVEmpLeave.ClientID%>");
...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a runat="server" id="IDAdd" href="/Cpanel/ERP/HRAndPayRoll/Transactions/PageEmployeeLeaveCategoryAdd.aspx" data-toggle="tooltip" title="إضافة إجازة لموظف" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageEmployeeLeaveCategory.aspx">ملفات الاجازات</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title" style="float: right">
                    <i class="fa fa-list"></i>ملفات الاجازات
                </h3>
                <div align="left">
                    ...
                    <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                        <table class='table' style="width: 100%">
                                        ...
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث"
                                                    ...
                                                    Text="قائمة إجازات جميع الموظفين"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GVEmpLeave" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeLeaveCategoryMapID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Number_Leave_" HeaderText="رقم الإجازة" SortExpression="Number_Leave_"
                                                    HeaderStyle-ForeColor="#CCCCCC" />
                                                <asp:TemplateField HeaderText="نوع الإجازة" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# Eval("LeaveCategory")%>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="الموظف المناوب عنه" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# ClassQuaem.FAlBaheth((Int32) Eval("ID_Emp_"))%>
                                                        <div class="HideThis">
                                                            <%# ClassSaddam.FCheckAllowAdmin((bool) (Eval("Is_Emp_")))%>
                                                        </div>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="تاريخ الإجازة" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# ClassSaddam.FChangeDate((DateTime) (Eval("StartDate")))%> - 
                                                                <%# ClassSaddam.FChangeDate((DateTime) (Eval("EndDate")))%>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="فترة الإجازة" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# Eval("TotalDay")%> / يوم
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                ...
                                                <asp:TemplateField HeaderText="نوع الرصيد" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# ClassSaddam.FCheckLeave(Convert.ToInt16(Eval("Is_Basic_")))%>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeLeaveCategoryByView.aspx?IDYear=<%# Eval("FinancialYear_Id_") %>&ID=<%# Eval("Number_Leave_") %>&IDU=<%# Eval("EmployeeLeaveCategoryMapID")%>'
                                                            title="عرض الملف" data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i></a>
                                                        <a href='PageEmployeeLeaveCategoryAdd.aspx?ID=<%# Eval("EmployeeLeaveCategoryMapID")%>'
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeLeaveCategoryByView.aspx?ID=<%# Eval("EmployeeLeaveCategoryMapID")%>'
                                                            title="عرض الملف" data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i></a>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />

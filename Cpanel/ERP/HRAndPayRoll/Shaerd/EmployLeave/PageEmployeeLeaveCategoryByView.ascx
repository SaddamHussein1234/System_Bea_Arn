<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeLeaveCategoryByView.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployLeave_PageEmployeeLeaveCategoryByView" %>
<style type="text/css">
        .StyleTD {
            text-align: center;
            padding: 5px;
...
<div class="page-header">
    <div class="container-fluid">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="PageEmployeeLeaveCategory.aspx">إجازات الموظفين</a></li>
            <li><a href="PageEmployeeLeaveCategoryByView.aspx">تفاصيل اجازة موظف</a></li>
        </ul>
    </div>
</div>
<asp:Panel ID="pnlPrint" runat="server" Direction="RightToLeft" Visible="false">
    <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
        <table style="width: 100%;">
            <tr>
                <td align="center">
                    <asp:TextBox ID="txtTitle" runat="server" Font-Size="14px" class="form-control" placeholder="عنوان البحث" Text=" طلب اجازة" Style="text-align: center; width: 95%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                </td>
                <td align="center">
                    ...
                    <table style="width: 95%">
                        <tr>
                            <td class="StyleTD" colspan="2">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 25%; border-left: double; border-width: 2px; border-color: #a1a0a0;">رقم الاجازة
                                        </td>
                                        <td style="width: 25%; border-left: double; border-width: 2px; border-color: #a1a0a0;">
                                            <asp:Label ID="lblNumberLeave" runat="server"></asp:Label>
                                        </td>
                                ...
                                <div class="container-fluid" dir="rtl">
                                    <div class="WidthText4">
                                        <div class="form-group">
                                            <strong>المكرم / رئيس لجنة الشؤون المالية والإدارية
                                            </strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="WidthText5">
                                        <div class="form-group">
                                            <p>
                                                آمل منكم الموافقة على إعطائي اجازة لمدة 
                                                (<asp:Label ID="lblTotalDay" runat="server"></asp:Label>) 
                                            وذلك من يوم : 
                                            <asp:Label ID="lblDateLeave" runat="server"></asp:Label>
                                            </p>
                                            <p>
                                                وسيكون بديلي أيام الاجازة الموظف /  
                                                <strong><asp:Label ID="lblEmp" runat="server"></asp:Label></strong>
                                            </p>
                                            <p>
                                                نوع الإجازة : <strong><asp:Label ID="lblLeaveCategory" runat="server"></asp:Label></strong> , 
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    <td align="right">توقيع البديل
                                                        <br />
                                                        <asp:Image ID="Img_Emp_Tow" runat="server" Width='100px' Height='25' />
                                                        <br />
                                                        <asp:Label ID="lblEmp2" runat="server"></asp:Label>
                                                    </td>
                                                    <td align="left">توقيع طالب الإجازة
                                                        <br />
                                        ...
                                        <tr style="display:none;">
                                            <td align="right">
                                                <div runat="server" id="pnlRaeesAllow">
                                                    <i class="fa fa-check-square"></i> يعتمد منحة الإجازة
                                                </div>
                                                <div runat="server" id="pnlRaeesNotAllow">
                                                    <i class="fa fa-check-square"></i> لا يعتمد منحة الإجازة
                                                </div>
                                            </td>
                                            <td align="center" >
                                                <span style=" font-family: 'Alwatan'; font-size: 18px;">
                                                    رئيس لجنة الشؤون المالية والإدارية</span>
                                                <br />

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeCompensatories.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployLeave_PageEmployeeCompensatories" %>
...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a runat="server" id="IDAdd" href="PageEmployeeCompensatoryAdd.aspx" data-toggle="tooltip" 
                title="إضافة إجازة تعويضيه" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageEmployeeCompensatories.aspx">ملفات الاجازات التعويضية</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
                    ...
                    <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                        <table class='table' style="width: 100%">
                                        ...
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث"
                                                    ...
                                                    Text="قائمة الإجازات التعويضية"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GVEmpLeave" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeLeaveCompensatoryMapID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="التاريخ اللذي داوم فيه" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeCompensatoryAdd.aspx?ID=<%# Eval("EmployeeLeaveCompensatoryMapID")%>'

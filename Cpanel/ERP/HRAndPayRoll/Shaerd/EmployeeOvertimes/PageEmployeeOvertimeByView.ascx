<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeOvertimeByView.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeOvertimes_PageEmployeeOvertimeByView" %>
<style type="text/css">
    .StyleTD {
        text-align: center;
        padding: 5px;
...
<div class="page-header">
    <div class="container-fluid">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="PageEmployeeOvertimes.aspx">قرارات العمل الإضافي</a></li>
            <li><a href="PageEmployeeOvertimeAdd.aspx">تفاصيل القرار</a></li>
        </ul>
    </div>
</div>
<asp:Panel ID="pnlPrint" runat="server" Direction="RightToLeft" Visible="false">
    <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
        <table style="width: 100%;">
            <tr>
                <td align="center">
                    <asp:TextBox ID="txtTitle" runat="server" Font-Size="14px" class="form-control" placeholder="عنوان البحث" Text="قرار عمل إضافي لموظف" Style="text-align: center; width: 95%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                </td>
                <td align="center">
                                ...
                                <div class="container-fluid" dir="rtl">
                                    <div class="WidthText4">
                                        <div class="form-group">
                                            <strong> المهمة المكلف بها الموظف :-
                                            </strong>
                                        </div>
                                    </div>
                                    <div class="WidthText4">
                                        <div class="form-group">
                                            <strong>مبلغ العمل الاضافي 
                                    ...
                                    <div class="WidthText5">
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="lblHouesInDay" runat="server"></asp:Label>
                                            <br />
                                            <asp:Label ID="lblHouresWork" runat="server"></asp:Label>
                                            <br />
                                ...
                                <div class="container-fluid" dir="rtl">                                          
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="form-group">
                                                    للاطلاع والتوجيه حيال العمل الإضافي للموضح بياناته بعاليه حيث أن ملاحظاتنا هي : -
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <div runat="server" id="pnlRaeesAllow">
                                                    <i class="fa fa-check-square"></i> تمت المهمة بشكل كامل . 
                                                </div>
                                                <div runat="server" id="pnlRaeesNotAllow">
                                                    <i class="fa fa-check-square"></i> تمت المهمة مع الملاحظات التالية .
                                                    <br />

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeResolvedByView.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeResolveds_PageEmployeeResolvedByView" %>
<style type="text/css">
    .StyleTD {
        text-align: center;
        padding: 5px;
...
<div class="page-header">
    <div class="container-fluid">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="PageEmployeeResolveds.aspx">قرارات الحسم</a></li>
            <li><a href="">تفاصيل قرار الحسم</a></li>
        </ul>
    </div>
</div>
<asp:Panel ID="pnlPrint" runat="server" Direction="RightToLeft" Visible="false">
    <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
        <table style="width: 100%;">
            <tr>
                <td align="center">
                    <asp:TextBox ID="txtTitle" runat="server" Font-Size="14px" class="form-control" placeholder="عنوان البحث" Text=" قرار حسم" Style="text-align: center; width: 95%; background-color: #fc5d5d; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                </td>
                <td align="center">
                            ...
                            <td class="StyleTD" colspan="2">
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="width: 25%; border-left: double; border-width: 2px; border-color: #a1a0a0;">تاريخ الحسم
                                        </td>
                                        <td style="width: 25%;">
                                    ...
                                    <div class="WidthText5">
                                        <div class="form-group">
                                            <p>
                                                ...
                                                من الموظف المذكور بياناته بعالية 
                                            </p>
                                            <p>
                                        ...
                                        <tr style="display:none;">
                                            <td align="right">
                                                <div runat="server" id="pnlRaeesAllow">
                                                    <i class="fa fa-check-square"></i> يعتمد الحسم
                                                </div>
                                                <div runat="server" id="pnlRaeesNotAllow">
                                                    <i class="fa fa-check-square"></i> لا يعتمد الحسم للأسباب التالية
                                                </div>
                                            </td>
                                            <td align="center" >
                                                <span style=" font-family: 'Alwatan'; font-size: 18px;">
                                                    رئيس الشؤون المالية والإدارة</span>
                                                <br />

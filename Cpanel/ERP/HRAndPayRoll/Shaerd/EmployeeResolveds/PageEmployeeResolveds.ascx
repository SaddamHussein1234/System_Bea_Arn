<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeResolveds.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeResolveds_PageEmployeeResolveds" %>
...
<script type="text/javascript">
    function ConfirmDelete() {
        var count = document.getElementById("<%=hfCount.ClientID %>").value;
            var gv = document.getElementById("<%=GVEmpResolvedByRaees.ClientID%>");
...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a runat="server" id="IDAdd" href="/Cpanel/ERP/HRAndPayRoll/Transactions/PageEmployeeResolvedAdd.aspx" 
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageEmployeeResolveds.aspx">ملفات بيانات الحسومات</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title" style="float:right;">
                    <i class="fa fa-list"></i>ملفات بيانات الحسومات
                </h3>
                <div align="left">
                    ...
                    <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                        <table class='table' style="width: 100%">
                                        ...
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث" 
                                                    ...
                                                    Text="قائمة بيانات الحسومات "></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GVEmpResolvedByRaees" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeResolvedID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Number_Resolved_" HeaderText="رقم الأمر" SortExpression="Number_Resolved_"
                                                ...
                                                <asp:BoundField DataField="_Resolved" HeaderText="مدة الحسم" SortExpression="_Resolved"
                                                    HeaderStyle-ForeColor="#CCCCCC" />
                                                <asp:TemplateField HeaderText="السبب" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# Eval("Reason")%>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                ...
                                                <asp:TemplateField HeaderText="تاريخ الحسم" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# ClassSaddam.FChangeDate((DateTime) (Eval("Date_Resolved_")))%>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeResolvedByView.aspx?IDYear=<%# Eval("FinancialYear_Id_") %>&ID=<%# Eval("Number_Resolved_") %>&IDU=<%# Eval("EmployeeResolvedID")%>' 
                                                            title="عرض الملف" data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i></a> 
                                                        <a href='PageEmployeeResolvedAdd.aspx?ID=<%# Eval("EmployeeResolvedID")%>' 
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeResolvedByView.aspx?ID=<%# Eval("EmployeeResolvedID")%>' 
                                                            title="عرض الملف" data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i></a> 
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />

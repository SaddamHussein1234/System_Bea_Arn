<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeWarning.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeWarning_PageEmployeeWarning" %>
...
<script type="text/javascript">
    function ConfirmDelete() {
        var count = document.getElementById("<%=hfCount.ClientID %>").value;
            var gv = document.getElementById("<%=GVEmpWarning.ClientID%>");
...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a runat="server" id="IDAdd" href="/Cpanel/ERP/HRAndPayRoll/Transactions/PageEmployeeWarningAdd.aspx" 
                data-toggle="tooltip" title="إضافة إنذار لموظف" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageEmployeeWarning.aspx">ملفات الإنذارات</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title" style="float:right;">
                    <i class="fa fa-list"></i>قائمة ملفات الإنذارات
                </h3>
                <div align="left">
                    ...
                    <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                        <table class='table' style="width: 100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GVEmpWarning" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeWarningID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Number_Warning_" HeaderText="رقم الأمر" SortExpression="Number_Warning_"
                                                ...
                                                <asp:TemplateField HeaderText="العنوان" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# Eval("Title_")%>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                ...
                                                <asp:TemplateField HeaderText="تاريخ الحسم" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# ClassSaddam.FChangeDate((DateTime) (Eval("Date_Warning_")))%>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeWarningByView.aspx?IDYear=<%# Eval("FinancialYear_Id_") %>&ID=<%# Eval("Number_Warning_") %>&IDU=<%# Eval("EmployeeWarningID")%>' 
                                                            title="عرض الملف" data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i></a> 
                                                        <a href='PageEmployeeWarningAdd.aspx?ID=<%# Eval("EmployeeWarningID")%>' 
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeWarningByView.aspx?ID=<%# Eval("EmployeeWarningID")%>' 
                                                            title="عرض الملف" data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i></a>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeDefinitionOfSalary.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_PageEmployeeDefinitionOfSalary" %>
<style type="text/css">
    .StyleTD {
        text-align: center;
        padding: 5px;
...
<div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">إشعار تعريف بالراتب</a></li>
                </ul>
            </div>
        </div>
                            ...
                            <table style="width: 95%">
                                    ...
                                    <td class="StyleTD" colspan="2">
                                        <table style="width: 100%">
                                            <tr>
                                                ...
                                                <td style="width: 25%;">
                                                    <asp:Label ID="lblDateCreate" runat="server"></asp:Label> م
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="StyleTD" colspan="2">
                                        <table style="width: 100%">
                                            <tr>
                                                <td style="width: 25%; border-left: double; border-width: 2px; border-color: #a1a0a0;">مقدار الراتب
                                                </td>
                                                <td style="width: 25%;">
                                                    <asp:Label ID="lblMony" runat="server"></asp:Label> 
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <div class="container-fluid" dir="rtl">
                                            ...
                                            <div class="WidthText5">
                                                <div class="form-group">
                                                    <br />
                                                    <strong>
                                                        بهذا نفيدكم بأن الموظف الموضح بياناته بعالية باشر العمل في الجمعية 
                                                        <br /><br />
                                                        إعتباراً من تاريخ 
                                                        <asp:Label ID="lblDateCreate2" runat="server"></asp:Label> م
                                                        <br /><br />
                                                        براتب وقدرة  
                                                        ( <asp:Label ID="lblMonyWord" runat="server" Text="0"></asp:Label> )
                                                         <asp:Label ID="lblCheck" runat="server" Text="ولا يزال على رأس العمل حتى تأريخة ,"></asp:Label>
                                                        <br /><br />
                                                        وقد أعطي هذة الشهادة لتقديمها لمن يهمة الأمر دون أدنى مسؤولية على إدارة الجمعية
                                                    </strong>
                                                    <br /><br />
                                                </div>
                                            </div>
                                            <hr style='border: solid; border-width: 1px; width: 100%' />
                                            <div class="WidthText4" align="center" style="color:#fff;">
                                                _
                                            </div>

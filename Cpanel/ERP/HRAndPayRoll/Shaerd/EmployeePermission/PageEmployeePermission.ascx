<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeePermission.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeePermission_PageEmployeePermission" %>
...
<script type="text/javascript">
    function ConfirmDelete() {
        var count = document.getElementById("<%=hfCount.ClientID %>").value;
            var gv = document.getElementById("<%=GVEmpPermission.ClientID%>");
...
<div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a runat="server" id="IDAdd" href="/Cpanel/ERP/HRAndPayRoll/Transactions/PageEmployeePermissionAdd.aspx" 
                    data-toggle="tooltip" title="إضافة إستئذان لموظف" class="btn btn-primary"><i class="fa fa-plus"></i></a>
            ...
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageEmployeePermission.aspx">ملفات الإستئذانات</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title" style="float:right;">
                        <i class="fa fa-list"></i>قائمة ملفات الإستئذانات
                    </h3>
                    <div align="left">
                        ...
                        <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                            <table class='table' style="width: 100%">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GVEmpPermission" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeePermissionMapID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="وقت الإستئذان" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            من الساعة : <%# Eval("From_The_Hour_", "{0:HH:mm tt}")  %><br />
                                                            إلى الساعة : <%# Eval("To_The_Hour_", "{0:HH:mm tt}")  %>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField> 
                                                    ...
                                                    <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                        <ItemTemplate>
                                                            ...
                                                            <a href='PageEmployeePermissionAdd.aspx?ID=<%# Eval("EmployeePermissionMapID")%>' 
                                                    ...
                                                    <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                        <ItemTemplate>
                                                            <a href='PageEmployeePermissionByView.aspx?ID=<%# Eval("EmployeePermissionMapID")%>' 
                                                                title="عرض الملف" data-toggle="tooltip">
                                                                <i class="fa fa-eye"></i></a> 
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />

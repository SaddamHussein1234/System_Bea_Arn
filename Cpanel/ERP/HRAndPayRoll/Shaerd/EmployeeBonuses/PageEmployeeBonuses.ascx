<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeBonuses.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeBonuses_PageEmployeeBonuses" %>
...
<script type="text/javascript">
    function ConfirmDelete() {
        var count = document.getElementById("<%=hfCount.ClientID %>").value;
            var gv = document.getElementById("<%=GVEmployeeBonuses.ClientID%>");
...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a href="~/Cpanel/ERP/HRAndPayRoll/Transactions/PageEmployeeBonusesAdd.aspx" data-toggle="tooltip" 
                title="إضافة قرار" class="btn btn-info" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
            <asp:Button ID="btnDelete" runat="server" Text="حذف الملفات المحددة" OnClick="btnDelete_Click"
                title="حذف الملفات المحددة" data-toggle="tooltip" CssClass="btn btn-danger" OnClientClick="return ConfirmDelete();" />
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageEmployeeBonuses.aspx">قائمة قرارات المكآفأت </a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-list"></i>قائمة قرارات المكآفأت
                </h3>
                    ...
                    <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                        <table class='table' style="width: 100%">
                                        ...
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث" 
                                                    ...
                                                    Text="قائمة قرارات المكآفأت"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GVEmployeeBonuses" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeBonusesMapID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        ...
                                                        <a href='PageEmployeeBonusesAdd.aspx?ID=<%# Eval("EmployeeBonusesMapID")%>' 
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeBonusesByView.aspx?ID=<%# Eval("EmployeeBonusesMapID")%>' 
                                                            title="عرض الملف" data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i></a> 
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />

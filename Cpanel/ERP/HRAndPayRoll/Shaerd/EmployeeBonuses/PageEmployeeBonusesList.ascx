<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeBonusesList.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeBonuses_PageEmployeeBonusesList" %>
...
<div class="page-header">
    <div class="container-fluid">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="PageEmployeeBonusesList.aspx">مسير المكآفئات </a></li>
        </ul>
    </div>
</div>
<div class="container-fluid">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">
                ...
                <asp:Label ID="lbmsg" runat="server" Text="مسير المكآفئات"></asp:Label>
            </h3>
        </div>
                        ...
                        <asp:Panel ID="pnlData" runat="server" Visible="False" Direction="RightToLeft">
                            <div class="table table-responsive" id="pnlPrint" runat="server" dir="rtl">
                                ...
                                <table class='table table-bordered table-condensed' style="width: 100%" aria-multiline="true">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="GVEmployeeBonuses" runat="server" OnPreRender="GVEmployeeOvertime_PreRender">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="StyleTD">
                                                        <span style="font-size: 12px"><%# Eval("Department")%></span>
                                                    </td>
                                                    <td class="StyleTD">
                                                        <span style="font-size: 12px"><%# Eval("_Name")%></span>
                                                    </td>
                                                    <td class="StyleTD">
                                                        <span style="font-size: 12px"><%# Eval("EmployeeNo")%></span>
                                                    </td>
                                                    <td class="StyleTD">
                                                        <span style="font-size: 12px"><%# Eval("Designation")%></span>
                                                    </td>
                                                    <th class="StyleTD th">
                                                        <span style="font-size: 12px"><%# Eval("Date_Bonuses_", "{0:MM/dd/yyyy}") %></span>
                                                    </th>
                                                    <td class="StyleTD">
                                                        <span style="font-size: 12px"><%# Eval("Number_Bonuses_")%></span>
                                                    </td>
                                                    <th class="StyleTD th">
                                                        <asp:Label ID="lblTotal_Amount" runat="server" 
                                                            Text='<%# Eval("Total_Amount")%>'></asp:Label> <%# XMony %>
                                                    </th>
                                                    <td class="StyleTD">

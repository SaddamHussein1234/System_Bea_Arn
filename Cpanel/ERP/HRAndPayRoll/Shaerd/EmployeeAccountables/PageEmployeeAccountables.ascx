<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeAccountables.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeAccountables_PageEmployeeAccountables" %>
...
<script type="text/javascript">
    function ConfirmDelete() {
        var count = document.getElementById("<%=hfCount.ClientID %>").value;
            var gv = document.getElementById("<%=GVEmpAccountables.ClientID%>");
...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a runat="server" id="IDAdd" href="/Cpanel/ERP/HRAndPayRoll/Transactions/PageEmployeeAccountableAdd.aspx" 
                data-toggle="tooltip" title="إضافة حسم لموظف" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageEmployeeAccountables.aspx">ملفات المساءلات</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title" style="float: right">
                    <i class="fa fa-list"></i>ملفات المساءلات
                </h3>
                <div align="left">
                    ...
                    <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                        <table class='table' style="width: 100%">
                                        ...
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث" 
                                                    ...
                                                    Text="قائمة مساءلات جميع الموظفين"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GVEmpAccountables" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeAccountableID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Number_Accountable_" HeaderText="رقم الإجراء" SortExpression="Number_Accountable_"
                                                    HeaderStyle-ForeColor="#CCCCCC" />
                                                <asp:TemplateField HeaderText="نوع المساءلة" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# Eval("Accountable")%>
                                                    </ItemTemplate>
                                                ...
                                                <asp:BoundField DataField="Department" HeaderText="الإدارة" SortExpression="Department"
                                                    HeaderStyle-ForeColor="#CCCCCC" />
                                                ...
                                                <asp:TemplateField HeaderText="تاريخ المساءلة" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# Eval("Date_Accountable_", "{0:dd/MM/yyyy}") %>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>  
                                                <asp:TemplateField HeaderText="الحالة" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <%# Convert.ToBoolean(Eval("Is_Reply_"))
                                                            ?
                                                            " <a href='javaScript:void(0)' data-toggle='modal' data-target='#IDAttachments" + Eval("EmployeeAccountableID").ToString() + "' data-tooltip='عرض ملاحظة الطلب'>"+
                                                            "<span style='border-radius:6px; font-size:10px; background-color:#1eb507; color:#FFF; padding: 0 2px 0 2px; margin-left:2px'> تم الرد عرض الإفادة </span> </a>"
                                                            :
                                                            "  <span style='border-radius:6px; font-size:10px; background-color:#ff6a00; color:#FFF; padding: 0 2px 0 2px; margin-left:2px'> لـم يـتـم الـرد </span> "
                                                        %>
                                                       
                                                        <div id="IDAttachments<%# Eval("EmployeeAccountableID") %>" class="modal fade in modal_New_Style">
                                                                            ...
                                                                            <div class="page-content">
                                                                                <div class=" panel-body">
                                                                                    <label>
                                                                                        ...
                                                                                        مرفقات <asp:Label ID="lblTitle" runat="server"></asp:Label> : 
                                                                                    </label>
                                                                                    <div align="center">
                                                                                        <div class="" dir="rtl">
                                                                                            <table class='table table-bordered table-condensed' style="width: 100%" aria-multiline="true">
                                                                                                <thead>
                                                                                                    <tr class="th">
                                                                                                        <th class="StyleTD">الإفادة</th>
                                                                                                        <th class="StyleTD">المرفقات</th>
                                                                                                    </tr>
                                                                                                </thead>
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td class="StyleTD" style="text-align:right;">
                                                                                                            <span style="font-size: 12px"><%# Eval("The_Statement_")%></span>
                                                                                                        </td>
                                                                                                        <td class="StyleTD">
                                                                                                            <a class="btn btn-default btn-sm download_button" style="<%# ClassSaddam.FCheckNullFile(Eval("The_File_").ToString()) %>"
                                                                                                                href="/<%# Eval("The_File_") %>" data-file="pdf" data-fancybox data-type="iframe" title="عرض الملف" data-toggle="tooltip">
                                                                                                                <i class="fas fa-file-pdf"></i>
                                                                                                                <div>
                                                                                                                    <span>عرض الملف </span><small><%--<%# ClassSaddam.FGetTypeFileOutTitle((string)Eval("The_File_")) %>--%> </small>
                                                                                                                </div>
                                                                                                            </a>
                                                                                                            <a class="btn btn-default btn-sm download_button" style="<%# ClassSaddam.FCheckNotNullFile(Eval("The_File_").ToString()) %>" data-file="pdf">
                                                                                                                <i class="fas fa-file-pdf"></i>
                                                ...
                                                <asp:TemplateField HeaderText="بتاريخ" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDate_Add" runat="server" 
                                                            Text='<%# Eval("CreatedDate", "{0:dd/MM/yyyy HH:mm tt}") %>' Font-Size="11px"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeAccountableByView.aspx?IDYear=<%# Eval("FinancialYear_Id_") %>&ID=<%# Eval("Number_Accountable_") %>&IDU=<%# Eval("EmployeeAccountableID")%>' 
                                                            title="عرض الملف" data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i></a> 
                                                        <a href='PageEmployeeAccountableAdd.aspx?ID=<%# Eval("EmployeeAccountableID")%>' 
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeAccountableByView.aspx?ID=<%# Eval("EmployeeAccountableID")%>' 
                                                            title="عرض الملف" data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i></a> 
                                                        <a href='PageEmployeeAccountableAdd.aspx?ID=<%# Eval("EmployeeAccountableID")%>' 
                                                            title="إضافة الإفادة" data-toggle="tooltip">
                                                            <i class="fa fa-edit"></i></a>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeAccountableByView.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeAccountables_PageEmployeeAccountableByView" %>
<style type="text/css">
    .StyleTD {
        text-align: center;
        padding: 5px;
    ...
    <div class="container-fluid">
        <div class="pull-right">
            <span runat="server" id="IDSearch">
                ...
                <asp:TextBox ID="txtSearch" runat="server" CssClass="WidthText20" placeholder=" رقم الإجراء ... "></asp:TextBox>
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="PageEmployeeAccountables.aspx">مساءلات الموظفين</a></li>
            <li><a href="">تفاصيل مساءلة</a></li>
        </ul>
    </div>
</div>
                    ...
                    <table style="width: 95%">
                        <tr>
                            <td class="StyleTD" colspan="2">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 25%; border-left: double; border-width: 2px; border-color: #a1a0a0;">رقم الإجراء
                                        </td>
                                ...
                                <div class="container-fluid" dir="rtl">
                                    <div class="WidthText5">
                                        <div class="form-group">
                                            <strong>(1) طلب الإفادة : 
                                            </strong>
                                        </div>
                                    </div>
                                    <div class="WidthText4">
                                        <div class="form-group">
                                            <strong>المكرم / الموظف الموضح بياناته بعاليه 
                                            </strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="WidthText5" style="margin-bottom:10px;">
                                        <div class="form-group">
                                            <p>
                                                <strong>
                                                    <asp:Label ID="lblStatement_Request" runat="server"></asp:Label>
                                                </strong>
                                            </p>
                                            <strong>
                                                رئيس اللجنة المالية والادارية :  
                                                <asp:Label ID="lbl_Raees_Top" runat="server"></asp:Label>
                                                , التوقيع : 
                                                <asp:Image ID="Img_Raees_Top" runat="server" Width='100px' Height='25' />
                                                , التاريخ :
                                                <asp:Label ID="lblDate_Accountable_Top" runat="server"></asp:Label> م 
                                            </strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="WidthText5">
                                        <div class="form-group">
                                            <strong>
                                                <asp:Label ID="lblTheStatement" runat="server"></asp:Label>
                                            </strong>
                                        </div>
                                    </div>
                                    <div class="WidthText5" style="margin-bottom:10px;">
                                        <div class="form-group">
                                            <strong>
                                                الإسم :  
                                                <asp:Label ID="lblName_Down" runat="server"></asp:Label>
                                                , التوقيع : 
                                                <asp:Image ID="Img_Emp" runat="server" Width='100px' Height='25' />
                                                , التاريخ :
                                                <asp:Label ID="lblDate_Accountable_Mediam" runat="server"></asp:Label> م 
                                            </strong>
                                        </div>
                                    </div>
                                    <hr style='border: solid; border-width: 1px; width: 100%' />
                                    <div class="WidthText5">
                                        <div class="form-group">
                                            <strong>
                                                (3) قرار المشرف المختص : 
                                            </strong>
                                            <strong>
                                            <div style="margin:10px 0 10px 0;">
                                                <div runat="server" id="pnl_Allow_Accountable" visible="false">
                                                <i class="fa fa-check-square"></i> تحتسب له إجازة مرضية بعد التأكد من نظامية التقرير
                                                </div>
                                                <div runat="server" id="pnl_Allow_Resolved" visible="false">
                                                    <i class="fa fa-check-square"></i> يعتمد الحسم لعدم قبول العذر
                                                </div>
                                                <div runat="server" id="pnl_Warning_Oral" visible="false">
                                                    <i class="fa fa-check-square"></i> إنذار شفهي
                                                </div>
                                                <div runat="server" id="pnl_Warning_Written" visible="false">
                                                    <i class="fa fa-check-square"></i> إنذار كتابي
                                                </div>
                                                <div runat="server" id="pnl_Warning_Final" visible="false">
                                                    <i class="fa fa-check-square"></i>  إنذار نهائي
                                                </div>
                                            </div>
                                            </strong>
                                            <strong>
                                                ...
                                                , التاريخ :
                                                <asp:Label ID="lblDate_Accountable_Bottom" runat="server"></asp:Label> م 
                                            </strong>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeMandates.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeMandates_PageEmployeeMandates" %>
...
<script type="text/javascript">
    function ConfirmDelete() {
        var count = document.getElementById("<%=hfCount.ClientID %>").value;
            var gv = document.getElementById("<%=GVEmployeeMandates.ClientID%>");
...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a href="~/Cpanel/ERP/HRAndPayRoll/Transactions/PageEmployeeMandateAdd.aspx" data-toggle="tooltip" title="إضافة إنتدابات للموظفين" class="btn btn-info" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageEmployeeMandates.aspx">قائمة إنتدابات الموظفين </a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-list"></i>قائمة إنتدابات الموظفين
                </h3>
                    ...
                    <div class="table table-responsive" runat="server" dir="rtl" id="pnlprint">
                        <table class='table' style="width: 100%">
                                        ...
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث" 
                                                    ...
                                                    Text="قائمة إنتدابات الموظفين"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GVEmployeeMandates" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeMandateMapID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        ...
                                                        <a href='PageEmployeeMandateAdd.aspx?ID=<%# Eval("EmployeeMandateMapID")%>' 
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                                    <ItemTemplate>
                                                        <a href='PageEmployeeMandateByView.aspx?ID=<%# Eval("EmployeeMandateMapID")%>' 
                                                            title="عرض الملف" data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i></a> 
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeMandateList.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeMandates_PageEmployeeMandateList" %>
...
<div class="page-header">
    <div class="container-fluid">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="PageEmployeeMandateList.aspx">مسير الإنتدابات </a></li>
        </ul>
    </div>
</div>
<div class="container-fluid">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">
                ...
                <asp:Label ID="lbmsg" runat="server" Text="مسير إنتداب الموظفين"></asp:Label>
            </h3>
        </div>
                                ...
                                <table class='table table-bordered table-condensed' style="width: 100%" aria-multiline="true">
                                    <thead>
                                        <tr class="th">
                                            ...
                                            <th class="StyleTD">الرقم الوظيفي
                                            </th>
                                            ...
                                            <th class="StyleTD">أيام الإنتداب
                                            </th>
                                            <th class="StyleTD">رقم الإنتداب
                                            </th>
                                            <th class="StyleTD">مبلغ الإنتداب
                                            </th>
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="GVEmployeeMandates" runat="server" OnPreRender="GVEmployeeMandates_PreRender">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <th class="StyleTD th">
                                                        <span style="font-size: 12px"><%# Eval("Start_Date_", "{0:MM/dd/yyyy}") %></span>
                                                    </th>
                                                    ...
                                                    <td class="StyleTD">
                                                        <span style="font-size: 12px"><%# Eval("Number_Mandate_")%></span>
                                                    </td>
                                                    <th class="StyleTD th">

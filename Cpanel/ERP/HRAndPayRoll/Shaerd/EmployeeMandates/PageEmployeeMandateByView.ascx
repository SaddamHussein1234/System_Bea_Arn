<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEmployeeMandateByView.ascx.cs" Inherits="Cpanel_ERP_HRAndPayRoll_Shaerd_EmployeeMandates_PageEmployeeMandateByView" %>
<style type="text/css">
    .StyleTD {
        text-align: center;
        padding: 5px;
...
<div class="page-header">
    <div class="container-fluid">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="PageEmployeeMandates.aspx">إنتدابات الموظفين</a></li>
            <li><a href="#">تفاصيل انتداب موظف</a></li>
        </ul>
    </div>
</div>
<asp:Panel ID="pnlPrint" runat="server" Direction="RightToLeft" Visible="false">
    <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
        <table style="width: 100%;">
            <tr>
                <td align="center">
                    <asp:TextBox ID="txtTitle" runat="server" Font-Size="14px" class="form-control" placeholder="عنوان البحث" Text="انتداب موظف" Style="text-align: center; width: 95%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                </td>
                <td align="center">
                    ...
                    <table style="width: 95%">
                        <tr>
                            <td class="StyleTD" colspan="2">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 25%; border-left: double; border-width: 2px; border-color: #a1a0a0;">رقم الإنتداب
                                        </td>
                                ...
                                <div class="container-fluid" dir="rtl">
                                    <div class="WidthText4">
                                        <div class="form-group">
                                            <strong> المهمة المنتدب إليها :-
                                            </strong>
                                        </div>
                                    </div>
                                    <div class="WidthText2">
                                        <div class="form-group">
                                            <strong>مبلغ الانتداب 
                                ...
                                <div class="container-fluid" dir="rtl">                                          
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="form-group">
                                                    للاطلاع والتوجيه حيال النتداب الموضح بياناته بعاليه حيث أن ملاحظاتنا هي : -
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageAfieldVisitPendingApprovalByRaees.aspx.cs" Inherits="Cpanel_PageAfieldVisitPendingApprovalByRaees" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageAfieldVisitPendingApprovalByRaees.aspx">قائمة زيارات بإنتظار الموافقه</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة زيارات بإنتظار موافقه رئيس المجلس
                        </h3>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="إسم المستفيد" HeaderStyle-ForeColor="#CCCCCC">
                                            <ItemTemplate>
                                                ...
                                                <br />
                                                <%# ClassSaddam.FCheckAllowModer((bool) (Eval("IsModer")))%> 

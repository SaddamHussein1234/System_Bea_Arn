...
public partial class Cpanel_PageAfieldVisitEdit : System.Web.UI.Page
{
    string XID;
    ...
    private void FZyaraEdit()
    {
        ...
        CZM._IDAdmin = Convert.ToInt32(IDUser);
        CZM._IDManage = 105;
        ...
        if (Attach_Repostry_SMS_Send_.AllSendSystemSocialSearch())
            Attach_Repostry_SMS_Send_.FAddSMSMessage(ClassAdmin_Arn.FGetPhoneByIDRaees(), "تعديل زيارة ميدانية" + "\n" + "رقم الملف :" + txtNumberMostafeed.Text.Trim() + "\n" + "بإنتظار الموافقة ,,,", "BerArn", "Edit", Test_Saddam.FGetIDUsiq());
    }

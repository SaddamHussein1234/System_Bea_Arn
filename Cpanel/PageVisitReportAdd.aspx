<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageVisitReportAdd.aspx.cs" Inherits="Cpanel_PageVisitReportAdd" %>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group date " style="margin-right: -10px">
                                            <asp:TextBox ID="txtDateReport" runat="server" class="form-control" Width="120" data-date-format="YYYY-MM-DD" ValidationGroup="g5" Style="direction: ltr"></asp:TextBox>
            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-pencil"></i>
                            <asp:Label ID="Label7" runat="server" Text="إحتياجات الأجهزة الكهربائية"></asp:Label>
                        </h3>
                                ...
                                <div class="container-fluid" dir="rtl">
                                    ...
                                    <div class="WidthText1">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group date " style="margin-right: -10px">
                                                    <asp:TextBox ID="txtDate" runat="server" class="form-control" Width="120" data-date-format="YYYY-MM-DD" ValidationGroup="GDevice" Style="direction: ltr"></asp:TextBox>
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-default" type="button">
                                                            <i class="fa fa-calendar"></i>
                                                        </button>
                                                ...
                                                <asp:TemplateField HeaderText="تاريخ الإضافة" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDate_Add" runat="server" 
                                                            Text='<%# Eval("DateAddDevice", "{0:dd/MM/yyyy}") + " " + Eval("DateAddDevice", "{0:HH:mm tt}")  %>' Font-Size="11px"></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>

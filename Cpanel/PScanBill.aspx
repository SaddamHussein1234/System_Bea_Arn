<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PScanBill.aspx.cs" Inherits="Cpanel_PScanBill" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-list"></i>سند إدخال أصناف للمستودع
                    </h3>
                            ...
                            <asp:GridView ID="GVProductShopWarehouseByID" runat="server" AutoGenerateColumns="False" DataKeyNames="_IDItem"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="10px">
                                        <ItemTemplate>
                                            <a href='CPanelManageWarehouse/PageManageProductShippingWarehouse.aspx?ID=<%# Eval("_IDUniq")%>' title="تعديل" data-toggle="tooltip"
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: 65%; border: thin double #808080; border-width: 1px;" align="center">
                                    <asp:TextBox ID="lblSumWord" runat="server" Text="سند إدخال أصناف للمستودع" class="form-control" placeholder="عنوان البحث" Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                </td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelSetting/MPCPanel.master" AutoEventWireup="true" CodeFile="PageAdminEdit.aspx.cs" Inherits="Cpanel_CPanelSetting_PageAdminEdit" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="تعديل مستخدم"></asp:Label>
                    </h3>
                </div>
                <div class="col-sm-12">
                    ...
                    <div class="content-box-large">
                        <div class="widget-box">
                            <div style="float: left; padding: 5px;">
                                ...
                                <br />
                                <asp:FileUpload ID="FUImgAdmin" runat="server" data-toggle="tooltip" ToolTip="تحديد صورة المستخدم" />
                            </div>
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="مطلوب" ValidationGroup="g2" ControlToValidate="DLGroup" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="txtUserName"
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <h5>كلمة المرور : </h5>
                                        <asp:TextBox ID="txtPass" runat="server" class="form-control" ValidationGroup="g2" TextMode="Password"></asp:TextBox>
                                        <br />
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtRePass" runat="server" class="form-control" ValidationGroup="g2" TextMode="Password"></asp:TextBox>
                                        <br />
                        ...
                        <div class="widget-box">
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <div class="keepmeLogged">
                                            <label class="switch">
                                                <input name="RememberMe" type="checkbox" id="CBIsAdmin" runat="server" />
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="يرجى التحديد" ValidationGroup="g2" ControlToValidate="DLIsAdminInEdarah" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <h5>صورة التوقيع  : <br />
                                            <asp:Image ID="ImgSignature" runat="server" Width='100px' Height='30' />

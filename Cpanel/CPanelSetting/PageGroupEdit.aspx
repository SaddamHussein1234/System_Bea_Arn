<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelSetting/MPCPanel.master" AutoEventWireup="true" CodeFile="PageGroupEdit.aspx.cs" Inherits="Cpanel_CPanelSetting_PageGroupEdit" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">تعديل صلاحيات مجموعة</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="تعديل صلاحيات مجموعة"></asp:Label>
                    </h3>
                </div>
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="WidthText2">
                                    <div class="form-group">
                                        ...
                                        <br />
                                        <%--<asp:CheckBox ID="CBActive" runat="server" Font-Size="14px" CssClass="checkbox-inline"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="keepmeLogged">
                                            ...
                                            <label class="switch">
                                                ...
                                                <span class="slider round"></span>
                                                <span class="keepme">موافقة رئيسالشؤون </span>
                                            </label>
                                            <br />
                                        </div>
                                    </div>
        ...
        <div class="container-fluid">
            <div style="float: left">
                ...
                <asp:LinkButton ID="LinkButton1" runat="server" Style="margin-right: 4px; font-size: medium"
                    class="btn btn-danger btn-fill pull-left" OnClick="LinkButton1_Click">رجوع</asp:LinkButton>
            </div>
            <div style="width: 50%">
            </div>
            <br />

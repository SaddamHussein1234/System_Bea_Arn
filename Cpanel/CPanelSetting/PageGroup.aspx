<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelSetting/MPCPanel.master" AutoEventWireup="true" CodeFile="PageGroup.aspx.cs" Inherits="Cpanel_CPanelSetting_PageGroup" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageGroupAdd.aspx" data-toggle="tooltip" title="إضافة مجموعة" class="btn btn-primary" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
                        ...
                        <asp:Panel ID="pnlData" runat="server" Visible="False">
                            <asp:Panel ID="pnl2" runat="server" Direction="RightToLeft">
                                ...
                                <div class="table table-responsive">
                                    <asp:GridView ID="GVGroupArn" runat="server" AutoGenerateColumns="False" DataKeyNames="IDGroup"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="IDGroup" HeaderText="IDGroup" InsertVisible="False" ReadOnly="True" SortExpression="IDGroup" Visible="false" />
                                            <asp:BoundField DataField="NameGroup" HeaderText="عنوان المجموعة" SortExpression="NameGroup" HeaderStyle-ForeColor="#CCCCCC" />
                                            <asp:TemplateField HeaderText="حالة التفعيل" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                    <%# ClassSaddam.FCheckActive2((Boolean) Eval("IsActiveGroup")) %>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="تاريخ الإضافة" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                    <%# ClassDataAccess.FChangeF((DateTime) Eval("DateAddGroup")) %>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Right" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="15px">
                                                <ItemTemplate>
                                                    <a href='PageGroupEdit.aspx?ID=<%# Eval("IDUniqGroup")%>' title="تعديل" data-toggle="tooltip" class="btn btn-info">

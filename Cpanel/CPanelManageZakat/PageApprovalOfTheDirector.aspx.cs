...
public partial class Cpanel_CPanelManageZakat_PageApprovalOfTheDirector : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            CheckAccountAdmin();
            FGetByApprovalOfTheDirector();
        }
    }

    private void FGetByApprovalOfTheDirector()
    {
        try
        {
            ...
            MWZB.IDCheck = "GetByApprovalOfTheDirector";

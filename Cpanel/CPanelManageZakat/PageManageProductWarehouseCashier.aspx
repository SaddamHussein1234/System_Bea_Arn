<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelManageZakat/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageProductWarehouseCashier.aspx.cs" Inherits="Cpanel_CPanelManageZakat_PageManageProductWarehouseCashier" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageManageProductWarehouseCashier.aspx">قائمة فواتير الدعم العيني </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                                        ...
                                        <tr>
                                            <th>
                                                ...
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة سندات الدعم العيني التي تحتاج إلى موافقة المشرف المالي" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>

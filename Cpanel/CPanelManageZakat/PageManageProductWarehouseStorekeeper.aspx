<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelManageZakat/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageProductWarehouseStorekeeper.aspx.cs" Inherits="Cpanel_CPanelManageZakat_PageManageProductWarehouseStorekeeper" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageManageProductWarehouseStorekeeper.aspx">قائمة فواتير الدعم العيني </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة فواتير الدعم العيني - مصادقة أمين المستودع
                        </h3>
                                        ...
                                        <tr>
                                            <th>
                                                ...
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة سندات الدعم العيني التي تحتاج إلى مصادقة أمين المستودع" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                                ...
                                                <asp:GridView ID="GVWarehouseCashier" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                            <ItemTemplate>
                                                                <a href='PageDeedDonationInKindDetails.aspx?IDYear=<%# Eval("_ID_FinancialYear_") %>&ID=<%# Eval("_bill_Number_")%>&IDP=<%# Eval("_ID_Project_")%>&Type=Moder' title="عرض التفاصيل" data-toggle="tooltip"

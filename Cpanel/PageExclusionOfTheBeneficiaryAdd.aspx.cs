...
public partial class Cpanel_PageExclusionOfTheBeneficiaryAdd : System.Web.UI.Page
{
    string XID;
    ...
    private void FArnEadatMostafeedAdd()
    {
        ...
        if (Attach_Repostry_SMS_Send_.AllSendSystemSocialSearch())
            Attach_Repostry_SMS_Send_.FAddSMSMessage(ClassAdmin_Arn.FGetPhoneByIDRaees(), "إضافة طلب إستبعاد مستفيد" + "\n" + "رقم الملف :" + txtNumberMostafeed.Text.Trim() + "\n" + "بإنتظار الموافقة ,,,", "BerArn", "Add", Test_Saddam.FGetIDUsiq());
    }

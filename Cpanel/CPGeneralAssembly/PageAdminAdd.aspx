<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPGeneralAssembly/MPCPanel.master" AutoEventWireup="true" CodeFile="PageAdminAdd.aspx.cs" Inherits="Cpanel_CPGeneralAssembly_PageAdminAdd" %>
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <h5>حدد المجموعة : </h5>
                                        <asp:DropDownList ID="DLGroup" runat="server" ValidationGroup="g2" Width="100%" Enabled="false"
                                            CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px; height: 32px">
                            ...
                            <div class="container-fluid" dir="rtl" runat="server" visible="false">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <div class="keepmeLogged">
                                            <label class="switch">
                                                <input name="RememberMe" type="checkbox" id="CBIsAssmply" runat="server" checked="checked" />
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtCommentAdmin" runat="server" class="form-control" ValidationGroup="g2" Text="عضو الجمعية العمومية"></asp:TextBox>

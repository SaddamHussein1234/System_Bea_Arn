...
public partial class Cpanel_CPGeneralAssembly_PageAdminAdd : System.Web.UI.Page
{
    ...
    private void FChackEmail()
    {
        ...
        if (dtEmail.Rows.Count > 0)
        {
            IDMessageSuccess.Visible = false;
            IDMessageWarning.Visible = true;
            lblMessageWarning.Text = "البريد الالكتروني مستخدم بالفعل ... ";
            return;
        }
        else
            FChackPass();
    ...
    private void FAdminAdd()
    {
        ...
        CA._IDGroup = Convert.ToInt32(23549);

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPGeneralAssembly/MPCPanel.master" AutoEventWireup="true" CodeFile="PageAdmin.aspx.cs" Inherits="Cpanel_CPGeneralAssembly_PageAdmin" %>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-12" align="center">
                            <asp:RadioButtonList ID="rblCheck" runat="server" CssClass="checkbox-inline" Visible="false"
                                RepeatDirection="Horizontal" AutoPostBack="True"
                                OnSelectedIndexChanged="rblCheck_SelectedIndexChanged">
                                <asp:ListItem Value="0" Text=" جميع المستخدمين " ></asp:ListItem>
                                <asp:ListItem Value="1" Text=" أعضاء مجلس الإدارة "></asp:ListItem>
                                <asp:ListItem Value="4" Text=" أعضاء الجمعية العمومية " Selected="True"></asp:ListItem>

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelManageSite/MPCPanel.master" AutoEventWireup="true" CodeFile="PageMenu.aspx.cs" Inherits="Cpanel_CPanelManageSite_PageMenu" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageMenuAdd.aspx" data-toggle="tooltip" title="إضافة قائمة جديدة" class="btn btn-primary" id="IDAdd" runat="server"><i class="fa fa-plus"></i></a>
                                ...
                                <div class="table table-responsive">
                                    <asp:GridView ID="GVMenu" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="TitleManageAr" HeaderText="العنوان(عربي)" SortExpression="TitleManageAr" HeaderStyle-ForeColor="#CCCCCC" />
                                            <asp:BoundField DataField="TitleManageTr" HeaderText="العنوان(تركي)" SortExpression="TitleManageTr" HeaderStyle-ForeColor="#CCCCCC" Visible="false" />
                                            <asp:BoundField DataField="TitleManageEn" HeaderText="العنوان(إنجليزي)" SortExpression="TitleManageEn" HeaderStyle-ForeColor="#CCCCCC" Visible="false" />

                                            <asp:BoundField DataField="IDOrder" HeaderText="الترتيب" SortExpression="IDOrder" HeaderStyle-ForeColor="#CCCCCC" />
                                            <asp:TemplateField HeaderText="حالة العرض" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                    <%# ClassSaddam.FChangeStyleCheckbox2((Boolean) Eval("ViewMenu"))%>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Right" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="حالة التفرع" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                    <%# ClassSaddam.FChangeStyleCheckbox2((Boolean) Eval("IsFork"))%>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Right" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="نوع التفرع" HeaderStyle-ForeColor="#CCCCCC">
                                                <ItemTemplate>
                                                    <%# ClassSaddam.FChangeMenuF((Int32) Eval("TypeSection"))%>
                                                    <%# ClassMenuSite.FGetMenuF((Int32) Eval("IDPartSection"))%>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Right" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="15px">
                                                <ItemTemplate>
                                                    <a href='PageMenuEdit.aspx?ID=<%# Eval("IDItem")%>&Name<%# Eval("TitleManageAr")%>' title="تعديل" data-toggle="tooltip">

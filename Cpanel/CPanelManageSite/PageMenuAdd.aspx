<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelManageSite/MPCPanel.master" AutoEventWireup="true" CodeFile="PageMenuAdd.aspx.cs" Inherits="Cpanel_CPanelManageSite_PageMenuAdd" %>
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group" runat="server" id="IDMenu" visible="false">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="* حدد القائمة" CssClass="font"
                                            ControlToValidate="DLMenu" ValidationGroup="g2" Font-Size="10px" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-lg-5">
                                    <div class="form-group">

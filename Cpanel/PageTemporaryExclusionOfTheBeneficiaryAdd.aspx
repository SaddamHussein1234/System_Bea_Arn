<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageTemporaryExclusionOfTheBeneficiaryAdd.aspx.cs" Inherits="Cpanel_PageTemporaryExclusionOfTheBeneficiaryAdd" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageTemporaryExclusionOfTheBeneficiary.aspx">طلبات الإستبعاد المؤقته</a></li>
                    <li><a href="PageTemporaryExclusionOfTheBeneficiaryAdd.aspx">إضافة طلب إستبعاد مؤقت</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-pencil"></i>
                            <asp:Label ID="Label4" runat="server" Text="إضافة طلب إستبعاد مؤقت"></asp:Label>
                        </h3>
                    </div>
                    <div class="panel-body">
                        <div class="content-box-large">
                                    ...
                                    <div class="WidthText1">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator4" runat="server"
                                                ControlToValidate="DLRaeesLagnatAlBahath" ErrorMessage="* حدد لحنة البحث الاجتماعي" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                                ValidationGroup="g2" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>

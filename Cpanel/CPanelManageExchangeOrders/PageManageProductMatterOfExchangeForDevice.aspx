<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelManageExchangeOrders/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageProductMatterOfExchangeForDevice.aspx.cs" Inherits="Cpanel_CPanelManageExchangeOrders_PageManageProductMatterOfExchangeForDevice" Debug="true" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">إضافة أمر صرف أجهزة</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div style="float: left">
                        ...
                        <asp:DropDownList ID="DLSupportType" runat="server" ValidationGroup="g2" CssClass="form-control2" AutoPostBack="true" 
                        ...
                        <div class="container-fluid" dir="rtl">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="DLCompany" runat="server" ValidationGroup="g2" Width="100%" CssClass="form-control2 chzn-select dropdown" Enabled="false"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtNumberMostafeed" runat="server" class="form-control" ValidationGroup="g2" Enabled="false"
                                        AutoPostBack="true" OnTextChanged="txtNumberMostafeed_TextChanged"></asp:TextBox>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="DLName" runat="server" ValidationGroup="g2" Width="100%" Enabled="false"
                                        CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;" AutoPostBack="true" OnSelectedIndexChanged="DLName_SelectedIndexChanged">
                                        <asp:ListItem Value=""></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                    ...
                    <div class="content-box-large">
                        <div class="widget-box">
                            <div class="container-fluid" dir="rtl">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <h5>الإنتماء : <span style="color: red">*</span>
                                        </h5>
                                        <asp:DropDownList ID="DLAffiliation" runat="server" ValidationGroup="g2" CssClass="form-control2 chzn-select dropdown" Enabled="false"
                                            Width="100%">
                                            <asp:ListItem></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator2" runat="server"
                                            ControlToValidate="DLAffiliation" ErrorMessage="* حدد الصنف" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                            ValidationGroup="g2" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLProduct" runat="server" ValidationGroup="g2" CssClass="form-control2 chzn-select dropdown"
                                            Width="100%" AutoPostBack="true" OnSelectedIndexChanged="DLProduct_SelectedIndexChanged">
                                            <asp:ListItem></asp:ListItem>
                                        </asp:DropDownList>

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelManageExchangeOrders/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageFinancialStatisticsCashSupport.aspx.cs" Inherits="Cpanel_CPanelManageExchangeOrders_PageManageFinancialStatisticsCashSupport" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageManageFinancialStatisticsCashSupport.aspx">قائمة الإحصاء المالي حسب الدعم النقدي</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                                                ...
                                                <asp:GridView ID="GVFinancialStatistics" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="عدد مرات الدعم" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ( <%# FGetCard((Int32) (Eval("AlQaryah")))%> ) / مرة
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="المبلغ الإجمالي" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCountTotalPrice" runat="server" Font-Size="12px" Text='<%# FPrice(Convert.ToInt32(Eval("AlQaryah")))%>'></asp:Label>
                                                                ريال
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />

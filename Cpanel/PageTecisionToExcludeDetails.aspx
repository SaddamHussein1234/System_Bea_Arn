<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageTecisionToExcludeDetails.aspx.cs" Inherits="Cpanel_PageTecisionToExcludeDetails" %>
                ...
                <tr>
                    <td colspan="2">
                        <div class="WidthText4" style="margin-right: 15px">
                            <asp:TextBox ID="txtTitle" runat="server" Font-Size="14px" class="form-control" placeholder="عنوان البحث" Text="قرار مجلس الإدارة لإستبعاد مستفيد" Style="text-align: center; width: 95%; background-color: #fc5d5d; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                        </div>
                        <div class="WidthText">

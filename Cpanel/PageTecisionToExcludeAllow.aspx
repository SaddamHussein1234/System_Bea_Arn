<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageTecisionToExcludeAllow.aspx.cs" Inherits="Cpanel_PageTecisionToExcludeAllow" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVTecisionToExcludeAllow.ClientID%>");
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageAcceptanceDecisionAllow.aspx">قائمة قرارات الإستبعاد التي تحتاج إلى موافقتك</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة قرارات الإستبعاد التي تحتاج إلى موافقتك
                        </h3>
                        ...
                        <asp:Panel ID="pnlData" runat="server" Direction="RightToLeft" Visible="False">
                            <div style="background-color: #8bfe5b;">
                                <div align="center" class="w">
                                    <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة قرارات الإستبعاد التي تحتاج إلى موافقتك" placeholder="عنوان البحث" Style="text-align: center; width: 100%"></asp:TextBox>
                                </div>
                            </div>
                            <hr />
                            <asp:GridView ID="GVTecisionToExcludeAllow" runat="server" AutoGenerateColumns="False" DataKeyNames="IDIteam"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                        <ItemTemplate>
                                            <a href='PageTecisionToExcludeDetails.aspx?ID=<%# Eval("NQarar")%>&XID=<%# Eval("IDUniq")%>' title="عرض الملف" data-toggle="tooltip"

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PScanQE.aspx.cs" Inherits="Cpanel_PScanQE" %>
                ...
                <tr>
                    <td colspan="2">
                        <div class="WidthText4" style="margin-right: 15px">
                            <asp:TextBox ID="txtTitle" runat="server" Font-Size="14px" class="form-control" placeholder="عنوان البحث" Text="قرار إستبعاد مستفيد" Style="text-align: center; width: 95%; background-color: #fc5d5d"></asp:TextBox>
                        </div>
                        <div class="WidthText">

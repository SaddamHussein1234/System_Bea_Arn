...
public partial class Cpanel_PageSearchStatusAdd : System.Web.UI.Page
{
    string XID;
    ...
    private void FArnBahthHalatMostafeedAdd()
    {
        ...
        //{
            ...
            //    CM._IsAllowModer_ = false;
            //    CM.BArnRasAlEstemarahUpdateModerAllow();

            //    CM._IsAllowRaeesLagnatAlBahth_ = false;
        ...
        else
        {
            ...
            if (Attach_Repostry_SMS_Send_.AllSendSystemSocialSearch())
                Attach_Repostry_SMS_Send_.FAddSMSMessage(ClassAdmin_Arn.FGetPhoneByIDRaees(), "إضافة بحث حالة" + "\n" + "رقم الملف :" + txtNumberMostafeed.Text.Trim() + "\n" + "بإنتظار الموافقة ,,,", "BerArn", "Add", Test_Saddam.FGetIDUsiq());
        }

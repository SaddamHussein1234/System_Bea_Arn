<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageSearchStatus.aspx.cs" Inherits="Cpanel_PageSearchStatus" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageConvertedCasesAdd.aspx" data-toggle="tooltip" title="إضافة طلب جديد" class="btn btn-primary" id="IDAdd" runat="server"><i class="fa fa-plus"></i></a>
                                                ...
                                                <asp:GridView ID="GVConvertedCases" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                            <ItemTemplate>
                                                                <a href='PageSearchStatusDetails.aspx?ID=<%# Eval("IDNumberReport")%>&XID=<%# Eval("IDUniq")%>' title='عرض الملف' data-toggle='tooltip'><span class="fa fa-eye"></span></a>
                                                                <br />
                                                                <a href='PageSearchStatusEdit.aspx?XID=<%# Eval("IDUniq") %>' title='تعديل الملف' data-toggle='tooltip'><span class='fa fa-edit'></span></a>
                                                            </ItemTemplate>

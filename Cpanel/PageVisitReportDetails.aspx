<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageVisitReportDetails.aspx.cs" Inherits="Cpanel_PageVisitReportDetails" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">تقارير الزيارات</a></li>
                    <li><a href="PageVisitReportDetails.aspx">تقرير نتيجة زيارة ميدانية</a></li>
                </ul>
            </div>
        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="container-fluid" dir="rtl">
                                                    ...
                                                    <asp:Panel ID="pnlDeviceMedical" runat="server" Visible="False">
                                                        <asp:Repeater ID="RPTDeviceByMostafeedMedical" runat="server">
                                                            <ItemTemplate>
                                                                <div class="Width10Percint StyleTD">
                                                                    <%# Library_CLS_Arn.WSM.WSM_ClassProduct.FProductName(Convert.ToInt32(Eval("_ID_Device_")))%> : 
                                                                    <%# Eval("_IDNumberCount") %>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
                                                ...
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        <td style="width: 33.3%; text-align: left">
                                                            ...
                                                            <br />
                                                            <div style="text-align:right; margin-top:-60px;" runat="server" visible="false" id="IDNote">
                                                                ملاحظة الباحث : <br />
                                                        ...
                                                        <td style="width: 33.3%; text-align: center; padding: 4px; border-left: double; border-right: double; border-top: double; border-width: 2px; border-color: #a1a0a0;">
                                                            <strong>مصادقة لحنة البحث الاجتماعي الإجتماعي 
                                                            </strong>
                                                        </td>

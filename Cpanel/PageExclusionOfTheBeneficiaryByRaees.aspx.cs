...
public partial class Cpanel_PageExclusionOfTheBeneficiaryByRaees : System.Web.UI.Page
{
    string XID;
    ...
    private void CheckAccountAdmin()
    {
        ...
        if (dtViewProfil.Rows.Count > 0)
        {
            ...
            A103 = Convert.ToBoolean(dtViewProfil.Rows[0]["A103"]);
            if (A101 == false)
            {
                IDAdd.Visible = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            CheckAccountAdmin();
            FArnEadatMostafeedByRaeesAlmaglis();
        }
    }

    private void FArnEadatMostafeedByRaeesAlmaglis()
    {
        try
        {
    ...
    {
        Response.Redirect("PageExclusionOfTheBeneficiaryByRaees.aspx");
    }

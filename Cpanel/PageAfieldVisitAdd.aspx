<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageAfieldVisitAdd.aspx.cs" Inherits="Cpanel_PageAfieldVisitAdd" %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group date " style="margin-right: -10px">
                                                <asp:TextBox ID="txtDateVisit" runat="server" class="form-control" Width="240" data-date-format="DD-MM-YYYY" ValidationGroup="g2" Style="direction: ltr" AutoPostBack="true" OnTextChanged="txtDateRegistry_TextChanged"></asp:TextBox>

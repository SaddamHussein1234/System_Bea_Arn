<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageAfieldVisitPendingApproval.aspx.cs" Inherits="Cpanel_PageAfieldVisitPendingApproval" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVAfieldVisitPendingApproval.ClientID%>");
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageAfieldVisitPendingApproval.aspx">قائمة زيارات بإنتظار الموافقه</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة زيارات بإنتظار موافقه مدير الجمعية
                        </h3>
                    ...
                    <div class="panel-body">
                        <asp:Panel ID="pnlData" runat="server">
                            <div class="table table-responsive">
                                <asp:GridView ID="GVAfieldVisitPendingApproval" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="إسم المستفيد" HeaderStyle-ForeColor="#CCCCCC">
                                            <ItemTemplate>
                                                ...
                                                <br />
                                                <span style="font-size: 11px">موافقة</span> <%# ClassSaddam.FCheckAllowModer((bool) (Eval("IsModer")))%>
                                        ...
                                        <asp:TemplateField HeaderText="نوع البحث" HeaderStyle-ForeColor="#CCCCCC">
                                            <ItemTemplate>
                                                <%# ClassSaddam.FChangeStyleCheckbox((bool) (Eval("BahthHalatMosTafeed")))%> <span style="font-size: 12px">بحث حالة مستفيد جديد</span>
                                                <br />
                                                <%# ClassSaddam.FChangeStyleCheckbox((bool) (Eval("EadatAlBahthLestafeedHaly")))%> <span style="font-size: 12px">إعادة البحث لمستفيد حالي</span>
                                                <br />
                                                <%# ClassSaddam.FChangeStyleCheckbox((bool) (Eval("EadatAlBahthLeMostafeedSabeq")))%> <span style="font-size: 12px">إعادة البحث لمستفيد سابق</span>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Right" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                            <ItemTemplate>
                                                ...
                                                <a href='PageAfieldVisitEdit.aspx?ID=<%# Eval("IDUniq")%>' title="تعديل" data-toggle="tooltip"

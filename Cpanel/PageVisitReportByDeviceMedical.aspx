<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageVisitReportByDeviceMedical.aspx.cs" Inherits="Cpanel_PageVisitReportByDeviceMedical" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageVisitReportByDevice.aspx">قائمة إحتياجات المستفيدين حسب الأجهزة الطبية</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <asp:Label ID="Label5" runat="server" Text="إحصائية حسب إحتياجات الأجهزة الطبية"></asp:Label>
                        </h3>
            ...
            <div class="container-fluid" runat="server" id="IDDataDevice">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة إحتياجات المستفيدين حسب الأجهزة الطبية
                        </h3>
                            ...
                            <div class="table table-responsive">
                                ...
                                <table class='table' style="width: 100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVVisitReport" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Mustafeed_"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="الأجهزة المطلوبة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <%# FGetDevice(Convert.ToInt32(Eval("_ID_Mustafeed_")),Convert.ToInt32(Eval("_ID_Report_")),DlVevice.SelectedValue) %>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                            <ItemTemplate>
                                                                <a href='PageVisitReportDetails.aspx?ID=<%# Eval("_ID_Report_")%>&XID=<%# Convert.ToString(Guid.NewGuid())%>' title="عرض الملف" data-toggle="tooltip"><span class="fa fa-eye"></span></a>
                                                                <br />
                                                                <a href='PageVisitReportEdit.aspx?ID=<%# Eval("_ID_Report_")%>&XID=<%# Convert.ToString(Guid.NewGuid())%>' title="تعديل" data-toggle="tooltip"
                                                ...
                                                <div class="container-fluid" dir="rtl" runat="server">
                                                    <div class="WidthText4" style="text-align: right">
                                                        <h5>إجمالي إحتياجات المستفيدين حسب الأجهزة الطبية 
                                                        </h5>
                                                    </div>
                                                </div>
                                                <div class="container-fluid" dir="rtl" runat="server">
                                                    <asp:Repeater ID="RPTDeviceAll" runat="server" Visible="false">
                                                        <ItemTemplate>
                                                            <%# ClassSaddam.FCheckNullDevice20(Convert.ToString(Eval("ProductName")), Convert.ToInt32(FGetCountDeviceAll(Convert.ToInt32(Eval("ProductID"))))) %>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                    <asp:Repeater ID="RPTDeviceByQariah" runat="server" Visible="false">
                                                        <ItemTemplate>
                                                            <%# ClassSaddam.FCheckNullDevice20(Convert.ToString(Eval("ProductName")), Convert.ToInt32(FGetCountDeviceByQariah(Convert.ToInt32(Eval("ProductID"))))) %>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                    <asp:Repeater ID="RPTDeviceByHalatMostafeed" runat="server" Visible="false">
                                                        <ItemTemplate>
                                                            <%# ClassSaddam.FCheckNullDevice20(Convert.ToString(Eval("ProductName")), Convert.ToInt32(FGetCountDeviceByHalatMostafeed(Convert.ToInt32(Eval("ProductID"))))) %>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                    <asp:Repeater ID="RPTDeviceByQariahAndHalatMostafeed" runat="server" Visible="false">
                                                        <ItemTemplate>
                                                            <%# ClassSaddam.FCheckNullDevice20(Convert.ToString(Eval("ProductName")), Convert.ToInt32(FGetCountDeviceByQariahAndHalatMostafeed(Convert.ToInt32(Eval("ProductID"))))) %>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                    <asp:Repeater ID="RPTDeviceByDevice" runat="server" Visible="false">
                                                        <ItemTemplate>
                                                            <%# ClassSaddam.FCheckNullDevice20(Convert.ToString(Eval("ProductName")), Convert.ToInt32(FGetCountDeviceByDevice(Convert.ToInt32(Eval("ProductID"))))) %>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                    <asp:Repeater ID="RPTDeviceByQariahAndDevice" runat="server" Visible="false">
                                                        <ItemTemplate>
                                                            <%# ClassSaddam.FCheckNullDevice20(Convert.ToString(Eval("ProductName")), Convert.ToInt32(FGetCountDeviceByQariahAndDevice(Convert.ToInt32(Eval("ProductID"))))) %>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                    <asp:Repeater ID="RPTDeviceByHalatMostafeedAndDevice" runat="server" Visible="false">
                                                        <ItemTemplate>
                                                            <%# ClassSaddam.FCheckNullDevice20(Convert.ToString(Eval("ProductName")), Convert.ToInt32(FGetCountDeviceByHalatMostafeedAndDevice(Convert.ToInt32(Eval("ProductID"))))) %>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                    <asp:Repeater ID="RPTDeviceByAlQariahAndHalatMostafeedAndDevice" runat="server" Visible="false">
                                                        <ItemTemplate>
                                                            <%# ClassSaddam.FCheckNullDevice20(Convert.ToString(Eval("ProductName")), Convert.ToInt32(FGetCountDeviceByAlQariahAndHalatMostafeedAndDevice((Int64) (Eval("ProductID"))))) %>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                </div>                               
                                            </td>

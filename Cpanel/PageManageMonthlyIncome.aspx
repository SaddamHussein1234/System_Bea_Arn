<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageMonthlyIncome.aspx.cs" Inherits="Cpanel_PageManageMonthlyIncome" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageManageMonthlyIncome.aspx">قائمة الدخل الشهري في النظام</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <asp:Label ID="lbmsg" runat="server" Text="إضافة دخل شهري للنظام"></asp:Label>
                        </h3>
                    </div>
                                ...
                                <div class="container-fluid" dir="rtl">
                                    <div class="WidthText4">
                                        <div class="form-group">
                                            <h5>عنوان الدخل الشهري : <span style="color: red">*</span>
                                            </h5>
                                            <asp:TextBox ID="txtName" runat="server" class="form-control" ValidationGroup="g2"></asp:TextBox>
                                            <asp:Label ID="lblName" runat="server" Text="* يرجى إضافة الدخل الشهري" ForeColor="Red" Font-Size="11px" Visible="false"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="WidthText4">
                                        <div class="form-group">
            ...
            <div class="container-fluid" runat="server" id="view">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة الدخل الشهري في النظام
                        </h3>
                            ...
                            <asp:GridView ID="GVVillageAll" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="الدخل الشهري" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            <%# Eval("AlDakhlAlShahryWaMasdarah")%>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16px">
                                        <ItemTemplate>
                                            <a href='PageManageMonthlyIncome.aspx?ID=<%# Eval("IDUniq")%>' title="تعديل"

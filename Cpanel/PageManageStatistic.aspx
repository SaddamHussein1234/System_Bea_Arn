<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageStatistic.aspx.cs" Inherits="Cpanel_PageManageStatistic" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6" runat="server" id="IDBeneficiaryBySearchBoysComprehensive" visible="false">
                    <a href="PageBeneficiaryBySearchBoysComprehensive.aspx" data-toggle="tooltip" title="بحث شامل عن المستفيدين">
                        <div class="tile">
                            <div class="tile-heading">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6" runat="server" id="IDBeneficiaryChildren" visible="false">
                    <a href="PageBeneficiaryChildren.aspx" data-toggle="tooltip" title="حسب الأطفال">
                        <div class="tile">
                            <div class="tile-heading">
                                حسب الأطفال <span class="pull-right"></span>
                            </div>
                            <div class="tile-body">
                                <i class="fa fa-list"></i>
                                <h2 class="pull-right"></h2>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6" runat="server" id="IDBeneficiaryTheElderly" visible="false">
                    <a href="PageBeneficiaryTheElderly.aspx" data-toggle="tooltip" title="حسب كبار السن">
                        <div class="tile">
                            <div class="tile-heading">
                                حسب كبار السن <span class="pull-right"></span>
                            </div>
                            <div class="tile-body">
                                <i class="fa fa-list"></i>
                                <h2 class="pull-right"></h2>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6" runat="server" id="IDBeneficiaryYoung" visible="false">
                    <a href="PageBeneficiaryYoung.aspx" data-toggle="tooltip" title="حسب الشباب والفتيات">
                        <div class="tile">
                            <div class="tile-heading">
                                حسب الشباب والفتيات <span class="pull-right"></span>
                            </div>
                            <div class="tile-body">
                                <i class="fa fa-list"></i>
                                <h2 class="pull-right"></h2>

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageAfieldVisitNotApproved.aspx.cs" Inherits="Cpanel_PageAfieldVisitNotApproved" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageAfieldVisitNotApproved.aspx">قائمة زيارات لم يتم الموافقه عليها</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة زيارات لم يتم الموافقه عليها
                        </h3>
                        ...
                        <asp:Panel ID="pnlData" runat="server">
                            ...
                            <asp:GridView ID="GVAfieldVisitApproval" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="رفض من قبل" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageSearchStatusEdit.aspx.cs" Inherits="Cpanel_PageSearchStatusEdit" %>
                        ...
                        <div class="container-fluid" dir="rtl">
                            ...
                            <div class="WidthText2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtNumberQarar" runat="server" class="form-control" ValidationGroup="g2" Enabled="false"></asp:TextBox>
                            ...
                            <div class="widget-box">
                                <div class="container-fluid" dir="rtl">
                                    <div class="container-fluid" dir="rtl">
                                        ...
                                        <div class="WidthText2">
                                            <div class="form-group">
                                                <h5>لحنة البحث الاجتماعي : <span style="color: red">*</span>
                                                </h5>

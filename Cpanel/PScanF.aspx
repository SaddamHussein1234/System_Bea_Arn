<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PScanF.aspx.cs" Inherits="Cpanel_PScanF" %>
                            ...
                            <div align="center" class="w">
                                <table style="width: 100%; background-color: #ffffff; color: #393939">
                                    <tr>
                                        ...
                                        <td style="border: thin double #808080; border-width: 1px; width: 20%">
                                            <span style="padding-right: 10px">رقم الأمر /  </span>
                                            <asp:Label ID="lblNumberTarmim" runat="server" Font-Size="12px"></asp:Label>
                                        </td>
                                        <td style="border: thin double #808080; border-width: 1px; width: 35%">
                                            <table style="width: 100%;">
                                                <tr>
                            ...
                            <div align="center" class="w">
                                <table style="width: 100%; background-color: #ffffff; color: #393939">
                                    <tr>
                                        ...
                                        <td style="border: thin double #808080; border-width: 1px; width: 20%">
                                            <span style="padding-right: 10px">رقم الأمر /  </span>
                                            <asp:Label ID="lblNumberPrisms" runat="server" Font-Size="12px"></asp:Label>
                                        </td>
                                        <td style="border: thin double #808080; border-width: 1px; width: 35%">
                                            <table style="width: 100%;">
                                                <tr>

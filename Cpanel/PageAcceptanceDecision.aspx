<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageAcceptanceDecision.aspx.cs" Inherits="Cpanel_PageAcceptanceDecision" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVAcceptanceDecision.ClientID%>");
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="PageAcceptanceDecisionAdd.aspx" data-toggle="tooltip" title="إضافة قرار جديد" class="btn btn-primary" id="IDAdd" runat="server"><i class="fa fa-plus"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageAcceptanceDecision.aspx">قائمة قرارات القبول</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة قرارات القبول
                        </h3>
                            ...
                            <div class="table table-responsive">
                                <table class='table' style="width: 100%">
                                        ...
                                        <tr>
                                            <th>
                                                ...
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة قرارات القبول" placeholder="عنوان البحث" Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVAcceptanceDecision" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="ر/القرار" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <%# Eval("NumberQarar")%><br /><%# Eval("NumberReport")%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="ر/التقرير" HeaderStyle-ForeColor="#CCCCCC" Visible="false">
                                                            <ItemTemplate>
                                                                <%# Eval("NumberReport")%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="ر/الملف" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                            <ItemTemplate>
                                                                <a href='PageAcceptanceDecisionDetails.aspx?ID=<%# Eval("NumberQarar")%>&XID=<%# Eval("IDUniq")%>' title="عرض الملف" data-toggle="tooltip"

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageBeneficiarySourceOfIncome.aspx.cs" Inherits="Cpanel_PageBeneficiarySourceOfIncome" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageBeneficiarySourceOfIncome.aspx">إحصائية حسب مصدر الدخل</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <asp:Label ID="lbmsg" runat="server" Text="إحصائية حسب مصدر الدخل"></asp:Label>
                        </h3>
            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>
                            <asp:Label ID="Label2" runat="server" Text="البيانات حسب مصدر الدخل"></asp:Label>
                        </h3>
                        <div style="float: left">
                            مصدر الدخل : 

<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageVisitReportByRaeesAllagnah.aspx.cs" Inherits="Cpanel_PageVisitReportByRaeesAllagnah" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageVisitReportByRaeesAllagnah.aspx">قائمة عرض تقارير الزيارات التي تحتاج إلى إطلاع رئيس اللجنة</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة عرض تقارير الزيارات التي تحتاج إلى إطلاع رئيس اللجنة
                        </h3>

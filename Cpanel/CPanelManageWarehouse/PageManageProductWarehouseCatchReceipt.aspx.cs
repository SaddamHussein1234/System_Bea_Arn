...
public partial class Cpanel_CPanelManageWarehouse_PageManageProductWarehouseCatchReceipt : System.Web.UI.Page
{
    ...
    private void FArnProductShopWarehouseByBill()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                "/Cpanel/CPanelManageWarehouse/PageManageProductWarehouseCatchReceipt.aspx?ID=" + txtSearch.Text.Trim();
                ...
                if (lblFromDonor.Text.Length == 36)
                    lblFromDonor.Text = Repostry_Company_.FCRM_Company_Manage(new Guid(ClassProductShopWarehouse.FLastDonor(Convert.ToInt32(dt.Rows[0]["_IDNaebRaees"]))));

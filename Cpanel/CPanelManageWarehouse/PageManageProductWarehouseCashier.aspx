<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelManageWarehouse/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageProductWarehouseCashier.aspx.cs" Inherits="Cpanel_CPanelManageWarehouse_PageManageProductWarehouseCashier" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageManageProductWarehouseCashier.aspx">قائمة أوامر شحن المستودع التي تحتاج إلى موافقة المشرف المالي</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة أوامر شحن تحتاج إلى موافقة المشرف المالي
                        </h3>
                            ...
                            <div class="table table-responsive">
                                <table class='table' style="width: 100%">
                                        ...
                                        <tr>
                                            <th>
                                                ...
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة أوامر شحن المستودع التي تحتاج إلى موافقة المشرف المالي" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVWarehouseCashier" runat="server" AutoGenerateColumns="False" DataKeyNames="_IDNaebRaees"

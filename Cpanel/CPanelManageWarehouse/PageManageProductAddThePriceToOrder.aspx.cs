...
public partial class Cpanel_CPanelManageWarehouse_PageManageProductAddThePriceToOrder : System.Web.UI.Page
{
    string XID;
    ...
    protected void LBRefreshPrisms_Click1(object sender, EventArgs e)
    {
        FArnSupportForPrismsByBillPrisms(Convert.ToInt32(txtSearchPrisms.Text.Trim()), Convert.ToInt32(DLProject.SelectedValue));
    }

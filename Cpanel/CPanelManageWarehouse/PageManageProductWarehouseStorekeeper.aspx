<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelManageWarehouse/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageProductWarehouseStorekeeper.aspx.cs" Inherits="Cpanel_CPanelManageWarehouse_PageManageProductWarehouseStorekeeper" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVWarehouseStorekeeper.ClientID%>");
    ...
    <script type="text/javascript">
        function DisableButton() {
            ...
            document.getElementById("<%=btnNotAllow.ClientID %>").disabled = true;
        }
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageManageProductWarehouseStorekeeper.aspx">قائمة أوامر شحن المستودع التي تحتاج إلى موافقة أمين المستودع</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة أوامر شحن تحتاج إلى مصادقة أمين المستودع
                        </h3>
                        <div style="float: left">
                            ...
                            <asp:Button ID="btnNotAllow" class="btn btn-danger" runat="server" Text="عدم الموافقة على السجلات المحددة" OnClick="btnNotAllow_Click"
                                title="عدم الموافقة على السجلات المحددة" data-toggle="tooltip" OnClientClick="return ConfirmDelete();" />
                        </div>
                    </div>
                            ...
                            <div class="table table-responsive">
                                <table class='table' style="width: 100%">
                                        ...
                                        <tr>
                                            <th>
                                                ...
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة أوامر شحن المستودع التي تحتاج إلى مصادقة أمين المستودع" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVWarehouseStorekeeper" runat="server" AutoGenerateColumns="False" DataKeyNames="_IDNaebRaees"
                                                    Width="100%" CssClass="footable1" EnableTheming="True" GridLines="Horizontal" OnRowDataBound="GVWarehouseStorekeeper_RowDataBound"

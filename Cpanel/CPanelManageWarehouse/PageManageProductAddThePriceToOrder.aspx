<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelManageWarehouse/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageProductAddThePriceToOrder.aspx.cs" Inherits="Cpanel_CPanelManageWarehouse_PageManageProductAddThePriceToOrder" %>
                ...
                <div class="panel-heading">
                    ...
                    <div style="float: left">
                        ...
                        <asp:LinkButton ID="btnSearchPrisms" runat="server" data-toggle="tooltip" title="جلب" OnClick="btnSearchPrisms_Click" ValidationGroup="gTarmim"
                            class="btn btn-info"><span class="tip-bottom"><i class="fa fa-search" style="font-size:16px"></i></span></asp:LinkButton>
                        <asp:LinkButton ID="LBRefreshPrisms" runat="server" class="btn btn-default" data-toggle="tooltip" OnClick="LBRefreshPrisms_Click1"
                            title="تحديث"><i class="fa fa-refresh"></i></asp:LinkButton>

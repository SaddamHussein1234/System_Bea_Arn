<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/CPanelManageWarehouse/MPCPanel.master" AutoEventWireup="true" CodeFile="PageManageProduct.aspx.cs" Inherits="Cpanel_CPanelManageWarehouse_PageManageProduct" %>
                                                ...
                                                <asp:GridView ID="GVProductAll" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductID"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="الوحدة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <%# Library_CLS_Arn.ClassEntity.Warehouse.Repostry.Repostry_Units_.FErp_Units_Manage_By_ID((Int64) (Eval("A2")))%>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:TemplateField>

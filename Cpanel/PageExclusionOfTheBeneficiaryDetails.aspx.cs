...
public partial class Cpanel_PageExclusionOfTheBeneficiaryDetails : System.Web.UI.Page
{
    string XID;
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                string code = ClassSetting.FGetNameServer() +
                    "/Cpanel/PageExclusionOfTheBeneficiaryDetails.aspx?ID=" + txtSearch.Text.Trim() + "&XID=" + dt.Rows[0]["IDUniq"].ToString();

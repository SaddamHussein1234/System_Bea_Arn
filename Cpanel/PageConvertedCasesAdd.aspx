<%@ Page Title="" Language="C#" MasterPageFile="~/Cpanel/MPCPanel.master" AutoEventWireup="true" CodeFile="PageConvertedCasesAdd.aspx.cs" Inherits="Cpanel_PageConvertedCasesAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <style type="text/css">
        ...
        .StyleTD {
            ...
            padding: 5px;
            border: double;
            border-width: 2px; border-color: #a1a0a0;
        }
    </style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content">
        <div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageConvertedCasesAdd.aspx">إضافة طلب تحويل الحالة</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
        ...
        <asp:Panel ID="pnlGetData" runat="server" Visible="false">
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-pencil"></i>
                            <asp:Label ID="Label4" runat="server" Text="إضافة طلب تحويل الحالة"></asp:Label>
                        </h3>
                    </div>
                    <div class="panel-body">
                        <div class="content-box-large">
            ...
            <div class="container-fluid" runat="server" visible="true" id="PnlManager">

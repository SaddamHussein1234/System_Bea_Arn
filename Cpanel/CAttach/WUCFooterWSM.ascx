<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WUCFooterWSM.ascx.cs" Inherits="Cpanel_CAttach_WUCFooterWSM" %>
    ...
    <tr>
        <td>
            ...
            <div class="WidthMaglis" align="center">
                <span style="font-size:14px;"> أمين المستودع </span>
                                                                    <br />
                <asp:Image ID="ImgAmeenAlmostoda" runat="server" Width='100px' Height='25' />
                <br />
                <asp:Label ID="lblAmeenAlmostoda" runat="server"></asp:Label>
                <asp:DropDownList ID="DLAmeenAlmostoda" runat="server" ValidationGroup="g2" Width="100%" AutoPostBack="true" 
                    OnSelectedIndexChanged="DLAmeenAlmostoda_SelectedIndexChanged"

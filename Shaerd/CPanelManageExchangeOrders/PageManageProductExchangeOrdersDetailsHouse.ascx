<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManageProductExchangeOrdersDetailsHouse.ascx.cs" Inherits="Shaerd_CPanelManageExchangeOrders_PageManageProductExchangeOrdersDetailsHouse" %>
    ...
    <div class="panel-body" id="IDFilter" runat="server">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <asp:CheckBoxList ID="CBCategory" runat="server" Font-Size="12px" RepeatDirection="Vertical" CssClass="checkbox" Width="100%">
                </asp:CheckBoxList>
            </div>
        </div>
        <div class="col-sm-3">
                            ...
                            <asp:GridView ID="GVExchangeOrders" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="عدد مرات الدعم" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            <%# FGetCountCard(Convert.ToInt32(Eval("ID")) , Convert.ToInt64(Eval("ID_Type"))) %> مرات
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Right" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="الإجمالي" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCountTotalPrice" runat="server" Font-Size="12px" Text='<%# FPrice(Convert.ToInt32(Eval("ID")) , Convert.ToInt64(Eval("ID_Type"))) %>'></asp:Label>
                                            ريال
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Right" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    ...
                                    <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                        <ItemTemplate>
                                            <a href='PageManageProductSupportByBeneficiary.aspx?TIDX=<%# Eval("ID")%>&XIDCate=<%# Eval("ID_Type")%>&XIDFrom=<%# txtDateFrom.Text.Trim()%>&XIDTo=<%# txtDateTo.Text.Trim()%>' title="عرض التفاصيل" data-toggle="tooltip"

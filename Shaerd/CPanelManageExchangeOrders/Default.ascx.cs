...
public partial class Shaerd_CPanelManageExchangeOrders_Default : System.Web.UI.UserControl
{
    string IDUniq;
    ...
    private void CheckAccountAdmin()
    {
        ...
        if (dtViewProfil.Rows.Count > 0)
        {
            ...
            if (A[106]) { IDManageProductMatterOfExchangeAdd.Visible = true; IDManageProductMatterOfExchangeForDamaged.Visible = true; IDSupportForPrismsAdd.Visible = true; }

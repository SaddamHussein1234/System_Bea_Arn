<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManageFinancialStatisticsByBuilding.ascx.cs" Inherits="Shaerd_CPanelManageExchangeOrders_PageManageFinancialStatisticsByBuilding" %>

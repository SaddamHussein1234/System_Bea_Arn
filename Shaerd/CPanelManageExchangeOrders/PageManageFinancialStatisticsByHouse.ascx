<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManageFinancialStatisticsByHouse.ascx.cs" Inherits="Shaerd_CPanelManageExchangeOrders_PageManageFinancialStatisticsByHouse" %>
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="">قائمة الإحصاء المالي حسب تـأثيث المنازل</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-list"></i>قائمة الإحصاء المالي حسب تـأثيث المنازل
                </h3>
            </div>
                                        ...
                                        <asp:GridView ID="GVFinancialStatistics" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                    ...
                                                    <ItemTemplate>
                                                        (
                                                                <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px" 
                                                                    Text='<%# FGetCard((Int32) (Eval("AlQaryah")), DLCategory.SelectedItem.ToString(),ClassQuaem.FAlQarabah((Int32) (Eval("AlQaryah"))))%>'></asp:Label>
                                                        ) أسره           
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                ...
                                                <asp:TemplateField HeaderText="عدد مرات الدعم" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        ( <%# FGetCard((Int32) (Eval("AlQaryah")), DLCategory.SelectedItem.ToString(),ClassQuaem.FAlQarabah((Int32) (Eval("AlQaryah"))))%> ) سلة
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManageProductApprovalOfTheDirector.ascx.cs" Inherits="Shaerd_CPanelManageExchangeOrders_PageManageProductApprovalOfTheDirector" %>
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="">قائمة أوامر الصرف التي تحتاج إلى موافقة مدير الجمعية</a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-list"></i>قائمة أوامر الصرف التي تحتاج إلى موافقة مدير الجمعية
                </h3>
                    ...
                    <div class="table table-responsive">
                        <table class='table' style="width: 100%">
                                ...
                                <tr>
                                    <th>
                                        ...
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة أوامر الصرف التي تحتاج إلى موافقة مدير الجمعية" placeholder="عنوان البحث" Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GVApprovalOfTheDirector" runat="server" AutoGenerateColumns="False" DataKeyNames="_billNumber,_IDCategory"
                            ...
                            <thead>
                                <tr>
                                    <th>
                                        ...
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitleHose" runat="server" class="form-control" Text="قائمة أوامر الصرف التي تحتاج إلى موافقة مدير الجمعية" placeholder="عنوان البحث" Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                    <ItemTemplate>
                                                        ...
                                                        <br />
                                                        <a href='PageManageProductRestorationAndConstructionEdit.aspx?IDX=<%# Eval("IDUniq")%>' title="تعديل البيانات" data-toggle="tooltip"><span class="fa fa-edit"></span></a>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                            </Columns>
                            ...
                            <thead>
                                <tr>
                                    <th>
                                        ...
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitlePrisms" runat="server" class="form-control" Text="قائمة أوامر الصرف التي تحتاج إلى موافقة مدير الجمعية" placeholder="عنوان البحث" Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                                    ...
                                    <td>
                                        <asp:GridView ID="GVApprovalOfTheDirectorPrisms" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                    <ItemTemplate>
                                                        <a href='PageManageProductAddThePriceToOrder.aspx?IDS=<%# Eval("billNumber_")%>&IDCh=<%# Eval("ID_Project_")%>&IDU=<%# Convert.ToString(Guid.NewGuid()) %>' title="عرض التفاصيل" data-toggle="tooltip"><span class="fa fa-eye"></span></a>
                                                        <br />
                                                        <a href='PageSupportForPrismsEdit.aspx?IDX=<%# Eval("IDUniq")%>' title="تعديل البيانات" data-toggle="tooltip"><span class="fa fa-edit"></span></a>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                            </Columns>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManageProductExchangeOrdersDetails.ascx.cs" Inherits="Shaerd_CPanelManageExchangeOrders_PageManageProductExchangeOrdersDetails" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="عدد مرات الدعم" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            ...
                                            <%# FGetCountCard(Convert.ToString(Eval("NameMostafeed")),Convert.ToInt32(Eval("_IDMosTafeed")) , Convert.ToInt32(Eval("_IDCategory"))) %> 
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Right" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:TemplateField>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManageProductSupportByBeneficiary.ascx.cs" Inherits="Shaerd_CPanelManageExchangeOrders_PageManageProductSupportByBeneficiary" %>
...
<div id="content">
                                            ...
                                            <asp:GridView ID="GVExchangeOrders" runat="server" AutoGenerateColumns="False" DataKeyNames="_billNumber"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="إسم المستفيد" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            <%# ClassMosTafeed.FGetMosTafeed((Int32) (Eval("_IDMosTafeed")))%> / رقم الأمر <%# Eval("_billNumber")%>
                                                            <br />
    ...
    <div class="page-header" runat="server" id="IDTarmem" visible="false">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="PageManageProductAnOrderToTxchangeHomeFurnishing.aspx" data-toggle="tooltip" title="إضافة أمر صرف جديد" class="btn btn-primary"><i class="fa fa-plus"></i></a>
    ...
    <div class="page-header" runat="server" id="IDPrisms" visible="false">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="PageSupportForPrismsAdd.aspx" data-toggle="tooltip" title="إضافة أمر صرف جديد" class="btn btn-primary"><i class="fa fa-plus"></i></a>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageSupportForPrismsEdit.ascx.cs" Inherits="Shaerd_CPanelManageExchangeOrders_PageSupportForPrismsEdit" %>
<style type="text/css">
...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a href="PageSupportForPrismsAdd.aspx" class="btn btn-primary">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="">أمر صرف نقدي</a></li>
            <li><a href="">تعديل أمر صرف نقدي لمستفيد</a></li>
        </ul>
    </div>
</div>
<div class="container-fluid">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">
                ...
                <asp:Label ID="lbmsg" runat="server" Text="تعديل أمر صرف نقدي لمستفيد"></asp:Label>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div style="float: left">
                ...
                <asp:DropDownList ID="DLSupportType" runat="server" ValidationGroup="g2" CssClass="form-control2" AutoPostBack="true" OnSelectedIndexChanged="DLSupportType_SelectedIndexChanged"
                    Width="150">
                ...
                <div class="container-fluid" dir="rtl">
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtNumberMostafeed" runat="server" class="form-control" Enabled="false" ValidationGroup="g2" AutoPostBack="true" OnTextChanged="txtNumberMostafeed_TextChanged"></asp:TextBox>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="DLName" runat="server" ValidationGroup="g2" Enabled="false" Width="100%" CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;" AutoPostBack="true" OnSelectedIndexChanged="DLName_SelectedIndexChanged">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtMoreDetails" runat="server" class="form-control" ValidationGroup="g2"
                                    Text="للمستفيد الموضح بياناته بعالية , بناءاً على الفواتير والسندات والعقود المرفقة ."

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManageFinancialStatisticsByDevice.ascx.cs" Inherits="Shaerd_CPanelManageExchangeOrders_PageManageFinancialStatisticsByDevice" %>
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="">قائمة الإحصاء المالي حسب الاجهزة الكهربائية</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-list"></i>قائمة الإحصاء المالي حسب الاجهزة الكهربائية
                </h3>
            </div>
                                        ...
                                        <asp:GridView ID="GVFinancialStatistics" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="عدد الأسر المستفيدة" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                        (
                                                                <asp:Label ID="lblCountAsrah" runat="server" Font-Size="12px" Text='<%# FGetCard((Int32) (Eval("AlQaryah")))%>'></asp:Label>
                                                        ) أسره           
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="الأجهزة التي تم صرفها" HeaderStyle-ForeColor="#CCCCCC">
                                                    <ItemTemplate>
                                                         <%# FGetDevice((Int32) (Eval("AlQaryah"))) %>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                            ...
                                            <tr>
                                                <td colspan="3" style="width: 15%; border: thin double #808080; border-width: 1px; padding: 10px" align="center">
                                                    <asp:Repeater ID="RPTDeviceAll" runat="server" Visible="false">
                                                        <ItemTemplate>
                                                           <div class='Width10Percint StyleTD' style="font-size:11px"> <%# Eval("ProductName") %> <%# FGetSumAllDevice(Convert.ToInt32(Eval("_IDProduct"))) %> </div>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                </td>
                                            </tr>

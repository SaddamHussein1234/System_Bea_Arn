<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageSubItems.ascx.cs" Inherits="Shaerd_ERP_OM_MainItems_PageSubItems" %>
...
<script type="text/javascript">
    function ConfirmDelete() {
        var count = document.getElementById("<%=hfCount.ClientID %>").value;
            var gv = document.getElementById("<%=GVMainItem.ClientID%>");
...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a href='javaScript:void(0)' data-toggle="modal" data-target="#IDModel3" title="إضافة بنك جديد" class="btn btn-info" runat="server" id="IDAdd"><i class="fa fa-plus"></i></a>
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageMainItems.aspx">قائمة البنود الرئيسية </a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-list"></i>قائمة البنود الرئيسية
                </h3>
                        ...
                        <div class="table table-responsive" id="pnlPrint" runat="server" dir="rtl">
                            <table class='table table-bordered table-condensed' style="width: 100%" aria-multiline="true">
                                            ...
                                            <div align="center" class="w">
                                                <div>
                                                    <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder="عنوان البحث"
                                                        ...
                                                        Text="قائمة البنود الرئيسية حتى حينة"></asp:TextBox>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GVMainItem" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="إسم البند عربي" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            <%# Eval("_Name_Ar_")  %>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="إسم البند إنجليزي" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            <div style="direction: ltr; text-align: left;"><%# Eval("_Name_En_") %></div>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="البنود الفرعية المرتبطة" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            <%# FGetCount(new Guid(Eval("_ID_Item_").ToString())) %>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                    ...
                    <div class="page-content">
                        <div class=" panel-body">
                            <label>
                                ...
                                <asp:Label ID="lblTitle" runat="server" Text="إضافة بند رئيسي جديد : "></asp:Label>
                            </label>
                            <div style="float: left;">

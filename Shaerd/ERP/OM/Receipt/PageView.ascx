<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageView.ascx.cs" Inherits="Shaerd_ERP_OM_Receipt_PageView" %>
...
<asp:Panel ID="pnlData" runat="server" Direction="RightToLeft" Visible="false">
            ...
            <table style="width: 100%; background-color: #ffffff; color: #393939">
                <tr>
                    <td style="border: thin double #808080; border-width: 1px; width: 45%">
                        <asp:TextBox ID="txtTitle" runat="server" Text="سند قبض" class="form-control" placeholder="عنوان البحث" Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                    </td>
    ...
    <div style="margin: 10px">
        ...
        <asp:Label ID="lblNameProject" runat="server" Font-Size="12px"></asp:Label>
        / 
    ...
    <table style="width: 100%; margin-top: -60px; font-size: 12px">
        <tr>
            <td style="width: 33%; border: thin double #808080; border-width: 1px;" align="center">
                <div style="margin: 0 0 5px 0;">
                    ...
                    <div align="right" style="margin-right: 5px;">
                        الإسم :
                        <asp:Label ID="lblModer" runat="server"></asp:Label><br />
                        التوقيع :
                        <asp:Image ID="ImgModer" runat="server" Width='100px' Height='30px' />
                        <asp:Label ID="lblModerAllowDate" runat="server"></asp:Label>
                    </div>
                </div>
            </td>
            <td style="width: 33%; border: thin double #808080; border-width: 1px;" align="center">
            ...
            <td style="width: 33%; border: thin double #808080; border-width: 1px; display:none;" align="center">
                <div style="margin: 0 0 5px 0;">
            ...
            <td style="width: 33%; border: thin double #808080; border-width: 1px;" align="center">
                <div style="margin: 0 0 5px 0;">
                    <span style="font-family: 'Alwatan'; font-size: 17px">الجهة أو الشخص</span>
                    <div align="right" style="margin-right: 5px;">
                        الإسم :

...
public partial class Shaerd_ERP_OM_Cashing_PageView : System.Web.UI.UserControl
{
    ...
    private void FGetByBill(string XIDYear, string XIDBill)
    {
        try
        {
            ...
            MC.IDCheck = "GetByBill";
            MC.ID_Item = new Guid(XIDYear);
            MC.bill_Number = Convert.ToInt64(XIDBill);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                "/ar/Cashing/PageView.aspx?ID=" + XIDBill + "&IDUniq=" + XIDYear;

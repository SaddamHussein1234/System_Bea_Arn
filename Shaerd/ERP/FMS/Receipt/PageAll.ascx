<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageAll.ascx.cs" Inherits="Shaerd_ERP_FMS_Receipt_PageAll" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageAll.aspx">قائمة إيصالات سندات القبض </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="float: right;">
                            <i class="fa fa-list"></i>قائمة إيصالات سندات القبض
                        </h3>
                        <div align="left">

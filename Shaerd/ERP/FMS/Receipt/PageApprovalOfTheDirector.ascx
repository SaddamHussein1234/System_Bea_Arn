<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageApprovalOfTheDirector.ascx.cs" Inherits="Shaerd_ERP_FMS_Receipt_PageApprovalOfTheDirector" %>
...
<!--
    ...
    <script type="text/javascript">
        function ConfirmDelete() {
            ...
            var gv = document.getElementById("<%=GVModer.ClientID%>");
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageCashier.aspx">قائمة فواتير سندات القبض </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة فواتير سندات القبض - موافقة مدير الجمعية
                        </h3>
                            ...
                            <div class="table table-responsive">
                                ...
                                <table class='table' style="width: 100%">
                                        ...
                                        <tr>
                                            <th>
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة فواتير إيصالات الدعم النقدي التي تحتاج إلى موافقة مدير الجمعية" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVModer" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"
                                                    Width="100%" CssClass="footable1" EnableTheming="True" GridLines="Horizontal" OnRowDataBound="GVModer_RowDataBound"
                                                        ...
                                                        <asp:TemplateField HeaderText="بيانات الفاتورة" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                ...
                                                                <div style="font-size: 11px" class="HideThis">
                                                                      <%# ClassSaddam.FCheckAllowModer((bool) (Eval("_IsAmmenAlSondoq_")))%>

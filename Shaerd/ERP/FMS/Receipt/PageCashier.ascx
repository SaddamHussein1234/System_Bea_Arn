<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageCashier.ascx.cs" Inherits="Shaerd_ERP_FMS_Receipt_PageCashier" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة فواتير سندات القبض - موافقة المشرف المالي
                        </h3>

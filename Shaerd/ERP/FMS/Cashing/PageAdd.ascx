<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageAdd.ascx.cs" Inherits="Shaerd_ERP_FMS_Cashing_PageAdd" %>
...
<div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageAdd.aspx">إضافة سند صرف</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-9">
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DL_Project" runat="server" ValidationGroup="GBill" Width="100%" CssClass="form-control chzn-select dropdown" Style="font-size: 12px;">
                                            <asp:ListItem Value=""></asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                    <h5>
                                        <asp:Label ID="lblSend" runat="server" Text="إرسال إشعار SMS"></asp:Label> <i class="fa fa-envelope"></i> : <span style="color: red">*</span>
                                    </h5>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-pencil"></i>
                        <asp:Label ID="lbmsg" runat="server" Text="إضافة سند صرف"></asp:Label>
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="content-box-large">
                        <div class="widget-box">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="* طبيعة الإستخدام" CssClass="font"
                            ...
                            <div class="container-fluid" dir="rtl" style="background-color:#f1eded; padding-right:5px; border-radius:7px; margin-top:10px;">
                                <div class="col-lg-12">
                                    <h5 style="margin-top:5px;">وذلك مقابل : </h5>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <h5>المقابل :
                                            </h5>

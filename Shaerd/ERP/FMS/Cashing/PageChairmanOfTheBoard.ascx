<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageChairmanOfTheBoard.ascx.cs" Inherits="Shaerd_ERP_FMS_Cashing_PageChairmanOfTheBoard" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageChairmanOfTheBoard.aspx">قائمة فواتير سندات الصرف </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة فواتير سندات الصرف - موافقة رئيس المجلس
                        </h3>
                            ...
                            <div class="table table-responsive">
                                ...
                                <table class='table' style="width: 100%">
                                        ...
                                        <tr>
                                            <th>
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة فواتير إيصالات الدعم النقدي التي تحتاج إلى موافقة رئيس مجلس الإدارة" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVChairmanOfTheBoard" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"
                                                    Width="100%" CssClass="footable1" EnableTheming="True" GridLines="Horizontal" OnRowDataBound="GVChairmanOfTheBoard_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="سحب من" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <span style="font-size: 12px">
                                                                    <%# Eval("_Finance_Account_")%>
                                                                </span>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="الجهة / الشخص" HeaderStyle-ForeColor="#CCCCCC">
                                                            <ItemTemplate>
                                                                <span style="font-size: 12px">
                                                                    <%# Eval("_Name_")%>
                                                                </span>
                                                        ...
                                                        <asp:TemplateField HeaderText="المشروع" HeaderStyle-ForeColor="#CCCCCC" Visible="false">
                                                            <ItemTemplate>
                                                                <span style="font-size: 12px">

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageCashier.ascx.cs" Inherits="Shaerd_ERP_FMS_Cashing_PageCashier" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageCashier.aspx">قائمة فواتير سندات الصرف </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة فواتير سندات الصرف - موافقة المشرف المالي
                        </h3>
                                        ...
                                        <tr>
                                            <th>
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة فواتير إيصالات الدعم النقدي التي تحتاج إلى موافقة المشرف المالي" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVCashier" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"
                                                    Width="100%" CssClass="footable1" EnableTheming="True" GridLines="Horizontal" OnRowDataBound="GVCashier_RowDataBound"

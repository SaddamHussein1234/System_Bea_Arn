<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageAll.ascx.cs" Inherits="Shaerd_ERP_FMS_Cashing_PageAll" %>
            ...
            <div class="container-fluid">
                <div class="pull-right">
                    ...
                    <asp:LinkButton ID="btnPrintMulti" runat="server" class="btn btn-success" data-toggle="tooltip" OnClick="btnPrintMulti_Click"
                        ...
                        <i class="fa fa-print"></i> طباعة متعدد للفواتير المحددة</asp:LinkButton>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageCash_Donation.aspx">قائمة سندات الصرف </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="float:right;">
                            <i class="fa fa-list"></i>قائمة سندات الصرف
                        </h3>
                        <div align="left">

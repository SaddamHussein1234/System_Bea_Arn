<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageAdd.ascx.cs" Inherits="Shaerd_ERP_FMS_Cash_Donation_PageAdd" %>
    ...
    <div class="page-header">
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageAdd.aspx">إضافة إيصال تبرع نقدي</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    <asp:Label ID="Label2" runat="server" Text="المالية"></asp:Label>
                </h3>
            </div>
            <div class="col-sm-12">
        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-pencil"></i>
                        <asp:Label ID="lbmsg" runat="server" Text="إضافة إيصال تبرع نقدي"></asp:Label>
                    </h3>
                    ...
                    <div class="content-box-large">
                        <div class="widget-box">
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <h5>حدد الداعم : <span runat="server" id="lblPhone"></span>
                                        </h5>
                                                                        ...
                                                                        <div class="" dir="rtl">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <asp:DropDownList ID="ddlCompanyType" runat="server" Width="250" CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;" ValidationGroup="VGAdd2">
                                                                                        <asp:ListItem Value=""></asp:ListItem>
                                                                                    </asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="pnlMelady" style="display: none; <%= FCheck("Melady") %>">
                                            <div class="input-group date " >
                                                <asp:TextBox ID="txtDateAdd" runat="server" class="form-control" data-date-format="YYYY-MM-DD" ValidationGroup="GBill" Style="direction: ltr; text-align:left;"></asp:TextBox>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator7" runat="server"
                                            ...
                                            ValidationGroup="GBill" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                        <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtPriceOfTheGrain"
                                            ErrorMessage="أرقام فقط" ValidationExpression="^[0-9]{1,2}([,.]{1}[0-9]{1,2})?$" ValidationGroup="GBill"
                                            Display="Dynamic">
                                        </asp:RegularExpressionValidator>--%>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtNumber_Shayk_Bank"
                                            ErrorMessage="* أرقام فقط" Font-Size="11px" ValidationExpression="^[0-9]+$" ValidationGroup="g2"
                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DL_For" runat="server" ValidationGroup="GBill"
                                            CssClass="form-control2 chzn-select dropdown" Width="100%">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem Value="تبرع_عام">تبرع_عام</asp:ListItem>
                                            <asp:ListItem Value="زكاة_المال">زكاة_المال</asp:ListItem>
                                            <asp:ListItem Value="صدقة">صدقة</asp:ListItem>
                                            <asp:ListItem Value="كفالة_الأيتام">كفالة_الأيتام</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator1" runat="server"
                                            ControlToValidate="DL_For" ErrorMessage="* حدد النوع" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                            ValidationGroup="GBill" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                                        <br />
                                    </div>
                                </div>

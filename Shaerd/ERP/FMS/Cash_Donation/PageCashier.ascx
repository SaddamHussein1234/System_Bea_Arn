<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageCashier.ascx.cs" Inherits="Shaerd_ERP_FMS_Cash_Donation_PageCashier" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageCashier.aspx">قائمة فواتير إيصالات الدعم النقدي </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>قائمة فواتير إيصالات الدعم النقدي - موافقة المشرف المالي
                        </h3>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageAdd.ascx.cs" Inherits="Shaerd_ERP_FMS_In_Kind_Donation_PageAdd" %>
...
<div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="PageAdd.aspx">إضافة سند تبرع عيني</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">          
                            ...
                            <div class="container-fluid" dir="rtl">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLType_Shipment" runat="server" ValidationGroup="VGDetails" Visible="false"
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date ">
                                            <asp:TextBox ID="txtDateAdd" runat="server" class="form-control" data-date-format="YYYY-MM-DD" ValidationGroup="VGDetails" Style="direction: ltr"></asp:TextBox>
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtPriceOfTheGrain"
                                            ErrorMessage="أرقام فقط" ValidationExpression="^[0-9]{1,2}([,.]{1}[0-9]{1,2})?$" ValidationGroup="VGDetails"
                                            Display="Dynamic">
                                        </asp:RegularExpressionValidator>--%>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <asp:Button ID="btnAdd" runat="server" Text="إضافة للفاتورة" Style="margin-right: 4px;"
                                            class="btn btn-info" ValidationGroup="VGDetails" OnClick="btnAdd_Click" />
                                        
                                        <asp:LinkButton ID="LBNew" runat="server" Style="margin-right: 4px;" OnClick="LBNew_Click" 
                                            OnClientClick="return insertConfirmation();"
                                            class="btn btn-success" ValidationGroup="GBill">حفظ بيانات الفاتورة</asp:LinkButton>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <h5>
                                        <asp:Label ID="lblSend" runat="server" Text="نسخة للمستودع"></asp:Label> : <span style="color: red">*</span>
                                    </h5>
                                    <asp:DropDownList ID="DLSend" runat="server" ValidationGroup="GBill"
                                            ...
                                            <asp:ListItem Value="No">لا تقم بالإرسال</asp:ListItem>
                                        </asp:DropDownList>
                                            ...
                                            <asp:GridView ID="GVDeedDonationInKind" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="المنتج" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            <%# WSM_ClassProduct.FProductName((Int32) (Eval("_ID_Project_")))%>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="التجزئة" HeaderStyle-ForeColor="#CCCCCC">
                                                        <ItemTemplate>
                                                            <%# Convert.ToBoolean(Eval("_Is_There_Partition_")) ?
                                                             Eval("_Count_Partition_") + " / <small>" + WSM_Repostry_Units_.FGetByIDProduct(Convert.ToInt64(Eval("_ID_Project_"))) + "</small>"
                                                             :
                                                             " 1 " + " / <small>" + WSM_Repostry_Units_.FGetByIDProduct(Convert.ToInt64(Eval("_ID_Project_"))) + "</small>"
                                                            %>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                        <ItemStyle HorizontalAlign="Right" />

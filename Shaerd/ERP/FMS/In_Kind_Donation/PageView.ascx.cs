...
public partial class Shaerd_ERP_FMS_In_Kind_Donation_PageView : System.Web.UI.UserControl
{
    ...
    private void FGetByBill()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                "/Cpanel/ERP/OM/In_Kind_Donation/PageView.aspx?ID=" + txtSearch.Text.Trim();
    ...
    private void FGetByBillDetails(Guid XID)
    {

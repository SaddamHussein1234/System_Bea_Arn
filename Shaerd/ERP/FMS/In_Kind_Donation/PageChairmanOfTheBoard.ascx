<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageChairmanOfTheBoard.ascx.cs" Inherits="Shaerd_ERP_FMS_In_Kind_Donation_PageChairmanOfTheBoard" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageChairmanOfTheBoard.aspx">قائمة فواتير الدعم العيني </a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                                        ...
                                        <tr>
                                            <th>
                                                <div align="center" class="w">
                                                    <div>
                                                        <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة فواتير الدعم العيني التي تحتاج إلى موافقة رئيس مجلس الإدارة" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>

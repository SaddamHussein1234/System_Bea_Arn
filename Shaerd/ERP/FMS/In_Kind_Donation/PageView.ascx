<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageView.ascx.cs" Inherits="Shaerd_ERP_FMS_In_Kind_Donation_PageView" %>
            ...
            <div class="container-fluid">
                <div class="pull-right">
                    <div>
                        ...
                        السنة : <asp:DropDownList ID="ddlYears" runat="server" ValidationGroup="VGDetails"
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">سند إستلام تبرع عيني</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <asp:Label ID="lbmsg" runat="server" Text="سند إستلام تبرع عيني"></asp:Label>
                    </h3>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: thin double #808080; border-width: 1px; width: 20%">
                                                <table style="width: 100%; font-size: 12px">
                                                    <tr>
                                                        <td align="left" style="width: 60%">رقم السند / 
                                                        </td>
                                                        <td style="width: 40%">
                            ...
                            <asp:GridView ID="GVProductShopWarehouseByID" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="المنتج" HeaderStyle-ForeColor="#CCCCCC">
                                        <ItemTemplate>
                                            <span style="font-size:11px;"><%# WSM_ClassProduct.FProductName((Int32) (Eval("_ID_Project_")))%></span>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Right" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:TemplateField>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: 65%; border: thin double #808080; border-width: 1px;" align="center">
                                    <asp:Label ID="lblSumWord" runat="server" class="form-control" placeholder="المبلغ" 

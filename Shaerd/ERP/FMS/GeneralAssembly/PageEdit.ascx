<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageEdit.ascx.cs" Inherits="Shaerd_ERP_FMS_GeneralAssembly_PageEdit" %>
<div class="page-header">
            <div class="container-fluid">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">تعديل ايصال إشتراك</a></li>
                </ul>
            </div>
        </div>
        <div class="container-fluid">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLProject" runat="server" ValidationGroup="g2" Width="100%" CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;">
                                            <asp:ListItem Value=""></asp:ListItem>
                                        </asp:DropDownList>
        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-pencil"></i>
                        <asp:Label ID="lbmsg" runat="server" Text="تعديل ايصال إشتراك"></asp:Label>
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="content-box-large">
                        <div class="widget-box">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator6" runat="server"
                                            ControlToValidate="txtbill_Number" ErrorMessage="* رقم السند" ForeColor="#FF0066" meta:resourcekey="RequiredFieldValidator1Resource1"
                                            ValidationGroup="g2" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                            ...
                            <div class="container-fluid" dir="rtl">    
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <h5>مبلغ وقدرة : <span style="color: red">*</span>
                                        </h5>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group date ">
                                                <asp:TextBox ID="txtDate_Shayk_Bank" runat="server" class="form-control" Width="220" data-date-format="YYYY-MM-DD" 
                                                    ValidationGroup="g2" Style="direction: ltr; text-align:left;"></asp:TextBox>
                                                <span class="input-group-btn">
                                                    <button class="btn btn-default" type="button">
                                                        <i class="fa fa-calendar"></i>
                                                    </button>
                            ...
                            <div class="container-fluid" id="IDEdaa" runat="server" visible="false" dir="rtl" 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group date " style="margin-right: -10px">
                                                <asp:TextBox ID="txtDate_Edaa_Bank" runat="server" class="form-control" Width="220" data-date-format="YYYY-MM-DD" 
                                                    ValidationGroup="g2" Style="direction: ltr; text-align:left;"></asp:TextBox>
                                                <span class="input-group-btn">
                                                    <button class="btn btn-default" type="button">
                                                        <i class="fa fa-calendar"></i>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group" align="left">
                                        <asp:LinkButton ID="btnAdd" runat="server"  ValidationGroup="g2" OnClick="btnAdd_Click"
                                            CssClass="btn btn-info">حفظ البيانات</asp:LinkButton>

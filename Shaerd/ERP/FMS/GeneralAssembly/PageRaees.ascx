<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageRaees.ascx.cs" Inherits="Shaerd_ERP_FMS_GeneralAssembly_PageRaees" %>
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageAmeen.aspx">قائمة ايصالات تحتاج إلى موافقة رئيس المجلس </a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-list"></i>قائمة ايصالات ايصالات إلى موافقة رئيس المجلس
                </h3>
                            ...
                            <table class='table' style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>
                                            <div>
                                                <asp:TextBox ID="txtTitle" Text="قائمة ايصالات تحتاج إلى موافقة رئيس المجلس" runat="server" class="form-control" placeholder="عنوان البحث" Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                            </div>
                                        </th>
                                    </tr>
                                </thead>

...
public partial class Shaerd_ERP_FMS_Statistics_PageStatisticsByCategory : System.Web.UI.UserControl
{
    ...
    {
        Response.Redirect("PageStatisticsByCategory.aspx");
    }
    ...
    private void FGetProducts()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                txtTitle.Text = " الإحصاء المالي للتبرع العيني حسب المشاريع الموضحة , من تاريخ " + txtDateFrom.Text.Trim() + " إلى تاريخ " + txtDateTo.Text.Trim();

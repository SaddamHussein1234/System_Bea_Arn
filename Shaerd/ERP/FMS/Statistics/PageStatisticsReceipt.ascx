<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageStatisticsReceipt.ascx.cs" Inherits="Shaerd_ERP_FMS_Statistics_PageStatisticsReceipt" %>
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="PageStatisticsReceipt.aspx">قائمة الإحصاء المالي لسندات القبض</a></li>
                    </ul>
                </div>
            </div>
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i> الإحصاء المالي لسندات القبض

...
public partial class Shaerd_ERP_WSM_PageShipping_PageApprovalOfTheDirector : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            CLS_Permissions.CheckAccountAdmin("A117");
            FGetData();
        }
    }
    ...
    private void FGetData()
    {
        try
        {
            ...
            MIKDB.IDCheck = "GetByApprovalOfTheDirector";
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            GVApprovalOfTheDirector.Columns[9].Visible = false;

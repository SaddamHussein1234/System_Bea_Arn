<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageStorekeeper.ascx.cs" Inherits="Shaerd_ERP_WSM_PageShipping_PageStorekeeper" %>
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageApprovalOfTheDirector.aspx">مصادقة أمين المستودع </a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-list"></i>قائمة فواتير شحن المستودع - مصادقة أمين المستودع
                </h3>
                    ...
                    <div runat="server" id="IDPrint" class="table table-responsive" dir="rtl">
                        ...
                        <table class='table' style="width: 100%">
                                ...
                                <tr>
                                    <th>
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة فواتير شحن المستودع التي تحتاج إلى مصادقة أمين المستودع" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GVStorekeeper" runat="server" AutoGenerateColumns="False" DataKeyNames="_ID_Item_"
                                            Width="100%" CssClass="footable1" EnableTheming="True" GridLines="Horizontal" OnRowDataBound="GVStorekeeper_RowDataBound"

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageApprovalOfTheDirector.ascx.cs" Inherits="Shaerd_ERP_WSM_PageShipping_PageApprovalOfTheDirector" %>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-list"></i>قائمة فواتير شحن المستودع - موافقة مدير الجمعية
                </h3>
                                ...
                                <tr>
                                    <th>
                                        <div align="center" class="w">
                                            <div>
                                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" Text="قائمة فواتير شحن المستودع التي تحتاج إلى موافقة مدير الجمعية" placeholder='عنوان البحث' Style="text-align: center; width: 100%; font-family: 'Alwatan'; font-size: 18px;"></asp:TextBox>
                                            </div>
                                        </div>
                                    </th>
                                </tr>

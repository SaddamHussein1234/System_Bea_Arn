...
public partial class Shaerd_PageAcceptanceDecisionDetails : System.Web.UI.UserControl
{
    string XID;
            ...
            if (dtId.Rows.Count > 0)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    string code = ClassSetting.FGetNameServer() +
                        "/Cpanel/PageAcceptanceDecisionDetails.aspx?ID=" + txtSearch.Text.Trim();

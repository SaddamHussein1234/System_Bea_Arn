<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManageAffiliation.ascx.cs" Inherits="Shaerd_CPanelManageWarehouse_PageManageAffiliation" %>
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="PageManageAffiliation.aspx">قائمة إنتماء للمستودع</a></li>
            </ul>
        </div>
    </div>
                        ...
                        <asp:GridView ID="GVAffiliationAll" runat="server" AutoGenerateColumns="False" DataKeyNames="AffiliationID"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="10px">
                                    <ItemTemplate>
                                        <a href='PageManageAffiliation.aspx?ID=<%# Eval("IDUniq")%>' title="تعديل" data-toggle="tooltip"

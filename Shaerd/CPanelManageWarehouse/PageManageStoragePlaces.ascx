<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManageStoragePlaces.ascx.cs" Inherits="Shaerd_CPanelManageWarehouse_PageManageStoragePlaces" %>
                    ...
                    <asp:GridView ID="GVStoragePlacesAll" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="10px">
                                <ItemTemplate>
                                    <a href='PageManageStoragePlaces.aspx?ID=<%# Eval("IDUniq")%>' title="تعديل" data-toggle="tooltip"><span class="fa fa-edit"></span></a>
                                </ItemTemplate>

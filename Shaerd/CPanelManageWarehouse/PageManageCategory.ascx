<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManageCategory.ascx.cs" Inherits="Shaerd_CPanelManageWarehouse_PageManageCategory" %>
                    ...
                    <asp:GridView ID="GVCategoryAll" runat="server" AutoGenerateColumns="False" DataKeyNames="CategoryID"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="10px">
                                <ItemTemplate>
                                    <a href='PageManageCategory.aspx?ID=<%# Eval("IDUniq")%>' title="تعديل" data-toggle="tooltip"

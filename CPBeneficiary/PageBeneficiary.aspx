<%@ Page Title="" Language="C#" MasterPageFile="~/CPBeneficiary/MPBeneficiary.master" AutoEventWireup="true" CodeFile="PageBeneficiary.aspx.cs" Inherits="CPBeneficiary_PageBeneficiary" %>
    ...
    <div id="content">
                            ...
                            <div class="container-fluid" dir="rtl">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DLAlHalahAlTaelimiahllmostafeed" runat="server" ValidationGroup="g2" CssClass="form-control2 chzn-select dropdown"
                                            Height="34" Width="95%">
                                            <asp:ListItem></asp:ListItem>
                                ...
                                <div class="col-md-3" runat="server" visible="false" id="PnlMehnah">
                                    <div class="form-group">
        ...
        <div class="container-fluid">
            ...
            <div style="float: left">
                <asp:LinkButton ID="btnAdd" runat="server"  ValidationGroup="g2" style="margin-right:4px;"
                    class="btn btn-info btn-fill pull-left" OnClick="btnAdd_Click">حفظ البيانات</asp:LinkButton>
                <asp:LinkButton ID="LinkButton1" runat="server" style="margin-right:4px;"
                    class="btn btn-danger btn-fill pull-left" OnClick="LBExit_Click">خروج </asp:LinkButton>
            </div>
            <div style="width: 50%">

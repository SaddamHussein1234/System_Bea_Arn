<%@ Page Title="" Language="C#" MasterPageFile="~/CPBeneficiary/MPBeneficiary.master" AutoEventWireup="true" CodeFile="PageBeneficiaryFamily.aspx.cs" Inherits="CPBeneficiary_PageBeneficiaryFamily" %>
        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <asp:LinkButton ID="btnSearch" runat="server" data-toggle="tooltip" title="جلب" Visible="false"
                        class="btn btn-info"><span class="tip-bottom"><i class="fa fa-search" style="font-size:16px"></i></span></asp:LinkButton>
                    &nbsp;
                    <asp:TextBox ID="txtSearch" runat="server" CssClass="WidthText2" placeholder=" رقم المستفيد ... " Visible="false"></asp:TextBox>
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="">معلومات أفراد الاسرة</a></li>
                </ul>
            </div>
        </div>
                                        ...
                                        <asp:GridView ID="GVMenu" runat="server" AutoGenerateColumns="False" DataKeyNames="IDItem"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                    <ItemTemplate>
                                                        <a href='PageBeneficiaryFamily.aspx?ID=<%# Eval("NumberMostafed")%>&XID=<%# Eval("IDUniq")%>' title="تعديل" data-toggle="tooltip"

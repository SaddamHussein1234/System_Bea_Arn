<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginAdmin.aspx.cs" Inherits="CPBeneficiary_LoginAdmin" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>تسجيل دخول مستفيد</title>
        ...
        <div class="continer-Login">
            ...
            <div style=" border-radius: 6px; margin-top:60px">
                <h2 class="Title-Login">
                    <span>الدخول الى</span>  لوحة تحكم <span>المستفيدين</span>
                </h2>

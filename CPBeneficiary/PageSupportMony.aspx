<%@ Page Title="" Language="C#" MasterPageFile="~/CPBeneficiary/MPBeneficiary.master" AutoEventWireup="true" CodeFile="PageSupportMony.aspx.cs" Inherits="CPBeneficiary_PageSupportMony" %>
                            ...
                            <div class="table table-responsive">
                                <table class='table' style="width: 100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVExchangeOrdersPrisms" runat="server" AutoGenerateColumns="False" DataKeyNames="billNumber_"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-ForeColor="#CCCCCC" HeaderStyle-Width="16">
                                                            <ItemTemplate>
                                                                <a href='PageManageProductAddThePriceToOrder.aspx?IDS=<%# Eval("billNumber_")%>&IDCh=<%# Eval("ID_Type")%>&IDU=<%# Convert.ToString(Guid.NewGuid()) %>' title="عرض التفاصيل" data-toggle="tooltip"><span class="fa fa-eye"></span></a>
                                                                <br />
                                                                <%# ClassSaddam.CheckAllowEditSupportForPrisms(Convert.ToBoolean(Eval("IsAllowModer")), Convert.ToString(Eval("IDUniq"))) %>
                                                            </ItemTemplate>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="WidthMaglis24" align="center" runat="server" visible="false">
                                                                        ...
                                                                        <asp:DropDownList ID="DropDownList5" runat="server" ValidationGroup="g2" Width="100%"
                                                                    ...
                                                                    <div class="WidthMaglis24" align="center" style="font-family: 'Alwatan'; font-size: 20px">
                                                                        مدير الجمعية
                                                                        <br />
                                                                        <asp:Image ID="ImgModerPrisms" runat="server" Width='100px' Height='25' />
                                                                        <br />
                                                                        <asp:Label ID="lblModerAlGmeiahPrisms" runat="server" Font-Size="20px"></asp:Label>
                                                                        <asp:DropDownList ID="DLModerAlGmeiahPrisms" runat="server" ValidationGroup="g2" Width="100%"
                                                                            CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;">
                                                                            <asp:ListItem Value=""></asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                    <div class="WidthMaglis24" align="center" style="font-family: 'Alwatan'; font-size: 20px">
                                                                        أمين الصندوق
                                                                        <br />
                                                                        <asp:Image ID="ImgAmeenAlSondoqPrisms" runat="server" Width='100px' Height='25' />
                                                                        <br />
                                                                        <asp:Label ID="lblAmeenAlSondoqPrisms" runat="server" Font-Size="20px"></asp:Label>
                                                                        <asp:DropDownList ID="DLAmeenAlSondoqPrisms" runat="server" ValidationGroup="g2" Width="100%"
                                                                            CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;">
                                                                            <asp:ListItem Value=""></asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                    <div class="WidthMaglis24" align="center" style="font-family: 'Alwatan'; font-size: 20px">
                                                                        رئيس مجلس الإدارة
                                                                        <br />
                                                                        <asp:Image ID="ImgRaeesMaglesAlEdarahPrisms" runat="server" Width='100px' Height='25' />
                                                                        <br />
                                                                        <asp:Label ID="lblRaeesMaglesAlEdarahPrisms" runat="server" Font-Size="20px"></asp:Label>
                                                                        <asp:DropDownList ID="DLRaeesMaglesAlEdarahPrisms" runat="server" ValidationGroup="g2" Width="100%"
                                                                            CssClass="form-control2 chzn-select dropdown" Style="font-size: 12px;">
                                                                            <asp:ListItem Value=""></asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                    <div class="WidthMaglis24" align="center">
                                                                        <div runat="server" id="IDKhatmPrisms" align="left">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th>
                                                ...
                                                <asp:Label ID="Label234" runat="server" Text="ريال" Style='color: Red; font-size: 12px'></asp:Label>

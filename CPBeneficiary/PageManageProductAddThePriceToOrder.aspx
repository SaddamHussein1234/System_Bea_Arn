<%@ Page Title="" Language="C#" MasterPageFile="~/CPBeneficiary/MPBeneficiary.master" AutoEventWireup="true" CodeFile="PageManageProductAddThePriceToOrder.aspx.cs" Inherits="CPBeneficiary_PageManageProductAddThePriceToOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="content">
        ...
        <div align="rigth" style="padding: 0 15px 0 15px" runat="server" visible="false">
            ...
            <span>فرز أوامر السلل لـــ 
                : 
                <asp:RadioButton ID="RBCart" runat="server" Text="سلة غذائية" GroupName="GCheck" /> - 
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div style="float: left" runat="server" visible="false">
                        <asp:TextBox Visible="false" ID="txtSearch" runat="server" CssClass="WidthText20" placeholder=" رقم الفاتورة ... " Width="100"></asp:TextBox>
        ...
        <div class="container-fluid" runat="server" id="ProductByTarmim" visible="false">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div style="float: left">
                        <asp:TextBox ID="txtSearchTarmim" Visible="false" runat="server" CssClass="WidthText20" placeholder=" رقم الامر ... " ValidationGroup="gTarmim"></asp:TextBox>
                ...
                <div class="panel-body">
                    <asp:Panel ID="pnlDataTarmim" runat="server" Direction="RightToLeft" Font-Size="14px">
                        ...
                        <div style="float: right; padding: 10px 10px 0 10px;" class="w">
                            <p style="font-size: 13px">
                                السيد / أمين الصندوق<asp:Label ID="Label1" runat="server" Visible="false"></asp:Label>
                            </p>
                            <p style="font-size: 13px">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div style="float: left">
                        <div runat="server" visible="false">
                            <span> حدد المشروع : </span>
                            <asp:DropDownList ID="DLProject" runat="server" ValidationGroup="g2" Width="100%"
                                CssClass="form-control2" Style="font-size: 12px; width:150px" Height="36">
                                <asp:ListItem Value=""></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <asp:RequiredFieldValidator SetFocusOnError="True" ID="RequiredFieldValidator2" runat="server"
                            ...
                            ValidationGroup="gTarmim" Font-Size="10px" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:TextBox ID="txtSearchPrisms" Visible="false" runat="server" CssClass="WidthText20" placeholder=" رقم الامر ... " ValidationGroup="gTarmim"></asp:TextBox>
                ...
                <div class="panel-body">
                    <asp:Panel ID="pnlDataPrisms" runat="server" Direction="RightToLeft" Font-Size="14px">
                        ...
                        <div style="float: right; padding: 10px 10px 0 10px;" class="w">
                            <p style="font-size: 13px">
                                السيد / أمين الصندوق<asp:Label ID="Label12" runat="server" Visible="false"></asp:Label>
                            </p>
                            <p style="font-size: 13px">
                    ...
                    <div class="content-box-large">
                        <div class="container-fluid" dir="rtl">
                            <asp:Panel ID="pnlSelect" runat="server">
                                ...
                                <br />
                                <div align="center">
                                    <h3 style="font-size: 20px">لا توجد بيانات , فاتورة غير صحيحة !
                                    </h3>
                                </div>
                                <br />
                                <br />

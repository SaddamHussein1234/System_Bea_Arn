<%@ Page Title="" Language="C#" MasterPageFile="~/CPBeneficiary/MPBeneficiary.master" AutoEventWireup="true" CodeFile="PageAcceptanceDecision.aspx.cs" Inherits="CPBeneficiary_PageAcceptanceDecision" %>
                                                ...
                                                <asp:Repeater ID="RPTGetAdminInManagment" runat="server">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="StyleTD" style="width: 31%;">
                                                                <%# Library_CLS_Arn.Saddam.ClassSaddam.FGetSignature(Convert.ToInt32(Eval("IDIteam")),Convert.ToBoolean(Eval("AdminAllow")),Convert.ToString(Eval("AddImgSignature"))) %>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>

<%@ Page Title="" Language="C#" MasterPageFile="~/ar/MPAr.master" AutoEventWireup="true" CodeFile="PageVideo.aspx.cs" Inherits="ar_PageVideo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="url" content="<%= "https://" + HFLink.Value + "/ar/PageVideo.aspx" %>" />

    <meta property="og:description" content="<%= HFDescrption.Value %>" />
    <meta property="og:title" content="<%= HFTitle.Value %>" />
    <meta property="og:type" content="site" />
    <meta property="og:url" content="<%= "https://" + HFLink.Value + "/ar/PageVideo.aspx" %>" />
    ...
    <meta name="twitter:url" content="<%= "https://" + HFLink.Value + "/ar/PageVideo.aspx" %>" />
</asp:Content>
        ...
        <div class="body_container">
            <div class="container inner">
                <div class="row grid-container-10">
                    <asp:Repeater ID="RPTVideoArabic" runat="server" Visible="false">
                        <ItemTemplate>
                ...
                <div class="pagination_div">
                    <ul class="pagination">
                        <li class='regular'>
                            <asp:Button ID="btnfirst" runat="server" Text="<< البداية" CssClass="submit" Font-Size="12px" Font-Bold="true" OnClick="btnfirst_Click" /></li>
                        <li class='active'>
                            <asp:Button ID="btnprevious" runat="server" Text="< السابق" CssClass="submit" Font-Size="12px" Font-Bold="true" OnClick="btnprevious_Click" /></li>
                        <li class='active'>
                            <asp:Button ID="btnnext" runat="server" Text="التالي >" CssClass="submit" Font-Size="12px" Font-Bold="true" OnClick="btnnext_Click" /></li>
                        <li class='active'>
                            <asp:Button ID="btnlast" runat="server" Text="النهاية >>" CssClass="submit" Font-Size="12px" Font-Bold="true" OnClick="btnlast_Click" /></li>
                    </ul>
                </div>
            </div>
        </div>
